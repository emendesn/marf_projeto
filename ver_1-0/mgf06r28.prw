...
Data................: 18/03/2019
Descrição / Objetivo: Relatório Posição Titulos ME - 06 Financeiro. 
Doc. Origem.........: 
Solicitante.........: Priscilla Sombini
Uso.................: Marfrig
Obs.................: Relatório Posição Titulos ME.
=====================================================================================
*/
...
User Function MGF06R28()
	...
	Aadd(_aDefinePl, "Relatório Posição Titulos ME"			)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerá na regua de processamento.
	Aadd(_aDefinePl, "Posição Titulos ME"					)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Posição Titulos ME"}					)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Posição Titulos ME"}					)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, { "NUM_EXP"			,"NUM_EXP"						,"Número da Exportação"		,"C",020,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "ANO_EXP"			,"ANO_EXP"						,"Ano da Exportação"		,"C",002,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "SUBEXP"				,"SUBEXP"						,"Sub Exp"					,"C",003,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "PEDIDO_EXPORTACAO"	,"PEDIDO_EXPORTACAO"			,"Pedido Exportação"    	,"C",020,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "COD_BUYER"			,"COD_BUYER"					,"Código Buyer"				,"C",006,0	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "EMISSAO"			,"EMISSAO"						,"Emissão"					,"D",008,0	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "NEGOCIO"			,"NEGOCIO"						,"Negócio"					,"C",045,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "SITUACAO"			,"SITUACAO"						,"Situação"					,"C",080,0	,""	,""	,""	})
	...
	aAdd(_aParambox,{1,"Negócio"				,Space(tamSx3("EEG_NOME")[1])	,""	,""													,""		,"",050,.F.})	//05
