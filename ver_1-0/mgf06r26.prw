...
//ฑฑบPrograma  ณ MGF06R26	บAutor  ณ Geronimo Benedito Alves                                                               บData ณ  22/08/18      บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.     ณ Rotina que mostra na tela os dados da planilha: Financeiro - Contas a Receber- Status Pedidos de Venda (M๓dulo 06-FIN)            บฑฑ
...
User Function MGF06R26()
	...
	Aadd(_aDefinePl, "Contas เ Receber - Status Pedidos de Venda"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {"ZQ_COD"		,"COD_REDE"						,"C๓d. Rede"						,""	,""	,""	,""		,""	,""	})
	Aadd(_aCampoQry, {"ZQ_DESCR"	,"DESC_REDE"					,"Decri็ใo Rede"					,""	,""	,""	,""		,""	,""	})
	Aadd(_aCampoQry, {"AOV_CODSEG"	,"COD_SEGMENTO"					,"C๓d. Segmento"					,""	,""	,""	,""		,""	,""	})
	Aadd(_aCampoQry, {"AOV_DESSEG"	,"NOM_SEGMENTO"					,"Nome Segmento"					,""	,""	,""	,""		,""	,""	})
	Aadd(_aCampoQry, {"C5_CONDPAG"	,"COD_COND_PAGAMENTO_PEDIDO"	,"Condi็ใo Pagto Pedido"			,""	,""	,""	,""		,""	,""	})
	Aadd(_aCampoQry, {"E4_DESCRI"	,"DESC_COND_PAGAMENTO_PEDIDO"	,"Descri็ใo condi็ใo Pagto Pedido"	,""	,""	,""	,""		,""	,""	})
	Aadd(_aCampoQry, {"E4_CODIGO"	,"COD_COND_PAGAMENTO_CLIENTE"	,"Condi็ใo Pagto Cliente"			,""	,""	,""	,""		,""	,""	})
	Aadd(_aCampoQry, {"E4_DESCRI"	,"DESC_COND_PAGAMENTO_CLIENTE"	,"Descri็ใo condi็ใo Pagto Cliente"	,""	,""	,""	,""		,""	,""	})
	...
	aAdd(_aParambox,{1,"Data Aprova็ใo Inicial"		,Ctod("")						,""	,""														,""		,""	, 050,.F.})
	aAdd(_aParambox,{1,"Data Aprova็ใo Final"		,Ctod("")						,""	,"U_VLFIMMAI(MV_PAR01, MV_PAR02, 'Data Aprova็ใo' )"	,""		,""	, 050,.T.})
	...
	// BLOQUEIO
	cQryBloque	:= " SELECT '" +SPACE(TamSx3("ZT_CODIGO")[1])+ "' as ZT_CODIGO, 'Nใo Informado' as ZT_DESCRI FROM DUAL UNION ALL "
	...
	cTitBloque	:= "Selecione os C๓digos de Bloqueio เ serem listados: "
	...
	// SEGMENTO
	cQrySegmen	:= " SELECT '" +SPACE(TamSx3("AOV_CODSEG")[1])+ "' as AOV_CODSEG, 'Nใo Informado' as AOV_DESSEG FROM DUAL UNION ALL "
	...
	cTitSegmen	:= "Selecione os C๓digos de Segmento เ serem listados: "
	...
	// APROVADOR
	cQryAprova	:= " SELECT '" +SPACE(TamSx3("ZV_CODAPR")[1])+ "' as ZV_CODAPR, 'Nใo Informado' as ZS_NOME, '  Nใo    ' as BLOQUEADO FROM DUAL UNION ALL "
	cQryAprova	+= " SELECT DISTINCT ZV_CODAPR, ZS_NOME, CASE WHEN ZS_MSBLQL = '1'  THEN 'BLOQUEADO' ELSE '  Nใo    ' END as BLOQUEADO"
	...
	cTitAprova	:= "Selecione os C๓digos dos Aprovadores เ serem listados: "
	nPosRetorn	:= 1		// Quero que seja retornado o primeiro campo: ZV_CODAPR
	//.T. no envio do parametro _lCancProg, indica que devo abandonar programa, se for clicado o botใo cancelar da MarkGene.
	//.T. no _lCancProg, ap๓s a Markgene, indica que realmente foi teclado o botใo cancelar e que devo abandonar o programa. 
	//.F. no _lCancProg, ap๓s a Markgene, indica que nใo foi teclado o botใo cancelar ou que mesmo ele teclado, nใo devo abandonar o programa (mas apenas "limpar/desconsiderar" a marca็ใo dos registro) 
	_lCancProg	:= .T. 		//.T. no envio do parametro, indica que devo abandonar programa, se for clicado o botใo cancelar da MarkGene
...
//WHERE V.DT_APROVACAO_FILTRO BETWEEN '20180818' AND '20180821'    
  // AND V.COD_FILIAL             IN ( '010041','010050','010022','010007','010001','020001') --OBRIGATORIO (SELEวรO COMBO FILIAL)
   //AND V.COD_CLIENTE            IN ('000095','000063','000082', '000512')                   --NรO ษ OBRIGATORIO (DIGITAR O COD. CLIENTE)
   //AND V.COD_REDE               IN ('001',' ','014','639' )                                              --NรO OBRIGATORIO (SELEวรO COMBO REDE) NOTAR OPCAO DE REDE EM BRANCO
