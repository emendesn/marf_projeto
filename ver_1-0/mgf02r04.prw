...
//ฑฑบPrograma  ณ MGF02R04	บAutor  ณ Geronimo Benedito Alves																	บData ณ 02/05/18	บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: COMPRAS - Relat๓rio de Abate (DAEMS)				 (M๓dulo 02-Compras)				บฑฑ
...
User Function MGF02R04()
	...
	Aadd(_aDefinePl, "COMPRAS - Abate-DAEMS"	)	//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, { "ZZM_FILIAL"	,"COD_EMPRESA	as CODEMPRESA"	,"C๓d. Filial"		,""		,	, 	,""		,""	,""	})
	...
	Aadd(_aCampoQry, { "ZZQ_GTA"	,"NUM_GTA"						,"N๚mero GTA"		,""		,	, 	,""		,""	,""	})
	Aadd(_aCampoQry, { "CC2_MUN"	,"MUNICIPIO"					,"Municํpio"		,""		,	, 	,""		,""	,""	})
	Aadd(_aCampoQry, { "XXXXXXXX02"	,"PROPRIEDADE	as PROPRIEDAD"	,"Propriedade"		,"C"	,065,0	,""		,""	,""	})
	Aadd(_aCampoQry, { "ZZM_FORNEC"	,"COD_PRODUTOR	as CODPRODUTO"	,"C๓d. Produtor"	,""		,	, 	,""		,""	,""	})
	...
	Aadd(_aCampoQry, { "ZZM_DTPROD"	,"DATA_PRODUCAO	as DATAPRODUC"	,"Data Produ็ใo"	,""		,	, 	,""		,""	,""	})
	Aadd(_aCampoQry, { "ZZM_NUMOP" 	,"NUM_OP"						,"Nบ OP."			,""		,	, 	,""		,""	,""	})

	aAdd(_aParambox,{1,"Data Produ็ใo Inicial"	,Ctod("")	,""	,"" 												,""	,"",050,.T.})
	aAdd(_aParambox,{1,"Data Produ็ใo Final"	,Ctod("")	,""	,"U_VLFIMMAI(MV_PAR01, MV_PAR02, 'Data de Emissao')",""	,"",050,.T.})
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),   " DATA_PRODUCAO_FILTRO BETWEEN '" + _aRet[1] + "' AND '" + _aRet[2] + "' "	)	// OBRIGATORIO, SEM A VALIDAวรO DE DATAS
