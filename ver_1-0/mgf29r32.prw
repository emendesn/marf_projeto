...
//ฑฑบPrograma  ณ MGF29R32	บAutor  ณ Geronimo Benedito Alves																	บData ณ  25/05/18  บฑฑ
...
User Function MGF29R32()
	...
	Aadd(_aDefinePl, "EXPORTAวรO - Vencidos"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {"XXPEDIEX01"		,"PEDIDO_EXPORTACAO	    	as PEDIEXPORT"	,"Pedido Exporta็ใo"				,"C",020	,0	,""	,0		,""	})
	...
	Aadd(_aCampoQry, {"F1_COND"			,"CONDICAO_PAG_INTERMEDIACAO as CONDPGI"	,"Cond. Pagamento Intermedia็ใo"	,"C",003	,0	,"" ,"" 	,"" }) 
