...
Data................: 27/05/2019
Descrição / Objetivo: Relatório Faturamento Lista de Produto. 
Doc. Origem.........: 
Solicitante.........: Priscilla Sombini
Uso.................: Marfrig
Obs.................: Relatório Lista de Produto.
=====================================================================================
*/
...
User Function MGF05R13()
	...
	Aadd(_aDefinePl, "Relatório Lista de Produto"			)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerá na regua de processamento.
	...
	Aadd(_aCampoQry, { "FAMILIA"				,"FAMILIA"					,"Família"				,"C",030,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "ORIGEM"					,"ORIGEM"					,"Origem"				,"C",030,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "NEGOCIO"				,"NEGOCIO"					,"Negócio"				,"C",030,0	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "CONSERVACAO"			,"CONSERVACAO"				,"Conservação"			,"C",015,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "HABILITACAO"			,"HABILITACAO"				,"Habilitação"			,"C",050,0	,""	,""	,""	})
