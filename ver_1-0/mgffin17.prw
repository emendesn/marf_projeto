...
//oStruZDP:SetProperty('Z2_FABRIC', MODEL_FIELD_WHEN,{|| INCLUI })  // este campo s� pode ser alterado no modo inclusao.
...
//oModel:GetModel('MODELNAME'):SetDescription('Cadastro Divis�o do Painel')
...
Static Function xProcBlo17()
	...
	//Local _cTxtBlq  := "Usuario: "+SubStr(cUsuario,7,15)+" Data: "+DtoC(ddatabase)+" Aviso: "+SuperGetMV("MGF_TXTBLQ",,"Bloqueado autom�tico por inatividade ")
	Local cError := ""
