...
//ฑฑบPrograma  ณ MGF34R12	บAutor  ณ Geronimo Benedito Alves																	บData ณ16/01/18	บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: CONTABILIDADE - Lan็amento Contแbil x NF Saida  (M๓dulo 34-CTB)					บฑฑ
...
User Function MGF34R12()
	...
	Aadd(_aDefinePl, "Contab. Gerencial - Contแbil x NF Saํda"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	Aadd(_aDefinePl, "Contแbil x NF Saํda"						)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Contแbil x NF Saํda"}					)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Contแbil x NF Saํda"}					)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, {"F2_EMISSAO"	,"DATA_EMISSAO_NF			as DTEMISSANF"	,"Emissใo NF"				,"D"	,008	,0	,""							,""	,""	 })
	...
	Aadd(_aCampoQry, {"EE7_PEDIDO"	,"NUM_EXP"									,"Num. Exporta็ใo"			,"C"	,020	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"C5_ZTPOPER"	,"COD_TIPO_OPERACAO			as CODTP_OPER"	,"C๓digo Tipo Opera็ใo"		,"C"	,002	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"X5_DESCRI"	,"TIPO_OPERACAO				as TP_OPERACA"	,"Tipo de Opera็ใo"			,"C"	,055	,0	,""							,""	,""	 })  
	Aadd(_aCampoQry, {"F4_CODIGO"	,"CODIGO_TES"								,"C๓d. Tp Entr/Saida"		,"C"	,003	,0	,""							,""	,""	 })  
	Aadd(_aCampoQry, {"F4_TEXTO"	,"DESC_TES"									,"Descr. Tp Entr/Saida"		,"C"	,020	,0	,""							,""	,""	 })  
	Aadd(_aCampoQry, {"X5_CHAVE"	,"CODIGO_FISCAL				as COD_FISCAL"	,"C๓digo Fiscal"			,"C"	,006	,0	,""							,""	,""	 })  
	Aadd(_aCampoQry, {"X5_DESCRI"	,"DESC_CODIGO_FISCAL		as DESCCDFISC"	,"Descr. C๓digo Fiscal"		,"C"	,055	,0	,""							,""	,""	 })
	...
	Aadd(_aCampoQry, {"A1_NOME"		,"RAZAO_SOCIAL				as RAZ_SOCIAL"	,"Razใo Social Cliente"		,"C"	,040	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"F4_CODIGO"	,"COD_TRIBUTARIO_CLIENTE	as CD_TRIBCLI"	,"C๓d. Tributario Cliente"	,"C"	,003	,0	,""							,""	,""	 })
	...
	Aadd(_aCampoQry, {"D2_COD"		,"COD_ITEM"									,"C๓digo Item"				,"C"	,015	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"B1_DESC"		,"DESC_ITEM"								,"Descri็ใo Item"			,"C"	,076	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"B1_CEST"		,"CEST"										,"C๓d. Espec. ST"			,"C"	,009	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"B1_GRTRIB"	,"COD_TRIBUTARIO_PRODUTO	as CD_TRIBPRO"	,"C๓d. Tributario Produto"	,"C"	,006	,0	,""							,""	,""	 })
	...
	Aadd(_aCampoQry, {"D2_GRUPO"	,"FAMILIA"									,"Famํlia"					,"C"	,004	,0	,""							,""	,""	 })
	...
	Aadd(_aCampoQry, {"D2_PRCVEN"	,"VALOR_UNITARIO			as VLR_UNITAR"	,"Valor Unitแrio"			,"N"	,018	,6	,"@E 999,999,999.999999"	,""	,""	 })
	...
	Aadd(_aCampoQry, {"C5_DESPESA"	,"DESPESAS_ACESSORIAS		as DESPEACESS"	,"Despesas Acess๓rias"		,"N"	,017	,2	,"@E 999,999,999.99"		,""	,""	 })
	...
	Aadd(_aCampoQry, {"A4_COD"		,"COD_TRANSPORTADORA		as CODTRANSPO"	,"C๓digo Transportadora"	,"C"	,006	,0	,""							,""	,""	 })
	...
	Aadd(_aCampoQry, {"E4_DESCRI"	,"CONDICAO_PAGAMENTO		as COND_PAGTO"	,"Condi็ใo Pagamento"		,"C"	,015	,0	,""							,""	,""	 })
	...
	Aadd(_aCampoQry, {"BM_DESC"		,"NUM_ROTEIRO				as NUMROTEIRO"	,"N๚mero do Roteiro"		,"C"	,030	,0	,""							,""	,""	 })
	...
	Aadd(_aCampoQry, {"EE9_RE"		,"REGISTRO_EXPORTACAO		as REG_EXPORT"	,"Registro Exporta็ใo"		,"C"	,012	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"EXL_NROMEX"	,"MEMORANDO_EXPORTACAO		as MEMO_EXPOR"	,"Memorando Exporta็ใo"		,"C"	,020	,0	,""							,""	,""	 })
	...
	Aadd(_aCampoQry, {"A3_COD"		,"CODIGO_VENDEDOR			as CODVENDEDO"	,"C๓digo Vendedor"			,"C"	,006	,0	,""							,""	,""	 })
	...
	aAdd(_aParambox,{1,"C๓digo Fiscal Inicial"	,Space(tamSx3("X5_CHAVE")[1])	,""		,""													,"13"	,"",050,.F.})	
	aAdd(_aParambox,{1,"C๓digo Fiscal Final"	,Space(tamSx3("X5_CHAVE")[1])	,""		,"U_VLFIMMAI(MV_PAR03, MV_PAR04, 'C๓digo Fiscal')"	,"13"	,"",050,.F.})	
	...
	aAdd(_aParambox,{1,"Conta Contแbil Final"	,Space(tamSx3("CT1_CONTA")[1])	,""		,"U_VLFIMMAI(MV_PAR06, MV_PAR07, 'Conta Contแbil')"	,"CT1"	,"",075,.F.})	
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),      " DATA_EMISSAO_NF_FILTRO BETWEEN '" + _aRet[1]    + "' AND '" + _aRet[2] + "' " ) //OBRIGATORIO, COM A VALIDAวรO DE 366 DIAS
