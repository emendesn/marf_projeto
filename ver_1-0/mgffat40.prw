...
Data................: 04/07/2017
Descricao / Objetivo: Job para impressao/envio para sistema WinPrint
...
User Function MGFFAT40(aParam)
	...
	/*
	����������������������������������������������������������������������������������������������������������Ŀ
	� Job/Schedule - Preparacao do Ambiente                                                                    |
	������������������������������������������������������������������������������������������������������������*/
	If ValType(aParam) $ "A"
		// TRYEXCEPTION
		RPCSetType(3)
	...
	*/
	...
	Else
		...
		ConOut("WINPRINT-Nao foi possivel estabelecer conexao com o servico da Sefaz.")
		MsgStop("WINPRINT-Nao foi possivel estabelecer conexao com o servico da Sefaz.")
...
//			AND F2_DOC IN ('000001131','000001132')
	...
	/*
	����������������������������������������������������������������������������������������������������������Ŀ
	� Job/Schedule - Finalizacao do Ambiente.                                                                  |
	������������������������������������������������������������������������������������������������������������
	*/
	If ValType(aParam) $ "A"
		RpcClearEnv()
