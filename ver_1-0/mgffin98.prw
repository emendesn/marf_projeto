...
//Permite reposi��o manual do caixinha com valores acima do limite: 1 - Permite; 2 - Nao permite.
STATIC lRpMnAcLim	:= SuperGetMV("MV_RPCXMN",.T.,"1") == "1"
//Permite que sejam realizadas reposi��es acima do valor do caixinha: T - Permite; F - Nao Permite
	...
	If oModel:GetOperation() == MODEL_OPERATION_INSERT
		...
		While (cQry)->(!EOF())			
			...
			For nx := 1 to Len(oStrZE0:aFields)
				If !oStrZE0:aFields[nx,14] //Verifica Se nao � Virtual

					cField  := oStrZE0:aFields[nx,3]//Pega o Id do Campo
					cFldQry := "(cQry)->" + cField //Monta Express�o para macro execucao
