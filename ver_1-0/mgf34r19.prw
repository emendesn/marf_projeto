...
//ฑฑบPrograma  ณ MGF34R19	บAutor  ณ Geronimo Benedito Alves																	บData ณ  18/06/18  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: CONTABILIDADE - Faturas                          (M๓dulo 34-CTB)                 บฑฑ
...
User Function MGF34R19()
	...
	Aadd(_aDefinePl, "Contabilidade - Faturas"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {"E2_NUM"		,"NUMERO_TITULO"		,"Nบ Tํtulo"			,"C"	,009	,0	,""	,""	,""	})
	...
	Aadd(_aCampoQry, {"ED_DESCRIC"	,"NATUREZA_DESCRICAO"	,"Descri็ใo Natureza"	,"C"	,030	,0	,""	,""	,""	})
	...
	Aadd(_aCampoQry, {"E2_VALOR"	,"VALOR_TITULO"			,"Valor Tํtulo"			,"N"	,016	,2	,""	,""	,""	})
	...
	aAdd(_aParambox,{1,"C๓d. Natureza Inicial"		,Space(tamSx3("E2_NATUREZ")[1])	,""	,""														,"SED"	,"",050,.F.})
	aAdd(_aParambox,{1,"C๓d. Natureza Final"		,Space(tamSx3("E2_NATUREZ")[1])	,""	,"U_VLFIMMAI(MV_PAR11, MV_PAR12, 'C๓d. Natureza')"		,"SED"	,"",050,.F.})
