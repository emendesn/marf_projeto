...
Local cMotBxFIDC	:= GetMv("MGF_FIN47A",,"DAC")	// Motivo da Baixa FIDC - Sem Movimento Banc�rio
...
do Case
	Case cBanco = '237'
		...
		cMotBxFIDC	:= GetMv("MGF_FIN48A",,"FIB")	// Motivo da Baixa FIDC Bradesco - Sem Movimento Banc�rio
	OtherWise
		cBcoFIDC	:= GetMv("MGF_FIN43A",,"341/1000/123456/001")	// Banco FIDC
		cMotBxFIDC	:= GetMv("MGF_FIN47A",,"FID")	// Motivo da Baixa FIDC - Sem Movimento Banc�rio
EndCase
