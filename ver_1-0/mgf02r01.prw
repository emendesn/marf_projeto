...
//����������������������������������������������������������������������������������������������������������������������������������������������������
//������������������������������������������������������������������������������������������������������������������������������������������������ͻ��
//���Programa  � MGF02R01	�Autor  � Geronimo Benedito Alves																	�Data �  13/12/17  ���
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.		� Rotina que mostra na tela os dados da planilha: COMPRAS - Acompanhamento Compras  (Modulo 02-COM)									���
...
User Function MGF02R01()
	...
	Aadd(_aDefinePl, "Almoxarifado - Acompanhamento Compras"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecera na regua de processamento.
	...
	Aadd(_aCampoQry, { "A1_NOME"	,"DESC_FILIAL					as DESCFILIAL"	,"Descricao da Filial"		,""	,""	,""	,""	,""	,""	})
	Aadd(_aCampoQry, { "A1_NOME"	,"SITUACAO_PEDIDO				as SITUPEDIDO"	,"Situacao do Pedido"		,""	,""	,""	,""	,""	,""	})
	Aadd(_aCampoQry, { "C7_NUM"		,"NUMERO_PEDIDO					as NUMEPEDIDO"	,"N� Pedido Compra"			,""	,""	,""	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "A2_COD"		,"COD_FORNECEDOR"								,"Cod. Fornecedor"			,""	,""	,""	,""	,""	,""	})
	Aadd(_aCampoQry, { "A2_NOME"	,"NOME_FORNECEDOR"								,"Nome Fornecedor"			,""	,""	,""	,""	,""	,""	})																																															  
	Aadd(_aCampoQry, { "F2_FILIAL"	,"COD_PRODUTO					as CODPRODUTO"	,"Produto"					,""	,""	,""	,""	,""	,""	})
	Aadd(_aCampoQry, { "C7_PRODUTO"	,"DESC_PRODUTO					as DESCPRODUT"	,"Descricao Produto"		,""	,""	,""	,""	,""	,""	})
	Aadd(_aCampoQry, { "BM_GRUPO"	,"COD_GRUPO_PRODUTO				as CODGRUPROD"	,"Codigo Grupo"				,""	,""	,""	,""	,""	,""	})
	Aadd(_aCampoQry, { "BM_DESC"	,"DESC_GRUPO_PRODUTO			as DESCGRUPRO"	,"Descricao Grupo"			,""	,""	,""	,""	,""	,""	})
	Aadd(_aCampoQry, { "X5_CHAVE"	,"COD_TIPO_PRODUTO				as CODTIPPROD"	,"Tipo de Produto"			,""	,""	,""	,""	,""	,""	})
	Aadd(_aCampoQry, { "X5_DESCRI"	,"DESC_TIPO_PRODUTO				as DESCTIPPRO"	,"Descricao Tipo do Produto",""	,""	,""	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "C7_ZVERSAO"	,"VERSAO_GRADE					as VERSAOGRAD"	,"Versao Grade"				,""	,""	,""	,""	,""	,""	})
	Aadd(_aCampoQry, { "CR_USER"	,"COD_APROV_N1 					as COD_APR_N1"	,"Codigo Usuario 1"			,""	,""	,""	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "CR_USER"	,"COD_APROV_N2 					as COD_APR_N2"	,"Cod. Usuario 2"			,""	,""	,""	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "CR_USER"	,"COD_APROV_N3 					as COD_APR_N3"	,"Cod. Usuario 3"			,""	,""	,""	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "CR_USER"	,"COD_APROV_N4 					as COD_APR_N4"	,"Cod. Usuario 4"			,""	,""	,""	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "CR_USER"	,"COD_APROV_N5 					as COD_APR_N5"	,"Cod. Usuario 5"			,""	,""	,""	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "C1_ZOBSEST"	,"OBSERVACAO_ESTOQUE"							,"Observacao Estoque"		,""	,""	,""	,""	,""	,""	}) 
	...
	aAdd(_aParambox,{1,"Codigo Produto Final"	,Space(tamSx3("B1_COD")[1])		,""	,"U_VLFIMMAI(MV_PAR03,MV_PAR04,'Codigo de Produto')","SB1"	,"",100,.F.})
	...
	cTituSitPC	:= "Marque Situa��es Possiveis a serem listadas: "
	...
	_cQuery += U_WhereAnd(!empty(_aRet[2]),    " DATA_PEDIDO_FILTRO  BETWEEN '"    + _aRet[1] + "' AND '" + _aRet[2] + "' " )	// OBRIGATORIO, COM A VALIDACAO DE 35 DIAS
	...
	_cQuery += U_WhereAnd(!empty(_aRet[6]),    " ID_SOLICITANTE_FILTRO BETWEEN '"  + _aRet[5] + "' AND '" + _aRet[6] + "' " )	// NAO OBRIGATORIO
	_cQuery += U_WhereAnd(!empty(_aRet[8]),    " COD_TIPO_PRODUTO BETWEEN '"       + _aRet[7] + "' AND '" + _aRet[8] + "' " )	// NAO OBRIGATORIO
	_cQuery += U_WhereAnd(!empty(cSituacaPC),  " SITUACAO_PEDIDO IN "              + cSituacaPC                             )	// NAO OBRIGATORIO (COMBO PARA SELECIONAR - SELECT PARA POPULAR O COMBO ABAIXO)
