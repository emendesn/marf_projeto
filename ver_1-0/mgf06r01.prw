...
//ฑฑบPrograma  ณ MGF06R01	บAutor  ณGeronimo Benedito Alves																	บData ณ29/12/17	บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: Financeiro -  Contas a Pagar - Duplicata Emissใo (M๓dulo 06-FIN)					บฑฑ
...
User Function MGF06R01()
	...
	Aadd(_aDefinePl, "CONTA A RECEBER - Duplicata_Emissใo"	)	//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	Aadd(_aDefinePl, "Duplicata_Emissใo"					)	//02-  _cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Duplicata_Emissใo"}					)	//03-  _cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Duplicata_Emissใo"}					)	//04-  _cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, {"A1_FILIAL"	,"COD_FILIAL"					,"C๓digo da Filial"		,"C",006	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"A1_NOME"		,"NOM_FILIAL"					,"Nome da Filial"		,"C",041	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"A1_COD"		,"COD_CLIENTE	as CODCLIENTE"	,"C๓digo do Cliente"	,"C",006	,0	,""							,""	,""	 })
	...
	Aadd(_aCampoQry, {"A1_NOME"		,"STATUS_TITULO	as STATUSTITU"	,"Status do Tํtulo"		,"C",040	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"E1_NATUREZ"	,"NATUREZA_TITULO as NATUREZATI","Natureza Titulo"		,"C",010	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"E1_SERIE"	,"SERIE_NF"						,"S้rie Nota Fiscal"	,"C",003	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"E1_NUMNOTA"	,"NUM_NF"						,"Nบ Nota Fiscal"		,"C",009	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"F2_PLIQUI"	,"VLR_PESO_LIQUIDO_NF"			,"Peso Liquido NF"		,	,		,	,""							,""	,""	 })
	Aadd(_aCampoQry, {"E1_VEND1"	,"COD_VENDEDOR	as CODVENDEDO"	,"C๓digo do Vendedor"	,"C",006	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"A3_NOME"		,"NOM_VENDEDOR	as NOMVENDEDO"	,"Nome do Vendedor"		,"C",040	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"E1_HIST"		,"OBSERVACAO"					,"Observa็ใo"			,"C",250	,0	,""							,""	,""	 })
	Aadd(_aCampoQry, {"E1_VALOR"	,"VLR_TITULO"					,"Valor do Tํtulo"		,"N",017	,2	,"@E 99,999,999,999.99"		,""	,""	 })
	Aadd(_aCampoQry, {"E1_VALOR"	,"VLR_TITULO_BRUTO"				,"Valor do Tํtulo Bruto","N",017	,2	,"@E 99,999,999,999.99"		,""	,""	 })
	Aadd(_aCampoQry, {"E1_VALOR"	,"VLR_TAXA_CARTAO"				,"Valor Taxa Cartใo"	,"N",017	,2	,"@E 99,999,999,999.99"		,""	,""	 })
	Aadd(_aCampoQry, {"E1_VALOR"	,"VLR_DEVOLUCAO	as VLRDEVOLUC"	,"Valor da Devolu็ใo"	,"N",017	,2	,"@E 99,999,999,999.99"		,""	,""	 })

	aAdd(_aParambox,{1,"Data Emissใo Inicial"	,Ctod("")						,""		,""													,""		,""	,050,.T.})
	aAdd(_aParambox,{1,"Data Emissใo Final"		,Ctod("")						,""		,"U_VLFIMMAI(MV_PAR01, MV_PAR02, 'Data')"			,""		,""	,050,.T.})
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),           " A.DT_EMISSAO_FILTRO	BETWEEN '" + _aRet[1] + "' AND '" + _aRet[2] + "' " ) // OBRIGATORIO, COM A VALIDAวรO DE 35 DIAS
	...
	_cQuery += U_WhereAnd( !empty(_aRet[8] ),           " A.COD_NATUREZA_FILTRO BETWEEN '" + _aRet[7] + "' AND '" + _aRet[8] + "' "	) // NรO OBRIGATORIO
	If empty(cPortaProd)
