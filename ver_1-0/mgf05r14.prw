...
//����������������������������������������������������������������������������������������������������������������������������������������������������
//������������������������������������������������������������������������������������������������������������������������������������������������ͻ��
//���Programa  � MGF05R14	�Autor  � Geronimo Benedito Alves                                                               �Data �  22/08/18  ���
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
...
//	aAdd(_aParambox,{1,"Data Entrega Final"		  ,Ctod("")						,""		,"U_VLFIMMAI(MV_PAR01, MV_PAR02, 'Data Entrega' )"		,""		,""	,050,.F.})
	...
	// Paulo Henrique - S� emite o relatorio se a data de emissao for menor de 90 dias
	If Mv_Par03 < (dDataBase - 90) .Or. Mv_Par04 > (dDataBase + 90)
	   ApMsgAlert(OemToAnsi("OS DADOS DEVER�O SER EMITIDOS DOS ULTIMOS 90 DIAS"),OemToAnsi("ATENCAO"))
	   Return
	EndIf
    ...
    // Paulo Henrique - 28/11/2019 - Separa��o das informacoes conforme marcacao do usuario
