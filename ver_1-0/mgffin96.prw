		...
		If !Empty(_cCaixa)
			...
			Else
				If _nSomZE0 == 0 // deriva de que a despesa esta incorreta em termos de valor ou nenhuma despesa foi marcada no Grid 
					Help(" ",1,'ERRO',,'Valor Total das Despesas Aprovadas esta Zerada: R$ ' + Transform(_nSomZE0, "@E 999,999,999,999.99") ,1,0,,,,,,{'Verifique os Valores das Despesas ou se houve marca��o no Grid' } ) 
					lRet := .F.
				EndIf	
			EndIf
		EndIf 
