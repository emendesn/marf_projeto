...
Data.....:              24/10/2016
Descricao / Objetivo:   Ponto de entrada da rotina de faturamento para chamada da funcao respons�vel pela medicao
...
User Function SF2460I()
	...
	If findfunction("u_xItensMed")
		// Monta array com itens para medicao
		aItensMed := u_xItensMed()
	Endif
	If findfunction("U_MGFGCT06")
		// Efetua chamada da rotina automatica de medi��es
		MsgRun("Aguarde, gerando medicao...","medicao",{|| U_MGFGCT06(aItensMed,_cChaveSE1)}) //SIGAGCT - Aguarde, processsando medicao...
	endif
	...
	If findfunction("u_MGFFATBD")
		// Corrigi data da emissao F2_EMISSAO conforme virada de hor�rio e parametro MV_HORARMT
		u_MGFFATBD()
	Endif
...
Autor....:              Roberto Sidney
Data.....:              21/09/2016
Descricao / Objetivo:   Monta array com itens para medicao de acordo com a nota
Doc. Origem:            VEN03 - GAP MGFVEN03
Solicitante:            Cliente
Uso......:              
Obs......:              Chamada efetuada atraves do ponto de entrada A410CONS()
