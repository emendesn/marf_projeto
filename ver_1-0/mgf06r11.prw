...
//ฑฑบPrograma  ณ MGF06R11	บAutor  ณ Geronimo Benedito Alves																	บData ณ  17/01/18  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: Financeiro -  Contas a Pagar - Ocorr๊ncia Abatimento			(M๓dulo 06-FIN)	บฑฑ
...
User Function MGF06R11()
	...
	Aadd(_aDefinePl, "Contas a Receber - Ocorr๊ncia Abatimento"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	Aadd(_aDefinePl, "Ocorr๊ncia Abatimento"					)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Ocorr๊ncia Abatimento"}					)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Ocorr๊ncia Abatimento"}					)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, {"E2_TIPO"		,"TIP_TITULO"							,"Tipo Tํtulo"				,"C",003	,0	,""						,""		,""	}) 
	...
	Aadd(_aCampoQry, {"E5_MOTBX"	,"COD_MOTIVOBAIXA		as MOTIVOBAIX"	,"C๓d. Motivo Baixa"		,"C",003	,0	,""						,""		,""	}) 
	...
	Aadd(_aCampoQry, {"E1_NATUREZ"	,"COD_NATUREZA_OPERACAO as CODNATUOPE"	,"C๓d. Natureza de Opera็ใo","C",010	,0	,""						,""		,""	}) 
	Aadd(_aCampoQry, {"E1_PORTADO"	,"COD_PORTADOR          as CODPORTADO"	,"C๓d. Portador"			,"C",003	,0	,""						,""		,""	}) 
	Aadd(_aCampoQry, {"E1_SERIE"	,"SERIE_NF"								,"S้rie NF"					,"C",003	,0	,""						,""		,""	}) 
	Aadd(_aCampoQry, {"E1_NUMNOTA"	,"NUM_NF"								,"Nบ NF"					,"C",009	,0	,""						,""		,""	}) 
	Aadd(_aCampoQry, {"E1_NUMBCO"	,"NUM_TIT_BANCO			as NUMTITBANC"	,"Nบ Titulo Banco"			,"C",015	,0	,""						,""		,""	}) 
...
//===		S E L E C I O N A	T I P O	D E		T I T U L O
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),       " DT_ABATIMENTO_FILTRO BETWEEN '" + _aRet[1] + "' AND '" + _aRet[2] + "' " ) // OBRIGATORIO, COM A VALIDAวรO DE 35 DIAS
	...
	_cQuery += U_WhereAnd( !empty(cTitulProd ),     " TIP_TITULO IN "                 + cTitulProd                             ) // NรO OBRIGATORIO
