...
//ฑฑบPrograma  ณ MGF34R01	บAutor  ณGeronimo Benedito Alves																	บData ณ  01/12/17  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: CONTABILIDADE - Estoque Pr้ - Contabilizado  (M๓dulo 34-CTB)						บฑฑ
...
User Function MGF34R01()
	...
	Aadd(_aDefinePl, "Contabilidade Gerencial - Estoque Pre Contabilizado"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {"A1_FILIAL"	, "COD_FILIAL"						,"C๓digo Filial"			,"C",012	,0, ""						,""		,""	}) 
	...
	Aadd(_aCampoQry, {"D3_COD"		,"COD_PRODUTO	as CODPRODUTO"		,"C๓digo do Produto"		,"C",015	,0, ""						,""		,""	})
	Aadd(_aCampoQry, {"B1_DESC"		,"DESC_PRODUTO	as DESCRPRODU"		,"Descri็ใo do Produto"		,"C",076	,0, ""						,""		,""	})
	...
	Aadd(_aCampoQry, {"CTT_CUSTO"	,"COD_C_CUSTO	as COD_C_CUST"		,"C๓digo C.Custo"			,"C",009	,0, ""						,""		,""	})
	Aadd(_aCampoQry, {"CTT_DESC01"	,"DESC_C_CUSTO	as DESC_C_CUS"		,"Descri็ใo C.Custo"		,"C",040	,0, ""						,""		,""	})
	Aadd(_aCampoQry, {"D3_CLVL"		,"CL_VALOR"							,"Classe de Valor"			,"C",009	,0, ""						,""		,""	})
	Aadd(_aCampoQry, {"B1_CONTA"	,"CONT_ERP"							,"Conta Contแbil"			,"C",020	,0, ""						,""		,""	})
	Aadd(_aCampoQry, {"CT1_DESC01"	,"CT1_DESC01"						,"Descri็ใo Conta Contแbil"	,"C",040	,0, ""						,""		,""	})
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2]),       " DT_MOVIMENTO_FILTRO BETWEEN '"   + _aRet[1]   + "' AND '" + _aRet[2] + "' " ) //OBRIGATORIO (USUมRIO DIGITA) 
	_cQuery += U_WhereAnd( !empty(_aRet[4]),       " CONT_ERP	BETWEEN '"            + _aRet[3]   + "' AND '" + _aRet[4] + "' " ) //NรO ษ OBRIGATORIO (USUมRIO DIGITA)
	_cQuery += U_WhereAnd( !empty(_aRet[6]),       " COD_C_CUSTO BETWEEN '"           + _aRet[5]   + "' AND '" + _aRet[6] + "' " ) //NรO ษ OBRIGATORIO (USUมRIO DIGITA)
	_cQuery += U_WhereAnd( !empty(_aRet[8]),       " CL_VALOR BETWEEN '"              + _aRet[7]   + "' AND '" + _aRet[8] + "' " ) //NรO ษ OBRIGATORIO 
