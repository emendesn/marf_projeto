...
//ฑฑบPrograma  ณ MGF09R01	บAutor  ณ Geronimo Benedito Alves                                                                   บData ณ  20/06/18  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: Financeiro -  Livros Fiscais - NF-e Pack                       (M๓dulo 09-FIS )  บฑฑ
//ฑฑบ			ณ Dados sao obtidos e mostrados na tela atrav้z da execu็ใo de query, e depois, pode-se gerar uma planilha excel com eles          บฑฑ
...
User Function MGF09R01()
	...
	Aadd(_aDefinePl, "Livros Fiscais - NF-e Pack"	)	//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {"F1_FILIAL"	,"EMPRESA"				,"C๓d. Filial"			,"C",006	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"XXF1_DOC"	,"NUM_NFE"				,"Nบ NFE"				,"C",010	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"XXF1SERIE"	,"SER_NFE"				,"Serie NFE"			,"C",005	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"F1_EMISSAO"	,"DAT_EMISSAO"			,"Data Emissใo"			,"D",008	,0	,"" 					,"" 	,"" })
	...
	Aadd(_aCampoQry, {"ED_DESCRIC"	,"NATUREZA_OPERACAO"	,"Natureza da Opera็ใo"	,"C",050	,0	,"" 					,"" 	,"" })
	...
	//Aadd(_aCampoQry, {"A2_COD"		,"COD_FORNECEDOR"		,"C๓d. Fornecedor"		,"C",006	,0	,""						,"" 	,"" })
	...
	Aadd(_aCampoQry, {"A2_INSCR"	,"INSCRICAO_ESTADUAL"	,"Inscri็ใo Estadual"	,""	,""		,""	,""						,"" 	,"" })
	...
	Aadd(_aCampoQry, {"A3_COD"		,"CODIGO_VENDEDOR"		,"C๓d. Vendedor"		,"C",006	,0	,"" 					,"" 	,"" })
	...
	aAdd(_aParambox,{1,"Grupo Tributแrio Inicial"	,Space(tamSx3("A1_COD")[1])	,""	,""															,"ZA"		,"",050,.F.})
	aAdd(_aParambox,{1,"Grupo Tributแrio Final"		,Space(tamSx3("A1_COD")[1])	,""	,"U_VLFIMMAI(MV_PAR07, MV_PAR08	,'Grupo Tributแrio')" 		,"ZA"		,"",050,.F.})
	...
	cTitTipPes	:= "Marque os Status de solicita็๕es เ serem listadas: "
	...
	_cQuery += U_WhereAnd( !empty(_cTpPessoa),		" TIPO_PESS IN "                     + _cTpPessoa                                ) //NรO OBRIGATORIO
	...
	//	_cQuery += U_WhereAnd( !empty(_cForn_Cli ),	" TP_FORNCLIE = '"          		 + _cForn_Cli + "' "	                	 ) // NรO OBRIGATORIO
	//Endif
