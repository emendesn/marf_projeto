...
//ฑฑบPrograma  ณ MGF06R17	บAutor  ณ Geronimo Benedito Alves																	บData ณ  23/04/18  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: Financeiro -  Contas a Receber - Rela็ใo de Clientes				(M๓dulo 06-FIN)บฑฑ
...
User Function MGF06R17()
	...
	Aadd(_aDefinePl, "Contas a Receber - Rela็ใo de Clientes"	)	//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	Aadd(_aDefinePl, "Rela็ใo de Clientes"						)	//02-  _cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Rela็ใo de Clientes"}					)	//03-  _cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Rela็ใo de Clientes"}					)	//04-  _cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, {"A1_COD"		,"COD_CLIENTE			as COD_CLIENT"	,"C๓d. Cliente"			,"C",006	,0	,""	,""		,""	 })
	...
	Aadd(_aCampoQry, {"A1_COND"		,"COD_COND_PAGAMENTO	as CODCONDPGT"	,"C๓d. Cond. Pgto"		,"C",003	,0	,""	,""		,""	 })
	Aadd(_aCampoQry, {"A2_NOME"		,"COND_PAGAMENTO		as COND_PAGTO"	,"Condi็ใo de Pagto"	,"C",015	,0	,""	,""		,""	 })
	Aadd(_aCampoQry, {"A1_LC"		,"LIMITE_CREDITO		as LIMITECRED"	,"Limite Credito"		,"N",014	,2	,""	,""		,""	 })
	Aadd(_aCampoQry, {"A1_VENCLC"	,"VENC_LIM_CREDITO		as VENCLIMCRE"	,"Venc. Limite Cr้dito"	,"D",008	,0	,""	,""		,""	 })
	...
	Aadd(_aCampoQry, {"A1_END"		,"ENDERECO"								,"Endere็o"				,"C",080	,0	,""	,""		,""	 })
	...
	Aadd(_aCampoQry, {"A1_NATUREZ"	,"COD_NATUREZA			as SALDOTITUL"	,"C๓d. Natureza"		,"C",010	,0	,""	,""		,""	 })
	Aadd(_aCampoQry, {"ED_DESCRIC"	,"NATUREZA"								,"Natureza"				,"C",030	,0	,""	,""		,""	 })
	Aadd(_aCampoQry, {"COD_CNAE"	,"COD_CNAE"								,"C๓d. CNAE"			,"C",009	,0	,""	,""		,""	 })
