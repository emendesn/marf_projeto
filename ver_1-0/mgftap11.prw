...
Data.....:              24/11/2016
Descricao / Objetivo:   Integraï¿½ï¿½o PROTHEUS x Taura - Processos Produtivos
Doc. Origem:            Contrato - GAP TAURA
Solicitante:            Cliente
Uso......:              Marfrig
Obs......:              Integração Quantidades do Armazém Produtivo (02)
						Envia ao Taura os produtos transferidos ao Armazém Produtivo
						16/02/2017 - Considera diversos armazéns
=====================================================================================
*/
...
User Function MGFTAP11()
	...
	Else
		...
		*/
		...
		ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
		*/
		//RpcSetType(3) 		// Seta job para nao consumir licenças
		...
		cArmPrd	:= GetMv("MGF_TAP11A",,"02/04/06/")
		dDatIni	:= GetMv("MGF_TAP11F",,STOD("20170614")) 	 // Data Início - Referência para Averbação RCTRC
