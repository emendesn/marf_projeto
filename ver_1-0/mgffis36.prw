...
//GAP apenas para o Rio Grande do Sul, Notas de complemento de ICMS (I) e CFOPs espec�ficos
If cUFFil == 'RS';
 .AND. cTpDOC == 'I' ;
 .AND. (IIF(Empty(cCFAtu),.F.,cCFAtu $ cCFDev) .OR. lExcl) //Se for exclusao nao precisa validar o CFOP.
	...
	//3 - Valida na exclusao se o NCC j� sofreu baixa.
	If nOpc = 1
		lRet := FIS36VCli()
	ElseIf nOpc = 2
		lRet := FIS36NCC()
...
//Autor...............: Natanael Filho
//Data................: 15/JUNHO/2018 
//Desc:...............: Valida na exclusao se o NCC j� sofreu baixa.
//===========================================================
