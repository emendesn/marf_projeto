...
Solicitante.........: Cliente
Uso.................: 
Obs.................: Carrega os rateios na Medi��o
=====================================================================================
*/
user function MGFCTB12()
	...
	If Empty(CND_CLIENT)
		If Empty(CND->CND_DTFIM) .AND. CND->CND_ALCAPR = 'L'  	.AND. CND->CND_AUTFRN == '1'	.AND. CND->CND_SERVIC == '1'
			...
			EndIf
		Else
			MsgInfo('S� � possivel incluir rateio em medicao que estao com status de aberto')
		EndIf
	Else
		MsgInfo('S� � possivel incluir rateio em medi��es de Compras')
	EndIf
return
