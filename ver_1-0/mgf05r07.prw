...
//ฑฑบPrograma  ณ MGF05R07	บAutor  ณ Geronimo Benedito Alves																	บData ณ  11/07/18  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: FATURAMENTO - Devolu็ใo X AR   (M๓dulo 05-FAT)                                   บฑฑ
...
User Function MGF05R07()
	...
	Aadd(_aDefinePl, "Faturamento - Devolu็ใo X AR"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	Aadd(_aDefinePl, "Devolu็ใo X AR"				)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Devolu็ใo X AR"}				)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Devolu็ใo X AR"}				)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, { "F1_TIPO"	,"TIPO_OPERACAO_NF"		,"Tipo Opera็ใo NF"			,""		,""	,	,""		,""		,""		})
	Aadd(_aCampoQry, { "ZZH_AR"		,"NUMERO_AR"			,""							,""		,""	,	,""		,""		,""		})
	Aadd(_aCampoQry, { "F1_DTDIGIT"	,"DT_DIGITACAO"			,"Data Lan็amento NF"		,""		,""	,	,""		,""		,""		})
	...
	Aadd(_aCampoQry, { "F1_FORNECE"	,"COD_CLIENTE"			,"C๓digo Cliente"			,""		,""	,	,""		,""		,""		})
	...
	aAdd(_aParambox,{1,"Data Lan็amento NF Inicial"	,Ctod("")		,""	,""														,""		,""	, 050,.T.})
	aAdd(_aParambox,{1,"Data Lan็amento NF Final"	,Ctod("")		,""	,"U_VLFIMMAI(MV_PAR01, MV_PAR02, 'Data Lan็amento NF')"	,""		,""	, 050,.T.})
