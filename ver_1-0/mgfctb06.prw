...
Elseif mv_par04 == 1 .and. mv_par07 == 1 .and. mv_par10 == 2 .and. mv_par13 == 1
	...
	lComp := .T.
	cTipo := "12"
	ApMsgStop("Parametros para considerar Entidades Cont�beis ('Sim'/'Nao'), incorretos para execucao desta rotina.")
	Return()
	cTipo := "12"
...
Elseif mv_par04 == 2 .and. mv_par07 == 1 .and. mv_par10 == 1 .and. mv_par13 == 1
	...
	Return()
	cTipo := "14"
	//APMsgStop("Conta Cont�bil nao considerada."+CRLF+;
	//"Considere sempre a Conta Cont�bil nesta rotina.")
	//Return()
...
If cMv == "mv_par04" .and. mv_par04 != 1
	lRet := .F.
	MsgStop("Informe 'Sim' para Considerar a Conta Cont�bil.")
Endif
