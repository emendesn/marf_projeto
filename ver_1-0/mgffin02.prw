...
If !IsInCallStack('U_MGFCOM15')
	If Empty(xcod) .OR. Empty(xLoja) 
		Alert("Para preencher o campo � necessario informar primeiro o Codigo/Loja do fornecedor!")
...
(cAlias1)->(DbGoTop())
If (cAlias1)->(Eof())
	Aviso( "Pecuaristas", "Nao existem contas banc�rias cadastradas para o pecuarista.", {"Ok"} )
	Return .F.
Endif
