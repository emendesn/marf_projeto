...
Solicitante.........: Cliente
Uso.................: 
Obs.................: Tela para permitir alteracao do parametro MV_SPEDEXC
=====================================================================================
*/
...
@ 000, 000 TO 160,400 DIALOG oDlg TITLE "Parametro 'MV_SPEDEXC'"
...
If nOpcA == 1 .and. nHoras != nHorasSav
	If lOk .and. MsgYesNo("Deseja realmente atualizar o parametro ?") 
		...
		ProcLogAtu("FIM","Processamento de alteracao do parametro 'MV_SPEDEXEC' pela rotina 'MGFFIS41'",cDet,,.T.)
