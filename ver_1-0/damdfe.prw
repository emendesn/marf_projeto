...
Do Case
	Case Type("oCab:_MDFE:_INFMDFE:_EMIT:_CNPJ")=="O"
		cAux := TransForm(oCab:_MDFE:_INFMDFE:_EMIT:_CNPJ:TEXT,"@r 99.999.999/9999-99")
	Case Type("oCab:_MDFE:_INFMDFE:_EMIT:_CPF")=="O"
		cAux := TransForm(oCab:_MDFE:_INFMDFE:_EMIT:_CPF:TEXT,"@r 999.999.999-99")
	OtherWise
		cAux := Space(14)
EndCase

oDamdfe:Say(0098, 0005, 'CNPJ/CPF: ' + cAux, oFont08)
