...
Data................: 28/05/2019
Descrição / Objetivo: Relatório Logistica - Devolução Cross Docking. 
Doc. Origem.........: 
Solicitante.........: Priscilla Sombini
Uso.................: Marfrig
Obs.................: Relatório Devolução Cross Docking.
=====================================================================================
*/
...
User Function MGF78R05()
	...
	Aadd(_aDefinePl, "Relatório Devolução Cross Docking"		)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerá na regua de processamento.
	Aadd(_aDefinePl, "Devolução Cross Docking"					)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Devolução Cross Docking"}				)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Devolução Cross Docking"}				)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, { "N_NF"					,"N_NF"										,"Número da NF"				,"C",015,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "SERIE_NF"				,"SERIE_NF"									,"Série da NF"				,"C",004,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "COD_CLIENTE"			,"COD_CLIENTE"								,"Cód. Cliente"				,"C",015,0	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "N_RAMI"					,"N_RAMI"									,"Número da RAMI"			,"C",006,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "DT_EMISSAO"				,"DT_EMISSAO"								,"Data Emissão"				,"D",008,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "DT_DIGITACAO"			,"DT_DIGITACAO"								,"Data Digitação"			,"D",008,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "DT_LANCAMENTO"			,"DT_LANCAMENTO"							,"Data de Lançamento"		,"D",008,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "CIDADE_ORIGEM_2_TRECHO"	,"CIDADE_ORIGEM_2_TRECHO"					,"Cidade Origem 2 Trecho"	,"C",060,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "N_NF_ORIGEM"			,"N_NF_ORIGEM"								,"Número NF Origem"			,"C",015,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "SERIE_NF_ORIGEM"		,"SERIE_NF_ORIGEM"							,"Série NF Origem"			,"C",004,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "N_PEDIDO_ORIGEM"		,"N_PEDIDO_ORIGEM"							,"Núm. Pedido Origem"		,"C",015,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "QTDE_NF_ORIGEM"			,"QTDE_NF_ORIGEM"							,"Qtde. NF Origem"			,"N",017,4	,"@E 999,999,999,999.9999"	,""	,""	})
	Aadd(_aCampoQry, { "COD_TRASPORTADOR"		,"COD_TRASPORTADOR"							,"Cód. Transportador"		,"C",015,0	,""	,""	,""	})																																												  
	Aadd(_aCampoQry, { "NM_TRANSPORTADOR"		,"NM_TRANSPORTADOR"							,"Nome Transportador"		,"C",040,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "N_OE"					,"N_OE"										,"Número OE"				,"C",008,0	,""	,""	,""	})
	//Aadd(_aCampoQry, { "F1_EMISSAO"				,"F1_EMISSAO    AS DT_EMISSAO_FILTRO"		,"Data Emissão Filtro"		,"D",008,0	,""	,""	,""	})
	//Aadd(_aCampoQry, { "F1_DTLANC"				,"F1_DTLANC		AS DT_LANCAMENTO_FILTRO"	,"Data Lançamento Filtro"	,"D",008,0	,""	,""	,""	})																																													  
	
																																							
	aAdd(_aParambox,{1,"Data Digitação Inicial"	,Ctod("")						,""		,""													,""		,""	,050,.F.})			// 01
	aAdd(_aParambox,{1,"Data Digitação Final"	,Ctod("")						,""		,"U_VLFIMMAI(MV_PAR01, MV_PAR02, 'Data Digitação')"	,""		,""	,050,.F.})			// 02
	...
	aAdd(_aParambox,{1,"RAMI Até "				,Space(tamSx3("ZAV_CODIGO")[1])	,""		,"U_VLFIMMAI(MV_PAR05, MV_PAR06, 'RAMI')"			,""		,,050,.F.}) //06
	aAdd(_aParambox,{1,"Nota Fiscal De "		,Space(tamSx3("F2_DOC")[1])		,""		,""													,""		,,050,.F.}) //07
	aAdd(_aParambox,{1,"Nota Fiscal Até "		,Space(tamSx3("F2_DOC")[1])		,""		,"U_VLFIMMAI(MV_PAR07, MV_PAR08, 'Nota Fiscal')"	,""		,,050,.F.}) //08
	aAdd(_aParambox,{1,"Número OE De "			,Space(tamSx3("F2_DOC")[1])		,""		,""													,""		,,050,.F.}) //09
	aAdd(_aParambox,{1,"Número OE Até "			,Space(tamSx3("F2_DOC")[1])		,""		,"U_VLFIMMAI(MV_PAR09, MV_PAR10, 'Grp. Produto')"	,""		,,050,.F.}) //10
	...
	cTitCidade	:= "Seleção Cidade Origem: "
