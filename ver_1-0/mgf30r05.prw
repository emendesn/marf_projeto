...
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.		� Rotina que mostra na tela os dados da planilha: EEC-Easy Financing - 30 -Financiamento-Ordens Importacao antec. Pagos       ���
...
User Function MGF30R05()
	...
	Aadd(_aDefinePl,  "Financiamento-Ordens Importacao Antec. Pagos"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecer� na regua de processamento.
	Aadd(_aDefinePl,  "Ordens Importacao Antec. Pagos"	)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Ordens Importacao Antec. Pagos"}	)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Ordens Importacao Antec. Pagos"}	)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
