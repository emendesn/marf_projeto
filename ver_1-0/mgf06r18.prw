...
//����������������������������������������������������������������������������������������������������������������������������������������������������
//������������������������������������������������������������������������������������������������������������������������������������������������ͻ��
//���Programa  � MGF06R18	�Autor  � Geronimo Benedito Alves																	�Data �  20/06/18  ���
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.		� Rotina que mostra na tela os dados da planilha: Financeiro -  Contas a Receber - Titulos Recebiveis				(Modulo 06-FIN)���
...
User Function MGF06R18()
	...
	Aadd(_aDefinePl, "Contas a Receber - Titulos Receb�veis"	)	//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecer� na regua de processamento.
	Aadd(_aDefinePl, "Titulos Receb�veis"						)	//02-  _cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Titulos Receb�veis"}						)	//03-  _cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Titulos Receb�veis"}						)	//04-  _cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, {"E1_FILIAL"	,"COD_FILIAL"			,"Cod. Filial"			,"C",006	,0	,"" 						,"" 	,"" })
	Aadd(_aCampoQry, {"A1_NOME"		,"NOM_FILIAL"			,"Nome Filial"			,"C",040	,0	,"" 						,"" 	,"" })
	Aadd(_aCampoQry, {"NUM_PREFIXO"	,"NUM_PREFIXO"			,"Prefixo"				,"C",003	,0	,"" 						,"" 	,"" })
	Aadd(_aCampoQry, {"NUM_TITULO"	,"NUM_TITULO"			,"N� Titulo"			,"C",009	,0	,"" 						,"" 	,"" })
	Aadd(_aCampoQry, {"NUM_EXP"		,"NUM_EXP"				,"Num EXP"				,"C",030	,0	,""							,"" 	,"" })
	Aadd(_aCampoQry, {"E1_MOEDA"	,"COD_MOEDA"			,"Moeda"				,"N",002	,0	,""							,"" 	,"" })
	Aadd(_aCampoQry, {"XXE1_MOEDA"	,"DESC_MOEDA"			,"Descricao da Moeda"	,"C",015	,0	,""							,"" 	,"" })
	Aadd(_aCampoQry, {"COD_CLIENTE"	,"COD_CLIENTE"			,"Cod. Cliente"			,"C",006	,0	,""							,"" 	,"" })
	Aadd(_aCampoQry, {"NOM_CLIENTE"	,"NOM_CLIENTE"			,"Nome Cliente"			,"C",040	,0	,""							,"" 	,"" })
	Aadd(_aCampoQry, {"COD_LOJA"	,"COD_LOJA"				,"Cod Loja"				,"C",002	,0	,""  						,"" 	,"" })
