...
//����������������������������������������������������������������������������������������������������������������������������������������������������
//������������������������������������������������������������������������������������������������������������������������������������������������ͻ��
//���Programa  � MGF34R22	�Autor  � Geronimo Benedito Alves																	�Data �  12/08/18  ���
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.		� Rotina que mostra na tela os dados da planilha: Contabilidade Gerencial - SD3 (Modulo 34-CTB)                                    ���
...
//������������������������������������������������������������������������������������������������������������������������������������������������ͼ��
//���Alteracoes		� Data: 22-01-2019 � Inclusao de dois novos campos na query classe valor e descricao classe valor 			   ���
//������������������������������������������������������������������������������������������������������������������������������������������������ͼ��
//����������������������������������������������������������������������������������������������������������������������������������������������������
...
User Function MGF34R23()
	...
	Aadd(_aDefinePl, "Contabilidade Gerencial - SD3"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecer� na regua de processamento.
	...
	aAdd(_aParambox,{1,"Codigo Produto Inicial"		,Space(tamSx3("D3_COD")[1])		,"@!"	,""														,"SB1"	,""	, 075,.F.})
	aAdd(_aParambox,{1,"Codigo Produto Final"		,Space(tamSx3("D3_COD")[1])		,""		,"U_VLFIMMAI(MV_PAR03, MV_PAR04,'Codigo Fornecedor')"	,"SB1"	,""	, 075,.F.})
	aAdd(_aParambox,{1,"Tipo Movimento Inicial"		,Space(tamSx3("D3_TM")[1])		,"@!"	,""														,"SF5"	,""	, 050,.F.})
	aAdd(_aParambox,{1,"Tipo Movimento Final"		,Space(tamSx3("D3_TM")[1])		,""		,"U_VLFIMMAI(MV_PAR05, MV_PAR06,'Conta Cont�bil')"		,"SF5"	,""	, 050,.F.})
	aAdd(_aParambox,{1,"Centro de Custo Inicial"	,Space(tamSx3("CTT_CUSTO")[1])	,"@!"	,""														,"CTT"	,""	, 075,.F.})
	aAdd(_aParambox,{1,"Centro de Custo Final"		,Space(tamSx3("CTT_CUSTO")[1])	,""		,"U_VLFIMMAI(MV_PAR07, MV_PAR08,'Codigo Fornecedor')"	,"CTT"	,""	, 075,.F.})
	...
	_cQuery += U_WhereAnd(!empty(_cCODFILIA ),     " COD_FILIAL IN "                + _cCODFILIA                             ) //OBRIGATORIO, SELE��O POR FILIAL
	...
	_cQuery += U_WhereAnd(!empty(_aRet[6] ),       " COD_TP_MOVIMENTO    BETWEEN '" + _aRet[5] + "' AND '" + _aRet[6] + "' " ) //NAO OBRIGATORIO
	_cQuery += U_WhereAnd(!empty(_aRet[8] ),       " COD_C_CUSTO         BETWEEN '" + _aRet[7] + "' AND '" + _aRet[8] + "' " ) //NAO OBRIGATORIO
