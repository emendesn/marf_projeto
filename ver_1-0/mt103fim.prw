...
User function MT103Fim()
	...
	// Paulo da Mata - 23/06/2020 - S� passa por aqui, no ato da entrada da note, via importacao do CTE	
	...
	If FindFunction("U_MGFCRM49")
		If PARAMIXB[2] == 1 // Se o usuario confirmou a operacao de gravacao da NFECODIGO DE APLICA��O DO USUARIO
