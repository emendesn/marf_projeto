...
//����������������������������������������������������������������������������������������������������������������������������������������������������
//������������������������������������������������������������������������������������������������������������������������������������������������ͻ��
//���Programa  � MGF30R02	�Autor  � Geronimo Benedito Alves                                                                   � Data � 13/06/18  ���
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.     � Rotina que mostra na tela os dados da planilha:                                                                                   ���
//���          � EFF-Easy Financing - 30 -Financiamento - Ordens de Pagamento com Saldo                                                            ���
...
User Function MGF30R02()
	...
	Aadd(_aDefinePl, "Financiamento - Ordens de Pagamento com Saldo")	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecer� na regua de processamento.
	...
	aAdd(_aParambox,{1,"Codigo de Cliente Inicial"	,Space(tamSx3("A1_COD")[1])	,"@!",""													,"SA1"	,"",050,.F.}) 
	aAdd(_aParambox,{1,"Loja   do Cliente Inicial"	,Space(tamSx3("A1_LOJA")[1]),"@!",""													,""		,"",050,.F.}) 
	aAdd(_aParambox,{1,"Codigo de Cliente Final"	,Space(tamSx3("A1_COD")[1])	,"@!","U_VLFIMMAI(MV_PAR01, MV_PAR03, 'Codigo de Cliente')"	,"SA1"	,"",050,.F.})													
	...
	_cQuery += U_WhereAnd( !empty(_cCODFILIA),         " COD_FILIAL IN "         + _cCODFILIA                                 ) // OBRIGATORIO (SELE��O DO COMBO)  CAMPO EMPRESAS(02 posicoes)
	_cQuery += U_WhereAnd( !empty(_aRet[3]),         " COD_CLIENTE BETWEEN '"  + _aRet[01] + "' AND '" + _aRet[03] + "' " ) // NAO OBRIGATORIO, USUARIO COLOCA O CODIGO DE/ATE (RANGE)
	_cQuery += U_WhereAnd( !empty(_aRet[4]),         " LOJA_CLIENTE BETWEEN '" + _aRet[02] + "' AND '" + _aRet[04] + "' " ) // NAO OBRIGATORIO, USUARIO COLOCA O CODIGO DE/ATE (RANGE)
