...
MontaCab()
IF Len(aBrowse) = 0 
     MsgAlert('Nao h� dados para o filtro selecionado !')
     Return
ENDIF
...
IF nTipo == 1 //Estoque
    cTexto := 'Estoque'
	aLegenda := { {"BR_VERDE"    ,"Dispon�vel para Uso"},;
				  {"BR_VERMELHO" ,cParBloqueio}}
ENDIF

IF nTipo == 2 // Solicita��o Armazem
   cTexto := 'Solic. Armazem'
   aLegenda := {{"BR_VERDE"    ,"Pendente"},;
                {"BR_VERMELHO" ,"Gerada Pr� Requisi��o"},;
				{'BR_CINZA'    ,"Bloqueado"} }
EndIF
...
IF nTipo == 5 //Solicita��o de Compra
    cTexto := 'Solic. Compra'
	aLegenda := { {"BR_VERDE"   ,"Solicita��o em Aberto"},;
					{'BR_LARANJA' ,"Solicita��o Rejeitada"},;
					{'BR_CINZA'   ,"Solicita��o Bloqueada"},;
					{'BR_AMARELO' ,"Solicita��o com Pedido Colocado Parcial"},;
					{'BR_AZUL'    ,"Solicita��o em Processo de Cota��o"}}
