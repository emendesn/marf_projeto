...
=============================================================================================
=>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> Hist๓rico de Altera็๕es <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<|
=============================================================================================
|   Data    |               Altera็ใo              				 |    Autor     |  Chamado  |
=============================================================================================
|12/12/2018 |Cria็ใo do Relat๓rio de saldo de Estoque com OP     |Eduardo Donato|           |
|  /  /     |                                                    |              |           | 
=============================================================================================
...
User Function MGF04R05()
	...
	//Cria as defini็๕es do relat๓rio
	oReport := fReportDef()

	//Serแ enviado por e-Mail?
	If lEmail
...
Static Function fReportDef()
	...
	oReport := TReport():New(	"MGF6999",;		//Nome do Relat๓rio
	"Relatorio de Saldo Estoque",;		//Tํtulo
	...
	{"QRY_AUX"})	//Tabelas utilizadas, a primeira serแ considerada como principal da se็ใo
	oSectDad:SetTotalInLine(.F.)  //Define se os totalizadores serใo impressos em linha ou coluna. .F.=Coluna; .T.=Linha
...
ฑฑบPrograma  ณValidPerg บAutor  ณEduardo Donato     บ                    บฑฑ
...
Static Function AjustSX1()
	...
	AAdd(aRegs,{"01","Emissใo de ?" 	,"mv_ch1","D",8,0,0,"G","MV_PAR01","" ,"", "" })
	AAdd(aRegs,{"02","Emissใo at้ ?"	,"mv_ch2","D",8,0,0,"G","MV_PAR02","" ,"", "" })
	AAdd(aRegs,{"03","Armazem de ?"		,"mv_ch3","C",tamSX3("B2_LOCAL")[1],0,0,"G","MV_PAR03","" ,"", "" })
	AAdd(aRegs,{"04","Armazem at้ ?"	,"mv_ch4","C",tamSX3("B2_LOCAL")[1],0,0,"G","MV_PAR04","" ,"", "" })
	AAdd(aRegs,{"05","Produto de ?"		,"mv_ch5","C",tamSX3("B1_COD")[1],0,0,"G","MV_PAR05","" ,"", "SB1" })
	AAdd(aRegs,{"06","Produto at้ ?"	,"mv_ch6","C",tamSX3("B1_COD")[1],0,0,"G","MV_PAR06","" ,"", "SB1" })
	...
	AAdd(aRegs,{"09","OP Taura at้ ?"	,"mv_ch9","C",tamSX3("C2_ZOPTAUR")[1],0,0,"G","MV_PAR09","" ,"", "SC2" })
