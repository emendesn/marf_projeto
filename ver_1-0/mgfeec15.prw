...
//		Set Filter to ALLTRIM(ZZJ_PEDIDO) == Alltrim(EE7->(EE7_ZEXP+EE7_ZANOEX+EE7_ZSUBEX))
	...
	Elseif IsInCallStack("EECAE100") //Inclu�do por Barbieri em 11/2016 com dados da tabela EEC       
...
@param cOrcam, character, numero do or�amento caso nao tenha pedido
/*/
