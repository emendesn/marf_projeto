...
user function MGFCRM32(cA1Cod, cA1Loj)
	...
	DEFINE MSDIALOG oDlg1 TITLE OemToAnsi("Transferencia - Estrutura de Vendas") FROM aSizeWnd[1],aSizeWnd[2] TO aSizeWnd[3],aSizeWnd[4] PIXEL
		...
		oGrid1:addColumn({"Cód. Nível 1"		, {||aOri[oGrid1:nAt,1]}	, "C",, 1, 035	,, .F.})
		oGrid1:addColumn({"Nível 1"				, {||aOri[oGrid1:nAt,2]}	, "C",, 1, 100	,, .F.})
		oGrid1:addColumn({"Cód. Representante"	, {||aOri[oGrid1:nAt,3]}	, "C",, 1, 035	,, .F.})
		oGrid1:addColumn({"Representante"		, {||aOri[oGrid1:nAt,4]}	, "C",, 1, 100	,, .F.})
		oGrid1:addColumn({"Cód. Nível 2"		, {||aOri[oGrid1:nAt,5]}	, "C",, 1, 035	,, .F.})
		oGrid1:addColumn({"Nível 2"				, {||aOri[oGrid1:nAt,6]}	, "C",, 1, 100	,, .F.})
		oGrid1:addColumn({"Cód. Representante"	, {||aOri[oGrid1:nAt,7]}	, "C",, 1, 035	,, .F.})
		oGrid1:addColumn({"Representante"		, {||aOri[oGrid1:nAt,8]}	, "C",, 1, 100	,, .F.})
		oGrid1:addColumn({"Cód. Nível 3"		, {||aOri[oGrid1:nAt,9]}	, "C",, 1, 035	,, .F.})
		oGrid1:addColumn({"Nível 4"				, {||aOri[oGrid1:nAt,10]}	, "C",, 1, 100	,, .F.})
		oGrid1:addColumn({"Cód. Representante"	, {||aOri[oGrid1:nAt,11]}	, "C",, 1, 035	,, .F.})
		oGrid1:addColumn({"Representante"		, {||aOri[oGrid1:nAt,12]}	, "C",, 1, 100	,, .F.})
		oGrid1:addColumn({"Cód. Nível 4"		, {||aOri[oGrid1:nAt,13]}	, "C",, 1, 035	,, .F.})
		oGrid1:addColumn({"Nível 4"				, {||aOri[oGrid1:nAt,14]}	, "C",, 1, 100	,, .F.})
		oGrid1:addColumn({"Cód. Representante"	, {||aOri[oGrid1:nAt,15]}	, "C",, 1, 035	,, .F.})
		oGrid1:addColumn({"Representante"		, {||aOri[oGrid1:nAt,16]}	, "C",, 1, 100	,, .F.})
		oGrid1:addColumn({"Cód. Nível 5"		, {||aOri[oGrid1:nAt,17]}	, "C",, 1, 035	,, .F.})
		oGrid1:addColumn({"Nível 5"				, {||aOri[oGrid1:nAt,18]}	, "C",, 1, 100	,, .F.})
		oGrid1:addColumn({"Cód. Representante"	, {||aOri[oGrid1:nAt,19]}	, "C",, 1, 035	,, .F.})
		...
		oGrid2:addColumn({"Cód. Nível 1"		, {||aDest[oGrid2:nAt,1]}	, "C",, 1, 035	,, .F.})
		oGrid2:addColumn({"Nível 1"				, {||aDest[oGrid2:nAt,2]}	, "C",, 1, 100	,, .F.})
		oGrid2:addColumn({"Cód. Representante"	, {||aDest[oGrid2:nAt,3]}	, "C",, 1, 035	,, .F.})
		oGrid2:addColumn({"Representante"		, {||aDest[oGrid2:nAt,4]}	, "C",, 1, 100	,, .F.})
		oGrid2:addColumn({"Cód. Nível 2"		, {||aDest[oGrid2:nAt,5]}	, "C",, 1, 035	,, .F.})
		oGrid2:addColumn({"Nível 2"				, {||aDest[oGrid2:nAt,6]}	, "C",, 1, 100	,, .F.})
		oGrid2:addColumn({"Cód. Representante"	, {||aDest[oGrid2:nAt,7]}	, "C",, 1, 035	,, .F.})
		oGrid2:addColumn({"Representante"		, {||aDest[oGrid2:nAt,8]}	, "C",, 1, 100	,, .F.})
		oGrid2:addColumn({"Cód. Nível 3"		, {||aDest[oGrid2:nAt,9]}	, "C",, 1, 035	,, .F.})
		oGrid2:addColumn({"Nível 4"				, {||aDest[oGrid2:nAt,10]}	, "C",, 1, 100	,, .F.})
		oGrid2:addColumn({"Cód. Representante"	, {||aDest[oGrid2:nAt,11]}	, "C",, 1, 035	,, .F.})
		oGrid2:addColumn({"Representante"		, {||aDest[oGrid2:nAt,12]}	, "C",, 1, 100	,, .F.})
		oGrid2:addColumn({"Cód. Nível 4"		, {||aDest[oGrid2:nAt,13]}	, "C",, 1, 035	,, .F.})
		oGrid2:addColumn({"Nível 4"				, {||aDest[oGrid2:nAt,14]}	, "C",, 1, 100	,, .F.})
		oGrid2:addColumn({"Cód. Representante"	, {||aDest[oGrid2:nAt,15]}	, "C",, 1, 035	,, .F.})
		oGrid2:addColumn({"Representante"		, {||aDest[oGrid2:nAt,16]}	, "C",, 1, 100	,, .F.})
		oGrid2:addColumn({"Cód. Nível 5"		, {||aDest[oGrid2:nAt,17]}	, "C",, 1, 035	,, .F.})
		oGrid2:addColumn({"Nível 5"				, {||aDest[oGrid2:nAt,18]}	, "C",, 1, 100	,, .F.})
		oGrid2:addColumn({"Cód. Representante"	, {||aDest[oGrid2:nAt,19]}	, "C",, 1, 035	,, .F.})
