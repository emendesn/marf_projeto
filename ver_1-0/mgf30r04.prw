...
//����������������������������������������������������������������������������������������������������������������������������������������������������
//������������������������������������������������������������������������������������������������������������������������������������������������ͻ��
//���Programa  � MGF30R04	�Autor  � Geronimo Benedito Alves																	�Data �  25/05/18  ���
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.		� Rotina que mostra na tela os dados da planilha: EEF-Easy Financing - 30 -Financiamento-Ordens Importacao antec. � pagar		       ���
...
User Function MGF30R04()
	...
	Aadd(_aDefinePl,  "Financiamento-Ordens Importacao antec. � pagar"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecer� na regua de processamento.
	Aadd(_aDefinePl,  "Ordens Importacao antec. � pagar"	)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Ordens Importacao antec. � pagar"}	)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Ordens Importacao antec. � pagar"}	)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, {"E2_DATALIB"	,"DATA_APROVACAO"		,"Data Aprovacao" 		,""	, ""	, ""	, ""	, ""	, ""	})
	Aadd(_aCampoQry, {"WB_CA_DT"	,"DATA_DEBITO"			,"Data Debito"			,""	, ""	, ""	, ""	, ""	, ""	})
	...
	Aadd(_aCampoQry, {"E2_HIST"		,"HISTORICO"			,"Historico"			,""	, ""	, ""	, ""	, ""	, ""	})
	...
	SetKey(K_CTRL_F8,{||U_BIEmlini("Bi_e_Protheus")}) ;SetKey(K_CTRL_F9,{||U_BIEmlini("Protheus")})	// CTRL+F8 (Codigo inkey -27), executa a func�o que ira alimentar a array, para o envio do email com a query do relatorio para a equipe de desenvolvimento do B.I. e do Protheus.            // CTRL+F9 (Codigo inkey -28), envia o email somente para a equipe de desenvolvimento do Protheus.
	...
	_cQuery += "  FROM " + U_IF_BIMFR( "IF_BIMFR",	"V_TESOURARIA_ANTECAPAGAR" ) +CRLF
	_cQuery += U_WhereAnd( !empty(_cCODFILIA ),		" COD_FILIAL IN "			+ _cCODFILIA	                      		 ) 			//OBRIGATORIO (SELE��O COMBO)
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),       " DATA_VENCIMENTO_FILTRO BETWEEN '"	+ _aRet[1] + "' AND '" + _aRet[2] + "' " )	//OBRIGATORIO (DATA VENCIMENTO) 
