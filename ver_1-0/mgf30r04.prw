...
//±±ºPrograma  ³ MGF30R04	ºAutor  ³ Geronimo Benedito Alves																	ºData ³  25/05/18  º±±
...
//±±ºDesc.		³ Rotina que mostra na tela os dados da planilha: EEF-Easy Financing - 30 -Financiamento-Ordens Importação antec. à pagar		       º±±
...
User Function MGF30R04()
	...
	Aadd(_aDefinePl,  "Financiamento-Ordens Importação antec. à pagar"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerá na regua de processamento.
	Aadd(_aDefinePl,  "Ordens Importação antec. à pagar"	)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Ordens Importação antec. à pagar"}	)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Ordens Importação antec. à pagar"}	)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
