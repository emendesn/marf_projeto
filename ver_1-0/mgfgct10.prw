...
User Function fGct0601()
	...
	If ( fPergunta() )
		...
		If (cAliasTMP)->(EOF())
			...
			MsgAlert('Não foram encontradas notas para os dados informados')
...
Static Function fGeraExcel(aHeader , aDados)
	...
	cTitulo	:=	SuperGetMv('MGF_VEN0101' , NIL , "Notas de Crédito")
...
Static Function fFillObrig(cNumTit)
	...
	//- Campos Obrigatorios
	// Criado parametro p/verificar se o conteudo da Natureza vir� de MV ou Cad Cliente 
