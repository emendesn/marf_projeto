...
//ฑฑบPrograma  ณ MGF06R03	บAutor  ณGeronimo Benedito Alves																	บData ณ29/12/17	บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: Financeiro -  Contas a Pagar - Devolu็๕es Contas a Receber		 (M๓dulo 06-FIN)	บฑฑ
...
User Function MGF06R03()
	...
	Aadd(_aDefinePl, "Contas a Receber - Devolu็๕es"	)	//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {"F1_EMISSAO"	,"DT_EMISSAO"							,"Data Emissใo"					,"D",008	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"F1_SERIE"	,"NUM_SERIE_NFE			as NUMSERINFE"	,"Nบ S้rie NFD"					,"C",003	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"F1_DOC"		,"NUM_NFE"								,"Nบ NFD"						,"C",009	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"F1_RECBMTO"	,"DT_RECEBIMENTO		as DTRECEBIME"	,"Data de Recebimento"			,"D",008	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"ZZH_STATUS"	,"DESC_STATUS_AR		as DESCSTA_AR"	,"Descri็ใo Status AR"			,"C",020	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"ZZH_AR"		,"NUM_AR"								,"Nบ AR"						,"C",007	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"ZZH_DOCMOV"	,"NUM_DOC_MOV			as NUMDOC_MOV"	,"Nบ Documento"					,"C",009	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"D1_SERIORI"	,"NUM_SERIE_NF_VENDA	as SERIENFVEN"	,"Nบ S้rie NF Venda"			,"C",003	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"D1_NFORI"	,"NUM_NF_VENDA			as NUMNFVENDA"	,"Nบ NF Venda"					,"C",009	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"D1_ZRAMI"	,"NUM_RAMI"								,"C๓d. RAMI"					,"C",006	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"F1_VALBRUT"	,"VLR_BRUTO"							,"Valor Bruto"					,"N",017	,2,"@E 99,999,999,999.99"	,""	,""	}) 		
	Aadd(_aCampoQry, {"ZAW_MOTIVO"	,"MOT_DEVOLUCAO			as MOTDEVOLUC"	,"Motivo da Devolu็ใo"			,"C",060	,0, ""						,""	,""	})
	Aadd(_aCampoQry, {"ZAW_JUSTIF"	,"JUS_DEVOLUCAO			as JUSDEVOLUC"	,"Justificativa de Devolu็ใo"	,"C",060	,0, ""						,""	,""	})
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),      " DT_RECEBIMENTO BETWEEN '" + _aRet[1] + "' AND '" + _aRet[2] + "' "	) // OBRIGATORIO, COM A VALIDAวรO DE 35 DIAS
