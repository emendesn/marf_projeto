...
oStSX5:SetProperty('X5_TABELA',   MODEL_FIELD_INIT,    FwBuildFeature(STRUCT_FEATURE_INIPAD,  'cTab'))                     //Ini Padr�o
...
If SX5->(DbSeek(FWxFilial('SX5') +  cTab + cX5Chave))
    Help('',1, 'Chave duplicada' ,, 'J� existe chave para o codigo !',1,0)  
    lRet := .F.
EndIf
