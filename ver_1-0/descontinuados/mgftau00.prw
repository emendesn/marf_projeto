...
Data.....:              09/03/2016 
Descricao / Objetivo:   TAURA - Definicao de Parametros
Doc. Origem:            
Solicitante:            Totvs
Uso......:              
...
/*
aAdd(aParametros, {"MGF_MONI01", "","C", "Monitor Integracao Tipo Taura"      ,"001"} )
...
aAdd(aParametros, {"MGF_MONT10", "","C", "Retorno da Integracao Producao"     ,"010"} )
...
// Saidas
aAdd(aParametros, {"MGF_ROTA"  , "","C", "Rota para integracao Taura - Ordem de Embarque"            , "999999"} )
aAdd(aParametros, {"MGF_ZONA"  , "","C", "Zona para integracao Taura - Ordem de Embarque"            , "999999"} )
aAdd(aParametros, {"MGF_SETOR" , "","C", "Setor para integracao Taura - Ordem de Embarque"           , "999999"} )
aAdd(aParametros, {"MGF_ESPSC5", "","C", "Especie Cadastrada na SC5"            , "CAIXAS"} )


//Producao          
aAdd(aParametros, {"MGF_TAP02T","","C", "Int. Taura Prod - Endereco Padrao "                         ,"01"} )
aAdd(aParametros, {"MGF_TAP02A","","N", "Int. Taura Prod - Numero Maximo de Threads"                 ,"40"} )
aAdd(aParametros, {"MGF_TAP02B","","C", "Int. Taura Prod - TM de Produ�ao"                           ,"110"} ) // Deve existir cadastro na tabela SF5
aAdd(aParametros, {"MGF_TAP02C","","C", "Int. Taura Prod - TM de Devolucao - Integracao TAURA"       ,"001"} ) // Deve existir cadastro na tabela SF5
aAdd(aParametros, {"MGF_TAP02D","","C", "Int. Taura Prod - TM de Requisi�ao - Integracao TAURA"      ,"510"} ) // Deve existir cadastro na tabela SF5
...
aAdd(aParametros, {"MGF_TAP02G","","L", "Int. Taura Prod - Aglutina movimentacoes .T./.F."           ,".T."} ) // Desativado 
aAdd(aParametros, {"MGF_TAP02H","","C", "Int. Taura Prod - Path de gravacao de logs"                 ,"\TAURA\PRD\LOG\"} )
...
aAdd(aParametros, {"MGF_TAP02L","","C", "Int. Taura Prod - Tp Mov Devolucao-Apont Subprod"           ,"03/"} )
...
aAdd(aParametros, {"MGF_TAP11A","","C", "Int. Taura Prod - Relacao de Armazens Produtivos"           ,"21/22/23/24/25/26/27/28/29"} ) // Necessario definir. Valores usados em teste.
...
IF !bBarramento
	...
	aAdd(aParametros, {"MGF_TAE14", "","C", "URL Metodo Situa��oEstoque"    ,cURL+"situacaoestoque/consultaestoqueFEFO"} )
	aAdd(aParametros, {"MGF_TAE15", "","C", "URL Metodo Situa��oEstoque"    ,cURL+"situacaoestoque/consultaestoque"} )
...
Else
	...
	aAdd(aParametros, {"MGF_TAE14", "","C", "URL Metodo Situa��oEstoque FEFO",cURL+"taura-consulta-estoque-fefo"} )
	aAdd(aParametros, {"MGF_TAE15", "","C", "URL Metodo Situa��oEstoque"    ,cURL+"taura-consulta-estoque"} )
