...
Data................: 20/03/2019
Descrição / Objetivo: Relatório Comprovação Exportação - 09 Fiscal. 
Doc. Origem.........: 
Solicitante.........: Priscilla Sombini
Uso.................: Marfrig
Obs.................: Relatório Comprovação Exportação.
=====================================================================================
*/
...
User Function MGF09R03()
	...
	Aadd(_aDefinePl, "Comprovação Exportação"		)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerá na regua de processamento.
	Aadd(_aDefinePl, "Comprovação Exportação"		)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Comprovação Exportação"}	)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Comprovação Exportação"}	)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, { "SERIE"				,"SERIE"			,"Série NF"				,"C",003,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "DATA_NF"			,"DATA_NF"			,"Data NF"				,"D",008,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "COD_FISCAL"			,"COD_FISCAL"		,"Código Fiscal"		,"C",005,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "CHAVE_NF"			,"CHAVE_NF"			,"Chave NF"				,"C",044,0	,""	,""	,""	})																																  
	Aadd(_aCampoQry, { "COD_ITEM"			,"COD_ITEM"			,"Código Item"			,"C",015,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "QTDE_EMBAR"			,"QTDE_EMBAR"		,"Quantidade Embarque"	,"N",014,2	,"@E 99,999,999,999.99"	    ,""	,""	})
	Aadd(_aCampoQry, { "PRECO_UNIT"			,"PRECO_UNIT"		,"Preço Unitário"		,"N",014,2	,"@E 99,999,999,999.99"		,""	,""	})
	Aadd(_aCampoQry, { "PRECO_TOTAL"		,"PRECO_TOTAL"		,"Preço Total"			,"N",014,2	,"@E 99,999,999,999.99"		,""	,""	})
