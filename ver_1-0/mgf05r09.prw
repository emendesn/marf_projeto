...
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.		� Rotina que mostra na tela os dados da planilha: FATURAMENTO - Pedidos empenhados   (Modulo 05-FAT)                               ���
...
User Function MGF05R09()
	...
	Aadd(_aDefinePl, "Faturamento - Pedidos Empenhados"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecera na regua de processamento.
	...
	Aadd(_aCampoQry, {"C5_FILIAL"	,"COD_FILIAL"		,"Codigo Filial"			,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"M0_FILIAL"	,"DESC_FILIAL"		,"Nome Filial"				,"C"	,40	,0	,""		,""		,""	})
	Aadd(_aCampoQry, {"C5_NUM"		,"PEDIDO"			,"Pedido"					,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"C5_CLIENTE"	,"COD_CLIENTE"		,"Cod Cliente"				,""		,""	,""	,""		,""		,""	})
	...
	Aadd(_aCampoQry, {"C6_PRODUTO"	,"COD_PRODUTO"		,"Cod. Produto"				,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"C6_DESCRI"	,"DESCRICAO"		,"Descricao"				,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"C5_EMISSAO"	,"DATA_EMISSAO"		,"Emissao"					,""		,""	,""	,""		,""		,""	})
	...
	If Len(_aParambox) > 0
		_lRet := ParamBox(_aParambox, _aDefinePl[2], @_aRet	,,	,,	,,	,,.T.,.T. )	// PARAMBOX obtem os parametros da query que gerar� o relatorio
	Endif
