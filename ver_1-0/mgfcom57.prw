...
Local oListBox
Local cListBox
Local aSC3 := {"Contrato","Item","Produto","Valor Unit�rio","Quantidade","Condicao Pagamento","Emissao","Fornecedor"}
...
If SCR->CR_TIPO != "CP"
	ApMsgAlert("Esta consulta somente � disponivel para documentos provenientes de 'Contrato de Parceria'.")
	Return()
Endif	
...
//@ 003,005 SAY "Valor Unit�rio Item/Contrato:" SIZE 080,08 OF oDlg PIXEL
