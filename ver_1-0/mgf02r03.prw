...
//ฑฑบPrograma  ณ MGF02R03	บAutor  ณ Geronimo Benedito Alves																	บData ณ23/01/18	บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: COMPRAS - Compras Pendente				 (M๓dulo 02-Compras)						บฑฑ
...
User Function MGF02R03()
	...
	Aadd(_aDefinePl, "COMPRAS - Compras Pendente"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, { "C1_NUM"		,"NUMERO_SC"								,"Nบ Solicita็ใo"				,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C1_ITEM"	,"ITEM_SC"									,"Item Solicitado"				,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C1_ZGEAUTE"	,"GERA_AUT_ENTREGA"							,"Gera Autoriz Entrega"			,"C"	,003,0 	,""		,""	,""	})
	Aadd(_aCampoQry, { "C1_EMISSAO"	,"DATA_EMISSAO_SC"							,"Emissใo Solicita็ใo Compras"	,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C7_NUM"		,"NUMERO_PEDIDO  			as NUMEPEDIDO"	,"Nบ Pedido"					,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C7_EMISSAO"	,"DATA_EMISSAO_PEDIDO		as DT_EMI_PED"	,"Data Emissใo Pedido"			,""		,""	,	,""		,""	,""	})
	...
	Aadd(_aCampoQry, { "B1_COD"		,"COD_PRODUTO				as CODPRODUTO"	,"C๓d. Produto"					,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "B1_DESC"	,"DESC_PRODUTO				as DESCPRODUT"	,"Descr. Produto"				,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "X5_CHAVE"	,"COD_TIPO_PRODUTO			as CODTIPOPRO"	,"C๓d. Tipo Produto"			,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "X5_DESCRI"	,"DESC_TIPO_PRODUTO			as DESCTIPPRO"	,"Descr. Tipo Produto"			,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "BM_GRUPO"	,"COD_GRUPO_PRODUTO			as CODGRUPPRO"	,"C๓d. Grupo Produto"			,""		,""	,	,""		,""	,""	})
	...
	Aadd(_aCampoQry, { "C7_TOTAL"	,"PRECO_LIQUIDO_PEDIDO		as PRECLIQPED"	,"Pre็o Liquido Pedido"			,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C7_ZPRCORI"	,"PRECO_UNIT_ORIGEM			as PREUNITORI"	,"Pre็o Unitแrio Origem"		,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C8_PRECO"	,"PRECO_BASE"								,"Pre็o Base"					,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C7_ZVLDESC"	,"PERCENTUAL_SAVING			as PERCENSAV"	,"Percentual Saving"			,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C8_VALIDA"	,"DATA_VALIDADE_COTACAO 	as DTVALICOT"	,"Data Validade Cota็ใo"		,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C8_VALIPI"	,"VALOR_IPI"								,"Valor IPI"					,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C8_PRECO"	,"VALOR_ULTIMA_COMPRA		as VLRULTCOMP"	,"Valor ฺltima Compra"			,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "AH_UNIMED"	,"COD_UNIDADE_MEDIDA		as CODUNIDMED"	,"C๓d. Unidade Medida"			,""		,""	,	,""		,""	,""	})
	...
	Aadd(_aCampoQry, { "F1_DOC"		,"NUMERO_NF"								,"Nบ NF"						,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "F1_SERIE"	,"NUMERO_SERIE_NF 			as NUMSERIENF"	,"Nบ Serie NF"					,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "F1_EMISSAO"	,"DATA_EMISSAO_NF			as DT_EMIS_NF"	,"Data Emissใo NF"				,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "A2_COD"		,"COD_FORNECEDOR			as CODFORNECE"	,"C๓d. Fornecedor"				,""		,""	,	,""		,""	,""	})
	...
	Aadd(_aCampoQry, { "D1_VUNIT"	,"VALOR_UNIT_NF"							,"Valor Unitแrio NF"			,""		,""	,	,""		,""	,""	})
	...
	Aadd(_aCampoQry, { "D1_TOTAL"	,"VALOR_UNITARIO_SEMICMS_PROD"				,"Valor Unitแrio Sem ICMS Prod"	,""		,""	,	,""		,""	,""	})
	...
	Aadd(_aCampoQry, { "Y1_USER"	,"COD_SOLICITANTE			as CODSOLICIT"	,"C๓d. Solicitante"				,""		,""	,	,""		,""	,""	})
	...
	Aadd(_aCampoQry, { "ED_CODIGO"	,"COD_NATUREZA_FINANCEIRA 	as CODNATUREZ"	,"C๓d. Natureza Financeira"		,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "ED_DESCRIC"	,"DESC_NATUREZA_FINANCEIRA	as DESCNATURE"	,"Descr. Natureza Financeira"	,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C1_OBS"		,"STATUS_SOLICITACAO		as STATSOLICI"	,"Status Solicita็ใo" 			,"C"	,60	,0  ,""		,""	,""	})
	Aadd(_aCampoQry, { "C1_OBS"		,"OBSERVACAO_SC				as OBS_SC"		,"Observa็ใo Solicit." 			,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C7_OBS"		,"OBSERVACAO_PEDIDO			as OBS_PEDIDO"	,"Observa็ใo Pedido" 			,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "B1_ZPRODES"	,"OBERVACAO_PRODUTO			as OBS_PRODUT"	,"Observa็ใo Produto" 			,"C"	,2020,0	,""		,""	,""	})
	Aadd(_aCampoQry, { "E4_DESCRI"	,"CONDICAO_PAGAMENTO		as CONDIPAGTO"	,"Condi็ใo Pagamento" 			,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "A4_NOME"	,"TRANSPORTADORA			as TRANSPORTA"	,"Transportadora" 				,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "CR_DATALIB"	,"DATA_LIBERACAO_SC			as DATALIBESC"	,"Data Libera็ใo SC" 			,""		,""	,	,""		,""	,""	})
	Aadd(_aCampoQry, { "C1_ZOBSEST"	,"OBERVACAO_ESTOQUE"						,"Observa็ใo Estoque"			,""		,""	,	,""		,""	,""	}) 

	aAdd(_aParambox,{1,"Dt Emissใo Solicita็ใo Inicio"	,Ctod("")						,""	,"" 												,""		,"",050,.T.})
	aAdd(_aParambox,{1,"Dt Emissใo Solicita็ใo Final"	,Ctod("")						,""	,"U_VLDTINIF(MV_PAR01, MV_PAR02, _nInterval)"		,""		,"",050,.T.})
	aAdd(_aParambox,{1,"Dt Emissใo Pedido Inicial"		,Ctod("")						,""	,"" 												,""		,"",050,.F.})
	aAdd(_aParambox,{1,"Dt Emissใo Pedido Final"		,Ctod("")						,""	,"U_VLDTINIF(MV_PAR03, MV_PAR04, _nInterval)"		,""		,"",050,.F.})
	...
	cQryFornec	:= "SELECT ' ' as A2_COD_LOJ, 'NรO INFORMADO' as A2_NOME, ' ' AS A2_CGC  FROM DUAL UNION ALL "
	...
	aCpoFornec	:=	{	{ "A2_COD_LOJ"	,"c๓digo-loja"			,TamSx3("A2_COD")[1] + TamSx3("A2_LOJA")[1] +20		} ,;
	aCpoFornec	:=		{ "A2_NOME"		,"Nome do Fornecedor"	,TamSx3("A2_NOME")[1]  +50  }	 ,; 
	aCpoFornec	:=		{ "A2_CGC"		,U_X3Titulo("A2_CGC")	,TamSx3("A2_CGC")[1]  }	} 
	cTitFornec	:= " Marque os Fornecedores เ listar."
	...
	aCpoStSoli	:=	{	{ "CAMPO_01"	,"Nบ"					,02	} ,;
						{ "CAMPO_02"	,"Status Solicita็ใo"	,50	} } 
	cTitStSoli	:= "Marque os Status de solicita็๕es เ serem listadas: "
	...
	For _nI := 1 to len(aStatuSoli)
		aStatuSoli[_nI] := Alltrim(aStatuSoli[_nI])		// Retiro os espa็os em branco para ficar perfeito na clausula IN
	Next
	...
	cTitCompdo	:= "Marque os C๓digos de compradores เ serem listados: "
	nPosRetorn	:= 1		// Quero que seja retornado o primeiro campo: A6_COD
	//.T. no envio do parametro _lCancProg, indica que devo abandonar programa, se for clicado o botใo cancelar da MarkGene.
	//.T. no _lCancProg, ap๓s a Markgene, indica que realmente foi teclado o botใo cancelar e que devo abandonar o programa. 
	//.F. no _lCancProg, ap๓s a Markgene, indica que realmente nใo foi teclado o botใo cancelar ou que mesmo ele teclado, nใo devo abandonar o programa (mas apenas "limpar/desconsiderar" a marca็ใo dos registro) 
	...
	aCpoSolici	:=		{ "USR_CODIGO"	,"C๓digo Solicitante"	, 040	} ,;
	aCpoSolici	:=		{ "USR_NOME"	,"Nome Solicitante"		, 080	}	} 
	cTitSolici	:= "Marque os C๓digos de Solicitantes เ serem listados: "
	nPosRetorn	:= 1		// Quero que seja retornado o primeiro campo: A6_COD
	//.T. no envio do parametro _lCancProg, indica que devo abandonar programa, se for clicado o botใo cancelar da MarkGene.
	//.T. no _lCancProg, ap๓s a Markgene, indica que realmente foi teclado o botใo cancelar e que devo abandonar o programa. 
	//.F. no _lCancProg, ap๓s a Markgene, indica que realmente nใo foi teclado o botใo cancelar ou que mesmo ele teclado, nใo devo abandonar o programa (mas apenas "limpar/desconsiderar" a marca็ใo dos registro) 
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),     " DATA_EMISSAO_SC_FILTRO BETWEEN '"     + _aRet[1] + "' AND '" + _aRet[2] + "' "	)	// OBRIGATORIO, COM A VALIDAวรO DE 35 DIAS
	_cQuery += U_WhereAnd( !empty(_cCODFILIA ),   " COD_FILIAL IN " + _cCODFILIA	                                                    )	// OBRIGATORIO (SELEวรO DO COMBO)  CAMPO FILIAL(06 posi็๕es)
	_cQuery += U_WhereAnd( !empty(_aRet[4] ),     " DATA_EMISSAO_PEDIDO_FILTRO BETWEEN '" + _aRet[3] + "' AND '" + _aRet[4] + "' "	)	// NรO OBRIGATORIO
	If Empty( cComprador )
	...
	_cQuery += U_WhereAnd( !empty(cStatuSoli),    " STATUS_SOLICITACAO IN "               + cStatuSoli	                            )	// NรO OBRIGATORIO
	...
	aAdd(_aParambox,{1,"Status Solicita็ใo : "		,""})
	...
	aAdd(_aParambox,{1,"C๓digos de Solicitantes :"	,""})
