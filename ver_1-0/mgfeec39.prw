...
Autor...............: Joni Lima
Data................: 21/11/2017
Descricao / Objetivo: Bot�o para inclis�o de Courier
Doc. Origem.........: Contrato - GAP COMEX 035
=====================================================================================
*/
...
User Function xMGF39I(cTipo)
	...
	If IsInCallStack("EECAE100")
		If cTipo == "ROD_CAPA_EMB"
			...
			If Type("aObjs[2]:oBrowse") = "O" // testa, pois quando � dado o end da dialog, o oBrowse nao existe mais.
				aObjs[2]:oBrowse:Refresh() //Atualiza os dados do browse da GetDados
			EndIf

			If Type("aObjs[3]:oBrowse") = "O" // testa, pois quando � dado o end da dialog, o oBrowse nao existe mais.
...
//TODO Atualiza valores para Total Reimporta��o
...
User Function xMGF39v(cParam)
	...
	If 	IsInCallStack("EECAE100") .and. cParam ==  "GRV_CPOS_CUSTOM"
		...
		If DbSeek(xFilial("EEC","900001")+cEmbarque)
			If cOffCanc == "1"
					MsgInfo("� necessario cancelar o embarque na empresa Offshore.","Atencao")
			EndIf
			RecLock("EEC",.F.)
