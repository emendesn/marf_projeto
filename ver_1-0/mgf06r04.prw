...
//ฑฑบPrograma  ณ MGF06R04	บAutor  ณ Geronimo Benedito Alves																	บData ณ08/01/18	บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: Financeiro -  Contas a Pagar - CR-Ocorrencia Baixa NCC		 (M๓dulo 06-FIN)		บฑฑ
...
User Function MGF06R04()
	...
	Aadd(_aDefinePl, "Contas a Receber-Ocorr๊ncia Baixa NCC"	)	//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	Aadd(_aDefinePl, "Ocorr๊ncia Baixa NCC"						)	//02-  _cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Ocorr๊ncia Baixa NCC"}					)	//03-  _cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Ocorr๊ncia Baixa NCC"}					)	//04-  _cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, {"E1_FILIAL"	,"COD_FILIAL"								,"C๓digo Filial"			,"C",006	,0	,""							,""	,""	})
	...
	Aadd(_aCampoQry, {"ED_DESCRIC"	,"NOM_NATUREZA				as NOMNATUREZ"	,"Descri็ใo Natureza"		,"C",030	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"E1_EMISSAO"	,"DT_EMISSAO"								,"Data Emissใo"				,"D",008	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"A1_COD"		,"COD_CLIENTE				as CODCLIENTE"	,"C๓digo Cliente"			,"C",006	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"A1_NOME"		,"NOM_CLIENTE				as NOMCLIENTE"	,"Nome do Cliente"			,"C",020	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"ZQ_DESCR"	,"DESC_REDE"								,"Descri็ใo da Rede"		,"C",040	,0	,""							,""	,""	})
	...
	Aadd(_aCampoQry, {"E1_SERIE"	,"SERIE_NF"									,"S้rie"					,"C",003	,0	,""							,""	,""	})
	...
	Aadd(_aCampoQry, {"E5_DOCUMEN"	,"NUM_NF_ABATIMENTO 		as NUMABATINF"	,"Nบ NF Abatimento"			,"C",050	,0	,""							,""	,""	})
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),      " A.COD_CLIENTE BETWEEN '"                    + _aRet[3] + "' AND '" + _aRet[4] + "' " ) // NรO OBRIGATORIO
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),      " A.COD_REDE BETWEEN '"                       + _aRet[5] + "' AND '" + _aRet[6] + "' " ) // NรO OBRIGATORIO
	If empty(cPortaProd)
