	...
	#define STR0035 "| Lote |  Fecha |Embarque|Llegada  | Nº Proceso      | D I        | Despach |Entrega |"
	...
	#define STR0045 "Informac. "
		...
		#define STR0035 "| Lot  |  Date  |Shipment|Arrive   |Process  No.     | D.I.       | Cleara. |Delivery|"
		...
		#define STR0034 If( cPaisLoc $ "ANG|PTG", "|                                  embarques                                         |", "|                                  EMBARQUES                                         |" )
		#define STR0035 If( cPaisLoc $ "ANG|PTG", "| lote |  data  |embarque|chegada  | núm. processo    | d.i.       | desemb. |entrega |", "| Lote |  Data  |Embarque|Chegada  | Nr. Processo    | D.I.       | Desemb. |Entrega |" )
