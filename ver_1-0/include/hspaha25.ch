	...
	#define STR0009 "Existe(n) procedimiento(s) registrado(s) con esta dosis de anestesia. Borrado no permitido"
		...
		#define STR0006 "Porte Anestésico de Cirurgia"
		#define STR0007 "Atenção"
		#define STR0008 "Validação da Exclusão"
		#define STR0009 "Existe(m) procedimento(s) cadastrado(s) com este porte anestésico. Exclusão não permitida"
	#endif
#endif
