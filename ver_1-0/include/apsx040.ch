	...
	#define STR0023 "Borrar"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Registo - SX3", "Cadastro - SX3" )
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Países", "Paises" )
		#define STR0010 "Obrigat"
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "Países", "Paises" )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "Tradução SX3 - ENGLISH", "Traducao SX3 - ENGLISH" )
		#define STR0013 "Pesquisar"
		#define STR0014 "Visualizar"
		#define STR0015 "Incluir"
		#define STR0016 "Alterar"
		#define STR0017 "Excluir"
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "Tradução SX3 - SPANISH", "Traducao SX3 - SPANISH" )
