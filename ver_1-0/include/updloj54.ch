#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion de la FNC 00000009154/2010. "
	...
	#define STR0004 " FNC 00000009154/2010 "
...
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries in accordance with FNC 00000009154/2010. "
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função da FNC 00000009154/2010. ", "Este programa tem como objetivo ajustar os dicionários de dados em função da FNC 00000009154/2010. " )
