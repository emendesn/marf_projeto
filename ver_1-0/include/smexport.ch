...
#ELSE
   ...
   #ELSE
      #define STR0001 "First"
      #define STR0002 "Assistente de Exportação"
      #define STR0003 "Bem Vindo ao assistente de Exportação dos dados do First. Esta rotina permite que todos os dados e as configurações da versao First sejam exportadas para a versao Classic ou Express. Para prosseguir com a exportação informe o diretório onde os pacotes de exportaçãp do First serão gravados."
