	...
	#define STR0016 If( cPaisLoc == "ANG", "Diario", If( cPaisLoc == "CHI", "Diarista", If( cPaisLoc == "COL", "Diarista", If( cPaisLoc == "COS", "Diarista", If( cPaisLoc == "DOM", "Diarista", If( cPaisLoc == "EQU", "Diarista", If( cPaisLoc == "EUA", "Diarista", If( cPaisLoc == "HAI", "Diarista", If( cPaisLoc == "MEX", "Diarista", If( cPaisLoc == "PAD", "Diarista", If( cPaisLoc == "PAN", "Diarista", If( cPaisLoc == "PAR", "Diarista", If( cPaisLoc == "PER", "Diarista", If( cPaisLoc == "POR", "Diarista", If( cPaisLoc == "PTG", "Diário", If( cPaisLoc == "SAL", "Diarista", If( cPaisLoc == "TRI", "Diarista", If( cPaisLoc == "URU", "Diarista", If( cPaisLoc == "VEN", "Diarista", "Jornalero" ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
	...
	#define STR0025 "Acumuladores auxiliares"
		...
		#define STR0012 If( cPaisLoc $ "ARG|AUS|BOL|BRA|CHI|COL|COS|DOM|EQU|EUA|HAI|MEX|PAD|PAN|PAR|PER|POR|SAL|TRI|URU|VEN", "Horista", "à hora" )
