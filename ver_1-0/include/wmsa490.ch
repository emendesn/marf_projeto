	...
	#define STR0042 "El módulo de distribución y logística no está activo (MV_INTDL)."
	...
	#define STR0045 "Producto origen informado no es origen del producto [VAR01]."
		...
		#define STR0042 "The distribution and logistics module is not active (MV_INTDL)."
		...
		#define STR0042 "O módulo de distribuição e logística não está ativo (MV_INTDL)."
