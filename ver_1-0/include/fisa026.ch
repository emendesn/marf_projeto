	...
	#define STR0044 "Este archivo no existe o el servidor SQL no puede abrirlo, utilice un archivo que este en la maquina de su servidor SQL o una direccion de red que pueda accederse por el servidor SQL."
#else
	#ifdef ENGLISH
		...
		#define STR0044 "This file does not exist or it cannot be opened by your SQL server. Use a file that is in the machine of your SQL server or a network address that can be accessed by the SQL server."
	#else
		...
		#define STR0044 If( cPaisLoc $ "ANG|PTG", "Este ficheiro não existe ou não pode ser aberto pelo seu servidor SQL. Utilize um ficheiro que esteja na máquina de seu servidor SQL ou um endereço de rede que possa ser acessado pelo servidor SQL.", "Este arquivo não existe ou não pode ser aberto pelo seu servidor SQL, utilize um arquivo que esteja na máquina de seu servidor SQL ou um endereço de rede que possa ser acessado pelo servidor SQL." )
	#endif
#endif
