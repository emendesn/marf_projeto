	...
	#define STR0005 If( cPaisLoc == "ANG", "Num. del NIF", If( cPaisLoc == "ARG", "CUIL", If( cPaisLoc == "AUS", "ABN", If( cPaisLoc == "BOL", "RUC", If( cPaisLoc == "BRA", "C.P.F.&#58;", If( cPaisLoc == "CHI", "RUT", If( cPaisLoc == "COL", "CC", If( cPaisLoc == "COS", "Identificacion", If( cPaisLoc == "DOM", "CIE", If( cPaisLoc == "EQU", "Num. del NIF", If( cPaisLoc == "EUA", "SS", If( cPaisLoc == "HAI", "Num. del NIF", If( cPaisLoc == "MEX", "RFC", If( cPaisLoc == "PAD", "Cedula de identificacion", If( cPaisLoc == "PAN", "CUIL", If( cPaisLoc == "PAR", "Num. IPS", If( cPaisLoc == "PER", "Num. documento", If( cPaisLoc == "POR", "SS", If( cPaisLoc == "PTG", "Num. del NIF", If( cPaisLoc == "SAL", "CUIL", If( cPaisLoc == "TRI", "RIF", If( cPaisLoc == "URU", "RUC", If( cPaisLoc == "VEN", "RIF", "C.P.F." ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
	...
	#define STR0146 "Modificacion de la Inicializacion de los Procesos WEB."
		...
		#define STR0005 "C.P.F.&#58;"
		#define STR0006 "Admiss&atilde;o &#40;dd&#47;mm&#47;aaaa&#41;&#58;"
		#define STR0007 "Birth; &#40;dd&#47;mm&#47;aaaa&#41;&#58;"
		...
		#define STR0005 If( cPaisLoc $ "ANG|ARG|AUS|BOL|BRA|CHI|COL|COS|DOM|EQU|EUA|HAI|MEX|PAD|PAN|PAR|PER|POR|PTG|SAL|URU|VEN", "C.P.F.&#58;", If( cPaisLoc == "TRI", "Nif&#58;", "C.P.F.&#58;" ) )
