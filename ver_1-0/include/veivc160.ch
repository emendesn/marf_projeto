	...
	#define STR0043 "Num.F    Serie  Chasis               Proveedor                     Emision   Fch. Digit       Valor        Num. F    Serie  Chasis               Cliente                        Emision         Valor"
#else
	#ifdef ENGLISH
		...
		#define STR0043 "Inv.Nr    Series Chassis               Supplier                       Issue    Dt. Digit       Value        Inv.Nr    Series Chassis              Customer                        Issue          Value"
	#else
		...
		#define STR0043 If( cPaisLoc $ "ANG|PTG", "Nr.Fact    Série  Chassis               Fornecedor                     Emissão   Dt. Digit.       Valor        Nr.Fact.    Série  Chassis               Cliente                        Emissao         Valor", "Num.NF    Serie  Chassi               Fornecedor                     Emissao   Dt. Digit       Valor        Num.NF    Serie  Chassi               Cliente                        Emissao         Valor" )
	#endif
#endif
