	...
	#define STR0035 "Informe"
#else
	#ifdef ENGLISH
		#define STR0001 "Controle de Demurrage / Detention"
		#define STR0002 "Cover Data"
		#define STR0003 "Detail Data"
		#define STR0004 "Values of Container Rates"
		...
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "Valores das Tarifas do Contentores", "Valores das Tarifas do Containeres" )
