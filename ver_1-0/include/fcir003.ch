	...
	#define STR0023 "Producido"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", , "Este relatório tem como objetivo apresentar os valores analíticos calculados na apuração do FCI para as Produções." )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", , "Relação FCI Analítica - Produção" )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", , "Produções do Periodo" )
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", , "Vl. Imp. Unitário" )
		...
		#define STR0020 If( cPaisLoc $ "ANG|PTG", , "Relação FCI Analítica - Produção (Periodo: " )
