	...
	#define STR0026 "¡ETA Origen no puede ser mayor que el ETS Origen !"
	#define STR0027 "¡Dead Line debe ser menor o igual al ETS Origen !"
	#define STR0028 "¡ETS Origen debe ser mayor o igual al Dead Line !"
	#define STR0029 "ETS Origen debe ser mayor o igual al ETA Origen !"
	#define STR0030 "¡Funcion AC170Destino no puede ejecutarse con  lWork == .F. y lRecalculo == .F. !"
		...
		#define STR0026 "ETA Source cannot be higher than ETS Source !"
		#define STR0027 "Dead Line must be lower or equal to ETS Source !"
		#define STR0028 "ETS Source must be higher or eqaul to Dead Line !"
		#define STR0029 "ETS Source must be higher or equal to ETA Source !"
		...
		#define STR0026 If( cPaisLoc $ "ANG|PTG", "Eta origem não pode ser maior que o ets origem !", "ETA Origem nao pode ser maior que o ETS Origem !" )
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "Prazo deve ser menor ou igual ao ets origem !", "Dead Line deve ser menor ou igual ao ETS Origem !" )
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "Ets de origem deve ser maior ou igual ao dead line !", "ETS Origem deve ser maior ou igual ao Dead Line !" )
		#define STR0029 If( cPaisLoc $ "ANG|PTG", "Ets de origem deve ser maior ou igual do que eta de origem !", "ETS Origem deve ser maior ou igual ao ETA Origem !" )
