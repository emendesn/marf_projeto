	...
	#define STR0020 "Borrar"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Registo - SX2", "Cadastro - SX2" )
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Tradução SX2 - ENGLISH", "Traducao SX2 - ENGLISH" )
		#define STR0010 "Pesquisar"
		#define STR0011 "Visualizar"
		#define STR0012 "Incluir"
		#define STR0013 "Alterar"
		#define STR0014 "Excluir"
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Tradução SX2 - SPANISH", "Traducao SX2 - SPANISH" )
