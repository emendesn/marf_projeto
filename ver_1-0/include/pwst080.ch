	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", , "Gerenciamento de Informações - Atualização de Dados" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", , "Informações enviadas com SUCESSO!" )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", , "Dados Cadastrais" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", , "Informações cadastradas com SUCESSO!" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", , "Gerenciamento de Informações Cadastrais - CONTATOS" )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", , "Dados Cadastrais : " )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", , "Dados Cadastrais - CONTATO" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", , "Informações cadastradas com SUCESSO!" )
		#define STR0009 "Erro"
