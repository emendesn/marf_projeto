	...
	#define STR0014 "   PIS/PASEP  SEXO RAZA GRADO CBO   DEFIC  NOMBRE COMPLETO                  CTPS    SER UF FECHA       REMUNERACION HRS FECHA      DESL TIPO"
	...
	#define STR0019 "   PIS/PASEP  SEXO RAZA GRADO CBO   DEFIC  NOMBRE COMPLETO                  CTPS    SER UF FECHA       REMUNERACION HRS FECHA      DESL TIPO"
	#define STR0020 "                   COL. INST       FISICO                                                 NACIM.                    ADMISION       MVTO"
#else
	#ifdef ENGLISH
		...
		#define STR0014 "   PIS/PASEP GEND. RACE EDUC CBO   PHYS.  ENTIRE NAME                    CTPS    SER ST BIRTH      EARNINGS    HRS ADMISSION DISM MVNT"
		...
		#define STR0019 "   PIS/PASEP  SEXO RACE EDUC CBO   PHYS.  ENTIRE NAME                    CTPS    SER ST BIRTH      EARNINGS    HRS ADMISSION DISM MVNT"
		#define STR0020 "                   ETHN LEVEL      DISAB.                                               DATE                       DATE           TYPE"
	#else
		...
		#define STR0014 If( cPaisLoc $ "ANG|PTG", "   Segurança Social  Sexo Raça Grau CAE   Defic  Nome Completo                  CT    Ser Distrito Data       Remuneração Horas Data      Saída Tipo", "   PIS/PASEP  SEXO RACA GRAU CBO   DEFIC  NOME COMPLETO                  CTPS    SER UF DATA       REMUNERACAO HRS DATA      DESL TIPO" )
		...
		#define STR0019 If( cPaisLoc $ "ANG|PTG", "   Segurança Social  Sexo Raça Grau CAE   Defic  Nome Completo                  CT    Ser Distrito Data       Remuneração Horas Data      Saída Tipo", "   PIS/PASEP  SEXO RACA GRAU CBO   DEFIC  NOME COMPLETO                  CTPS    SER UF DATA       REMUNERACAO HRS DATA      DESL TIPO" )
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "                   Cor  Inst       Físico                                               Nascim.                    Admissão       Mvto", "                   COR  INST       FISICO                                               NASCIM.                    ADMISSAO       MVTO" )
	#endif
#endif
