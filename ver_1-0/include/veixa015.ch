#ifdef SPANISH
	#define STR0001 "Salida de Vehiculos por Consignacion"
...
#else
	#ifdef ENGLISH
		#define STR0001 "Outflow of Vehicles per Consignment"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Saída de Veículos por Consignação", "Saida de Veiculos por Consignacao" )
