	...
	#define STR0019 "Items Borrados"
		...
		#define STR0001 "Desktop"
		#define STR0002 "Desktops"
		#define STR0003 "Desktop         "
		#define STR0004 "Obligations"
		#define STR0005 "Meetings"
		...
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "área de trabalho", "Area de trabalho" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "Obrigações", "Obrigacöes" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "Reuniões", "Reuniöes" )
