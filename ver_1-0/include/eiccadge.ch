	...
	#define STR0018 "Integracion Easy-GipLite"
	...
	#define STR0031 "Archivo de Atributos para Valoracion Aduanera"
	#define STR0032 "Archivo de Especificaciones para Valoracion"
	...
	#define STR0052 "Conversión no puede modificarse/borrarse, porque está utilizándose en el DrawBack."
		...
		#define STR0018 "Integration Easy-GipLite"
		...
		#define STR0031 "Atributes File for Customs Valorization"
		#define STR0032 "Specification File foe Valorization"
		...
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "Integração Easy-giplite", "Integracao Easy-GipLite" )
		...
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Registo De Atributos Para Valorização Aduaneira", "Cadastro de Atributos para Valoracao Aduaneira" )
		#define STR0032 If( cPaisLoc $ "ANG|PTG", "Registo De Especificações Para Valorização", "Cadastro de Especificacoes para Valoracao" )
