	...
	#define STR0040 "Porc.Sucursal"
	#define STR0041 "Porc.Empresa"
	#define STR0042 "Empleados"
	#define STR0043 "SUCURSAL   MATRIC NOMBRE                        ADMISION   FUNCION                  MANO DE    SALARIO   PORC.   PORC.   PORC."
#else
	#ifdef ENGLISH
		...
		#define STR0011 "                                                                                               NOMINAL  COST C.  BRANCH  COMPANY"
		...
		#define STR0039 "Cost C. Perc."
		#define STR0040 "Branch Perc."
		#define STR0041 "Company Perc."
		#define STR0042 "Employees   "
		#define STR0043 "BRANCH    ENROLLM NAME                           ADMISSION   POSITION                   LABOR     SALARY   PERC.   PERC.   PERC."
	#else
		...
		#define STR0043 If( cPaisLoc $ "ANG|PTG", "FILIAL    MATRÍC NOME                           ADMISSÃO   FUNÇÃO                   MÃO DE     SALÃRIO   PERC.   PERC.   PERC.", "FILIAL    MATRIC NOME                           ADMISSAO   FUNCAO                   MAO DE     SALARIO   PERC.   PERC.   PERC." )
	#endif
#endif
