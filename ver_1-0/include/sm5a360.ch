	...
	#define STR0006 "Atencion, los registros de ECF de ese periodo seran borrados del SF3. ¿Continua ?"
		...
		#define STR0002 "Esta rotina irá reprocessar os Livros Fiscais referente ao período"
		#define STR0003 "informado para Emissores de Cupom Fiscal."
		#define STR0004 "Este processamento deverá ser executado em mono-usuário."
		#define STR0005 "Reprocessando os registros de saídas - ECF "
