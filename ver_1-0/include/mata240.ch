	...
	#define STR0018 "La cantidad de la devolucion es mayor que el saldo requerido de este producto para esta OP. Al devolver esta cantidad, el saldo de la OP podra quedar negativo."
	...
	#define STR0068 " Local: "
		...
		#define STR0010 "to Product Structure"
		...
		#define STR0018 "The returned quantity is bigger than the balance requested for this PO. If this quantity is returned, the PO balance may become negative."
		...
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "A quantidade da devolução é maior do que o saldo requisitado do produto para esta op . ao devolver esta quantidade o saldo da op poderá ficar negativo.", "A quantidade da devolucao e' maior que o saldo requisitado deste produto para esta OP . Ao devolver esta quantidade o saldo da OP podera ficar negativo." )
