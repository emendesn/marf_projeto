	...
	#define STR0002 "Esta rutina tiene como funcion crear Tablas, Indices y Campos responsables por el"
	#define STR0003 "funcionamiento de la rutina de prorrateo por centro de costo en la solicitud aç almacén."
	#define STR0004 "Este proceso debe ejecutarse en modo EXCLUSIVO, es decir, no pueden haber otros "
	#define STR0005 "usuarios ou jobs utilizando o sistema. Se recomienda  que  se  haga un "
	#define STR0006 "BACKUP de los DICCIONARIOS y de la BASE DE DATOS antes de esta actualizacion para que, "
	#define STR0007 "en caso de que ocurran posibles fallas, se pueda restaurar ese backup."
	...
	#define STR0012 "No se realizo la actualizacion."
	...
	#define STR0027 "Final de la actualizacion del SX2"
	#define STR0028 "Inicio de la actualizacion del SX3"
	#define STR0029 "El tamano del campo "
	#define STR0030 "' no actualizado y se mantuvo en ['"
	#define STR0031 "Se creo el campo "
	#define STR0032 "¿Desea substituir? "
	#define STR0033 "Si"
	#define STR0034 "No"
	#define STR0035 "Si p/todos"
	#define STR0036 "No p/todos"
	#define STR0037 "Diferencia de contenido - SX3"
	#define STR0038 "Se selecciono la opcion de REALIZAR TODAS las modificaciones en el SX3 y NO MOSTRAR la pantalla de aviso."
	#define STR0039 "¿Confirma la accion [Si p/todos]?"
	#define STR0040 "Se selecciono la opcion de NO REALIZAR ninguna modificacion en el SX3 que este diferente de la base y NO MOSTRAR la pantalla de aviso."
	#define STR0041 "¿Confirma esta accion [No p/todos]?"
	#define STR0042 "Se modifico el campo "
	#define STR0043 "Actualizando campos de tabelas (SX3)..."
	#define STR0044 "Final de la actualizacion del SX3"
	#define STR0045 "Inicio de la actualizacion del SIX"
	#define STR0046 "Actualizando indices..."
	#define STR0047 "Final de la actualizacion del SIX"
	#define STR0048 "No fue posible abrir SM0 exclusivo."
	...
	#define STR0056 "Salir de la seleccion"
	...
	#define STR0061 "Inicio de la actualizacion del SX2"
	#define STR0062 " por pertenecer al grupo de campos "
	#define STR0063 " no actualizado y se mantuvo en "
	#define STR0064 " esta con el "
	#define STR0065 " con el contenido"
	#define STR0066 "que se sustituira por el NUEVO contenido"
	...
	#define STR0074 "Analisis de vinculos..."
	#define STR0075 "Inicio de la actualizacion del SX9"
	#define STR0076 "Actualizacion de Archivos (SX9)..."
	#define STR0077 "Se incluyo el vinculo "
	#define STR0078 "Se modifico el vinculo "
	#define STR0079 "Final de la actualizacion del SX9"
#else
	#ifdef ENGLISH
		#define STR0001 "TABLE AND DICTIONARY UPDATE"
		#define STR0002 "This routine creates Tables, Indexes and Fields responsible for"
		#define STR0003 "the routine of apportionment per cost center in the request to the warehouse."
		...
		#define STR0046 "Updating indices..."
		...
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "funcionamento do procedimento de rateio por centro de custo na solicitação ao armazém.", "funcionamento da rotina de rateio por centro de custo na solicitação ao armazém." )
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "caso ocorram eventuais falhas, esse backup possa ser restaurado.", "caso ocorra eventuais falhas, esse backup seja ser restaurado." )
		...
		#define STR0043 If( cPaisLoc $ "ANG|PTG", "A actualizando campos de tabelas (SX3)...", "Atualizando Campos de Tabelas (SX3)..." )
		...
		#define STR0051 "Empresa"
		#define STR0052 "Todos"
		#define STR0053 If( cPaisLoc $ "ANG|PTG", "Marca / Desmarca todos", "Marca / Desmarca Todos" )
		...
		#define STR0069 If( cPaisLoc $ "ANG|PTG", "Máscara empresa ( ?? )", "Máscara Empresa ( ?? )" )
		#define STR0070 "&Marcar"
