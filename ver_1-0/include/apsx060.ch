	...
	#define STR0020 "Borrar"
		...
		#define STR0009 "Translation SX6 - ENGLISH"
		#define STR0010 "Search"
		#define STR0011 "View"
		#define STR0012 "Add"
		#define STR0013 "Edit"
		#define STR0014 "Delete"
		#define STR0015 "Translation SX6 - SPANISH"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Registo - SX6", "Cadastro - SX6" )
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Tradução SX6 - ENGLISH", "Traducao SX6 - ENGLISH" )
		#define STR0010 "Pesquisar"
		#define STR0011 "Visualizar"
		#define STR0012 "Incluir"
		#define STR0013 "Alterar"
		#define STR0014 "Excluir"
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Tradução SX6 - SPANISH", "Traducao SX6 - SPANISH" )
