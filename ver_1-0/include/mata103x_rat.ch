	...
	#define STR0013 "Verifique el prorrateo del item: "
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", , "Não" )
		#define STR0010 If( cPaisLoc $ "ANG|PTG", , "Replicar informações para os demais itens do documento?" )
		#define STR0011 If( cPaisLoc $ "ANG|PTG", , "Todos" )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", , "Rateio Externo está com o registro bloqueado !" )
