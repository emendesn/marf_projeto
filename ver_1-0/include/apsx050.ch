	...
	#define STR0020 "Borrar"
		...
		#define STR0009 "Translation SX5 - ENGLISH"
		#define STR0010 "Search"
		#define STR0011 "View"
		#define STR0012 "Add"
		#define STR0013 "Edit"
		#define STR0014 "Delete"
		#define STR0015 "Translation SX5 - SPANISH"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Registo - SX5", "Cadastro - SX5" )
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Tradução SX5 - ENGLISH", "Traducao SX5 - ENGLISH" )
		#define STR0010 "Pesquisar"
		#define STR0011 "Visualizar"
		#define STR0012 "Incluir"
		#define STR0013 "Alterar"
		#define STR0014 "Excluir"
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Tradução SX5 - SPANISH", "Traducao SX5 - SPANISH" )
