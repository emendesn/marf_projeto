	...
	#define STR0002 "Este municipio no podra borrarse por estar relacionado a solicitudes de viajes."
		...
		Static STR0002 := "Este municipio não poderá ser excluido por estar relacionado a solicitações de viagens."
	#endif
#endif
	...
	If Type('cPaisLoc') == 'C'
		...
		If cPaisLoc == "ANG"
			...
			STR0002 := "Este concelho não poderá ser excluído por estar relacionado a solicitações de viagens."
		ElseIf cPaisLoc == "PTG"
			STR0001 := "Cadastro de Concelhos"
			STR0002 := "Este concelho não poderá ser excluído por estar relacionado a solicitações de viagens."
		EndIf
