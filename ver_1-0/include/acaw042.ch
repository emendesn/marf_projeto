	...
	#define STR0004 "Utilice el ENTER para navegacion vertical y el TAB para navegacion horizontal"
	...
	#define STR0027 "Confirma Inclusion"
		...
		#define STR0004 "Use ENTER to surf vertically and TAB to surf horizontally"
		...
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "Confirmar Inserção", "Confirma Inclusäo" )
	#endif
#endif
