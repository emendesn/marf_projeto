	...
	#define STR0009 "Borrar"
		...
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "Este local de entrega está a ser utilizado nalgum processo e não poderá ser excluído. ", "Este Local de Entrega esta sendo utilizado em algum processo e nao podera ser excluido. " )
