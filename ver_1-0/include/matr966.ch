	...
	#define STR0019 "|    |   No Contribuyente |     Contribuyente  |   No Contribuyente |     Contribuyente  |                    |                    |"
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "|    entradas de mercadorias, bens ou aquisições de serviço  s                                                                      |", "|    Entradas de Mercadorias, Bens ou Aquisicoes de Servicos                                                                      |" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "|    |                        |                        |                        |                icms cobrado por                 |", "|    |                        |                        |                        |                ICMS Cobrado por                 |" )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "|    |                        |                        |                        |             substituição tributaria             |", "|    |                        |                        |                        |             Substituicao Tributaria             |" )
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "| uf |         valor          |        base de         |         outras         +------------------------+------------------------+", "| UF |         Valor          |        Base de         |         Outras         +------------------------+------------------------+" )
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "|    |        contabil        |        cálculo         |                        |          petroleo      |        outros          |", "|    |        Contabil        |        Calculo         |                        |          Petroleo      |        Outros          |" )
