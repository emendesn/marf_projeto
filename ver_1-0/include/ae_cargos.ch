	...
	#define STR0017 "Estandarizar"
	...
	#else
		Static STR0001 := "Cadastro de Cargos"
		Static STR0002 := "Este cargo esta relacionado a colaboradores, portanto não poderá ser excluído."
		Static STR0003 := "Esta rotina seve para padronizar os valores que serão usados no calculo do adiantamento. "
		#define STR0004  "Após a confirmação, os valores serão iguais para todos os cargos."
		Static STR0005 := "Informe os valores para calculo do adiantamento"
		...
		Static STR0010 := "Valores gravados com sucesso."
	...
	If Type('cPaisLoc') == 'C'
		...
		If cPaisLoc == "ANG"
			STR0001 := "Registo de Cargos"
			STR0002 := "Este cargo está relacionado a colaboradores, portanto não poderá ser excluído."
			STR0003 := "Esta rotina seve para padronizar os valores que serão usados no cálculo do adiantamento. "
			STR0005 := "Informe os valores para cálculo do adiantamento"
			STR0010 := "Valores gravados com successo."
		ElseIf cPaisLoc == "PTG"
			STR0001 := "Registo de Cargos"
			STR0002 := "Este cargo está relacionado a colaboradores, portanto não poderá ser excluído."
			STR0003 := "Esta rotina seve para padronizar os valores que serão usados no cálculo do adiantamento. "
