	...
	#define STR0008 If( cPaisLoc == "PER", "Empleado sin CPF registrado.", "Empleado sin RFC (Registro Persona Fisica) registrado." )
	...
	#define STR0036 "¿Desea proseguir?"
		...
		#define STR0008 If( cPaisLoc == "PER", "There is no Individual Tax Registration (CPF) registered for the Employee.", "Employee with no registration of Individual Tax Registration (CPF)." )
		...
		#define STR0008 "Funcionário sem CPF cadastrado."
