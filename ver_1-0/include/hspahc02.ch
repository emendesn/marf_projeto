	...
	#define STR0033 "codigo ----------- C O N V E N I O   ------------- Aten./Canc.    Aten./Canc.    Aten./Canc.   Atendido / Cancelado"
#else
	#ifdef ENGLISH
		...
		#define STR0003 "SERVICING SUMMARY"
		...
		#define STR0012 "             to"
		#define STR0013 "Servicing Initial Dt"
		#define STR0014 "Servicing Final Date"
		#define STR0015 "Fm sect."
		#define STR0016 "To sector"
		#define STR0017 "Fm Clinic"
		...
		#define STR0025 "code   ----------- D  O  C  T  O  R  ------------- Serv./Canc.    Serv./Canc.    Serv./Canc.   Serviced / Cancelled"
		#define STR0026 "continue..."
		#define STR0027 "SUMMARY TOTAL   : =====>"
		#define STR0028 ""
		#define STR0029 "Setor"
		#define STR0030 "Clinic"
		#define STR0031 "Doctors"
		#define STR0032 "Hth. Care"
		#define STR0033 "code   ----------- H T H.  C A R E   ------------- Serv./Canc.    Serv./Canc.    Serv./Canc.   Serviced / Cancelled"
	#else
		...
		#define STR0003 "RESUMO DE ATENDIMENTOS"
		#define STR0004 "Zebrado"
		#define STR0005 "Administracao"
		#define STR0006 "*** CANCELADO PELO OPERADOR***"
		#define STR0007 "1o.Periodo das"
		#define STR0008 "            as"
		#define STR0009 "2o.Periodo das"
		#define STR0010 "            as"
		#define STR0011 "3o.Periodo das"
		#define STR0012 "            as"
		#define STR0013 "Dt Inicial Atendimento"
		#define STR0014 "Data Final Atendimento"
		#define STR0015 "Do Setor"
		#define STR0016 "Ate o Setor"
		#define STR0017 "Da Clinica"
		#define STR0018 "Ate Clinica"
		#define STR0019 "Do Medico"
		#define STR0020 "Ate o Medico"
		#define STR0021 "                                                   1o.Periodo     2o.Periodo     3o.Periodo           TOTAL"
		#define STR0022 "Imprime"
		#define STR0023 "codigo ------------  S E T O R  ------------------ Aten./Canc.    Aten./Canc.    Aten./Canc.   Atendido / Cancelado"
		#define STR0024 "codigo ------  C L I N I C A    M E D I C A  ----- Aten./Canc.    Aten./Canc.    Aten./Canc.   Atendido / Cancelado"
		#define STR0025 "codigo ----------- M  E  D  I  C  O  ------------- Aten./Canc.    Aten./Canc.    Aten./Canc.   Atendido / Cancelado"
		#define STR0026 "continua..."
		#define STR0027 "TOTAL DO RESUMO : =====>"
		#define STR0028 ""
		#define STR0029 "Setor"
		#define STR0030 "Clinica"
		#define STR0031 "Medicos"
