	...
	#define STR0008 " Este programa generara un archivo TXT, para exportacion"
	#define STR0009 " de informaciones segun se configuro en el registro de lineas."
	...
	#define STR0020 "Complete el Codigo del servicio."
		...
		#define STR0008 " This program generates a TXT file to export"
		#define STR0009 " information according to what is set in the rows registration."
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", " Este programa gerará um ficheiro TXT para exportação", " Este programa ira gerar um aquivo TXT, para exportação" )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", " de informações, conforme configurado no registo de linhas.", " de informações conforme cofigurado no cadastro de linhas." )
