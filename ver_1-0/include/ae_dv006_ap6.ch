	...
	#define STR0053 "¡Centro de Costo no Registrado!"
	...
	#else
		Static STR0001 := "Esta solicitação está cancelada e nõa pode ser fechada."
		#define STR0002  "Atenção"
		Static STR0003 := "Prestação de Contas, está Encerrada !"
		Static STR0004 := "Prestação de Contas, não está Liberada !"
		Static STR0005 := "Calculo Total a Faturar"
		...
		Static STR0046 := "Sub Total           US$"
		Static STR0047 := "Sub Total             R$"
		Static STR0048 := "Total a Faturar R$"
		Static STR0049 := "Politica Adotada"
		#define STR0050  "%  Cliente"
		#define STR0051  "%  Franquia"
		Static STR0052 := "%  Não Fatura"
	...
	If Type('cPaisLoc') == 'C'
		...
		If cPaisLoc == "ANG"
			STR0001 := "Esta solicitação está cancelada e não pode ser fechada."
			STR0003 := "Prestação de contas está encerrada !"
			STR0004 := "Prestação de contas não está liberada !"
			STR0005 := "Cálculo Total a Facturar"
			STR0046 := "Sub-Total           US$"
			STR0047 := "Sub-Total             R$"
			STR0048 := "Total a Facturar R$"
			STR0049 := "Política Adotada"
			STR0052 := "%  Não Factura"
		ElseIf cPaisLoc == "PTG"
			STR0001 := "Esta solicitação está cancelada e não pode ser fechada."
			STR0003 := "Prestação de contas está encerrada !"
