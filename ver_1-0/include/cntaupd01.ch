#ifdef SPANISH
	#define STR0001 "Desea hacer la actualizacion del Diccionario v."
	...
	#define STR0022 "Hubo un error desconocido al actualizar la tabla : "
	...
	#define STR0033 "Se incluyeron nuevos parametros. Verifique las configuraciones y funcionalidades : "
	#define STR0034 "Actualizando Disparadores..."
	#define STR0035 "Actualizando Relaciones..."
	#define STR0036 "¡No se pudo abrir la tabla de la empresa de forma exclusiva !"
	#define STR0037 "Consultas"
	#define STR0038 "Actualizando contenido de los campos y la consulta estandar (SXB) de las tablas "
	#define STR0039 "Actualizado Help de Campo en las tablas "
	#define STR0040 'GCTUPD001'
	#define STR0041 'Correccion de estructura de la situacion del contrato.'
	#define STR0042 'Nuevas rutinas y tratamientos en la Gestion de Contratos. '
#else
	#ifdef ENGLISH
		...
		#define STR0036 "Unable to open exclusive company table! "
		#define STR0037 "Queries "
		#define STR0038 "Updating field content and table default search (SXB) "
		#define STR0039 "Updated Field Help in tables "
		#define STR0040 'GCTUPD001'
		#define STR0041 'Contract Situation Structure Correction'
		#define STR0042 'New routines and handling on Contract Management  '
	#else
		...
		#define STR0037 "Consultas"
		#define STR0038 If( cPaisLoc $ "ANG|PTG", "Actualizado o conteúdo dos campos e a consulta padrão (SXB) das tabelas ", "Atualizado conteúdo dos campos e a consulta padrão (SXB)  das tabelas " )
		#define STR0039 If( cPaisLoc $ "ANG|PTG", "Actualizado o Help de Campo nas tabelas ", "Atualizado Help de Campo nas tabelas " )
		#define STR0040 'GCTUPD001'
		#define STR0041 If( cPaisLoc $ "ANG|PTG", 'Correcção estrutura da situação do contrato', 'Correção estrutura da situação do Contrato' )
		#define STR0042 If( cPaisLoc $ "ANG|PTG", 'Novos procedimentos e tratamentos no Gestão de Contratos ', 'Novas rotinas e tratamentos no Gestão de Contratos ' )
	#endif
#endif
