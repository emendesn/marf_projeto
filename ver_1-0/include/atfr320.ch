#ifdef SPANISH
	#define STR0001 "Este programa emite informe Responsables vs. Bienes"
	#define STR0002 "Respons.vs. Bienes"
	...
	#define STR0009 "Datos Responsable - "
	#define STR0010 "Datos Bienes - "
	#define STR0011 "(Orden 1)"
	#define STR0012 "(Orden 2)"
	#define STR0013 "Esperar..."
#else
	#ifdef ENGLISH
		#define STR0001 "Este programa emite o relatório Responsáveis x Bens"
		#define STR0002 "Responsáveis x Bens"
		#define STR0003 "Zebrado"
		#define STR0004 "Administracao"
		#define STR0005 " Responsável + Bem "
		#define STR0006 " Bem + Responsáveis "
		#define STR0007 "*** CANCELADO PELO OPERADOR ***"
		#define STR0008 "Gerando...: "
		#define STR0009 "Responsible info     - "
		#define STR0010 "Assets info    - "
