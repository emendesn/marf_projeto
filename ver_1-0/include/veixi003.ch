	...
	#define STR0028 "CC(Correccion datos)"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este procedimento tem como finalidade a geração ", "Esta rotina tem como finalidade a geração " )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "do ficheiro de comunicação EDI com a montadora ", "do arquivo de comunicação EDI com a montadora " )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "MITSUBISHI veículos - Assunto FACTURAS DE VEÍCULOS.", "MITSUBISHI veículos - Assunto NOTAS FISCAIS DE VEÍCULOS." )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "Exportação do ficheiro de FACTURAS DE VEÍCULOS.", "Exportação do arquivo de NOTAS FISCAIS DE VEÍCULOS." )
		...
		#define STR0027 "CE(Correção Warning)"
		#define STR0028 "CC(Correção dados)"
	#endif
#endif
