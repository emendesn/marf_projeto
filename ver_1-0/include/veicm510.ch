	...
	#define STR0037 "Base conocimiento"
		...
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "Vendedor não relacionado como vendedor de veículos no Registo de Dados Adicionais do Cliente CEV.", "Vendedor não relacionado como Vendedor de Veiculos no Cadastro de Dados Adicionais do Cliente CEV." )
		...
		#define STR0034 "Loja"
		#define STR0035 "Vendedor"
		#define STR0036 "Deseja incluir Oportunidade de Negócios para o Cliente?"
