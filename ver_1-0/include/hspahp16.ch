	...
	#define STR0017 "Lista de Precio      "
		...
		#define STR0017 "Price list    o     "
	#else
		#define STR0001 "Confirma início da atualização?"
		#define STR0002 "Atenção"
		#define STR0003 "Processando..."
		#define STR0004 "Aguarde..."
		#define STR0005 "Aguarde... Atualizando arquivo de Preços Diferenciados!"
		#define STR0006 "Codigo Convenio"
		#define STR0007 "% Desconto"
		#define STR0008 "Inclui Prods. Novos"
		#define STR0009 "Nao"
		#define STR0010 "Sim"
		#define STR0011 "Tabela de Preço"
		#define STR0012 "Aguarde... Incluido novos produtos"
		#define STR0013 "Codigo Convenio     "
		#define STR0014 "Plano               "
		#define STR0015 "% Desconto          "
		#define STR0016 "Inclui Prods. Novos "
		#define STR0017 "Tabela de Preço     "
	#endif
#endif
