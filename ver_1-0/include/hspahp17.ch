	...
	#else
		#define STR0001 "Confirma início da atualização de Preços "
		#define STR0002 "Atenção"
		#define STR0003 "Processando..."
		#define STR0004 "Aguarde..."
		#define STR0005 "Aguarde... Atualizando Medicamentos e Soluções..."
		#define STR0006 "PRODUTO NÃO ENCONTRADO "
		#define STR0007 "FOI REMOVIDO"
		#define STR0008 "Arquivo "
		#define STR0009 ", não encontrado"
		#define STR0010 "MATERIAL"
		#define STR0011 "SOLUCOES"
		#define STR0012 "UNIMED S/PRC"
		#define STR0013 "UNI"
		#define STR0014 "% Lucro Materiais   "
		#define STR0015 "% Lucro Solucoes    "
		#define STR0016 "Atualiza            "
		#define STR0017 "Tab.Selec.(GCB)"
		#define STR0018 "P.Base(SB1/GBI)"
		#define STR0019 "Ambos"
		#define STR0020 "Inclui Intens Novos "
		#define STR0021 "Sim"
		#define STR0022 "Nao"
		#define STR0023 "Atenção"
		#define STR0024 "Leitura dos Arquivos de Integração"
	#endif
#endif
