	...
	#define STR0008 "SUC C. COSTO             MAT.   NOMBRE EMPLEADO                SUELDO  APORTE   SUELDO  APORTE    SUELDO  APORTE             INSS"
	#define STR0009 "                                                               HASTA EL LIMITE   SUPER. AL LIMITE     T O T A L          RETENIDO"
	...
	#define STR0023 "SUC       C. COSTO       MATR.  NOMBRE EMPLEADO               SUELDO CONTRIB. SUELDO CONTRIB.  SUELDO CONTRIB.       I.N.S.S."
#else
	#ifdef ENGLISH
		...
		#define STR0008 "BRA C. CENTER            REG..  EMPLOYEE NAME                  SALARY BASE       SALARY BASE      SALARY BASE            SOC.SEC."
		#define STR0009 "                                                               UNTIL LIMIT       ABOVE LIMIT      T O T A L              WITHH.TX"
		...
		#define STR0023 "BR COST C MATR. EMPLOYEE NAME SALARY CONTRIB SALARY CONTRIB. SALARY CONTRIB. I.N.S.S."
	#else
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Fil C. Custo             Registo  Nome Empregado               Remuneração Contrib. Remuneração Contrib.  Remuneração Contrib.       S.S.", "FIL C. CUSTO             MATR.  NOME FUNCIONARIO               SALARIO CONTRIB. SALARIO CONTRIB.  SALARIO CONTRIB.       I.N.S.S." )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "                                                                 Até O Limite    Acima Do Limite      Total            Retido", "                                                                 ATE O LIMITE    ACIMA DO LIMITE      T O T A L            RETIDO" )
		...
		#define STR0023 "FIL       C. CUSTO       MATR.  NOME FUNCIONARIO               SALARIO CONTRIB. SALARIO CONTRIB.  SALARIO CONTRIB.       I.N.S.S."
	#endif
#endif
