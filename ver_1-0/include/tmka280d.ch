#ifdef SPANISH
	#define STR0001 " Titulos Vencidos Despues de la Ultima Negociacion"
...
#else
	#ifdef ENGLISH
		#define STR0001 " Over due bills after last Negotiation"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", " títulos vencidos após a última negociação", " Títulos Vencidos Após a Última Negociação" )
