	...
	#define STR0013 "Sin Especificacion de Tarea"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Relatório das manutenções em que o empregado   seleccionado é planea-", "Relatorio das manutencoes em que o funcionario   selecionado e planeja-" )
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Bem              Descrição                         Serviço Nome                          Sequência          Consumo Unidade Reserva", "Bem              Descrição                         Serviço Nome                          Sequencia          Consumo Unidade Reserva" )
