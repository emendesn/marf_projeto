	...
	#define STR0013 "    Num. Riesgo Agente                  Fuente Generadora            Evaluacion   Intensid.   U.M.    C.Costo                         Funcion                          Tarea                Entorno"
	...
	#define STR0032 "Indica si imprime la descripcion de la tarea."
		...
		#define STR0013 "    Number Risk Agent                  Generating Source            Intensity Evaluation   M.U.    Cost Center                         Function                          Task                Environment"
		...
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "    Nr. Risco Agente                  Fonte Geradora            Avaliação   Intensid.   U.M.    C.Custo                         Função                          Tarefa                Ambiente", "    Num. Risco Agente                  Fonte Geradora            Avaliacao   Intensid.   U.M.    C.Custo                         Funcao                          Tarefa                Ambiente" )
