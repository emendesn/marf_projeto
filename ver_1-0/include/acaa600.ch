...
#else
	#ifdef ENGLISH
		#define STR0001 "Estorno de Alunos Provisórios"
		#define STR0002 " This program aims at eliminating database "
		#define STR0003 " os alunos provisórios que não efetivaram matrícula "
		#define STR0004 " nos cursos a que foram aprovados. "
		#define STR0005 " Selecione entre estornar alunos provenientes de um processo "
		#define STR0006 " seletivo ou alunos inscritos diretamente em cursos. "
		#define STR0007 "Atenção"
		#define STR0008 "Confirma a operação?"
		#define STR0009 "Confirma"
		#define STR0010 "Cancela"
		#define STR0011 "Processing concluded successfully!"
