	...
	#define STR0003 "Este programa generara un archivo TXT, para exportacion"
	#define STR0004 " de informaciones segun se configuro en el registro de lineas."
	...
	#define STR0050 "Grupo de layout no se encontro."
		...
		#define STR0003 "This program generates a TXT file to export"
		#define STR0004 " information according to what is set in the rows registration."
		...
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "Este programa gerará um ficheiro TXT para exportacão", "Este programa ira gerar um aquivo TXT, para exportacão" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", " de informações, conforme configurado no registo de linhas.", " de informações conforme cofigurado no cadastro de linhas." )
