#ifdef SPANISH
	#define STR0001 "ESTADO POR MODALIDAD VS. CUENTA VS. C.COSTO VS. ITEM CONTABLE VS. CLASE DE VALOR"
	...
	#define STR0018 "TOTAL POR MODALIDAD"
	#define STR0019 "TOTAL GENERAL"
#else
	#ifdef ENGLISH
		#define STR0001 "STATEMENT PER CLASS X ACCOUNT X C. CENTER X ACCOUNTING ITEM X VALUE CLASS"
		...
		#define STR0018 "TOTAL PER CLASS"
		#define STR0019 "GENERAL TOTAL"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "DEMONSTRATIVO POR NATUREZA x CONTA x C.CUSTO x ELEM CONTABIL x CLASSE DE VALOR", "DEMONSTRATIVO POR NATUREZA x CONTA x C.CUSTO x ITEM CONTABIL x CLASSE DE VALOR" )
		...
		#define STR0018 "TOTAL POR NATUREZA"
