	...
	#define STR0008 "Matricula  Empleado                  Realizado   Agente  Nombre del Agente        Examen       Nombre del Examen        Cantidad       IBMP  U.M.     Res."
	...
	#define STR0050 "IBMP"
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Matrícula  Colaborador                  Realizado   Agente  Nome do Agente        Exame       Nome do Exame        Quantidade       IBMP  U.M.     Res.", "Matricula  Funcionario                  Realizado   Agente  Nome do Agente        Exame       Nome do Exame        Quantidade       IBMP  U.M.     Res." )
