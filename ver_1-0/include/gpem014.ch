	...
	#define STR0017 "Empleado con licencia"
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "Ocorreram inconsistências durante o processo de cálculo do benefício. ", "Ocorreram Inconsistências durante o processo de calculo do benefício. " )
		...
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "Fil Matric Mês  Ano Turno Semana Descrição ", "Fil Matric Mes  Ano Turno Semana Descrição " )
