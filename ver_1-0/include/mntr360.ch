	...
	#define STR0035 "Para la opcion 'Ambos' el sistema utilizara el tiempo de parada, si no, utilizara el tiempo de ejecucion."
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Família Descrição                 Bem              Descrição                                   MTBF               MTTR", "Familia Decricao                 Bem              Descrição                                   MTBF               MTTR" )
		...
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "Bem               Descrição                 Centro Custo         Descrição             Família Descrição                        MTBF               MTTR", "Bem               Descrição                 Centro Custo         Descrição             Familia Descrição                        MTBF               MTTR" )
