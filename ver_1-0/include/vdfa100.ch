	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", , "Averbações de Tempo de Contribuição" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", , "Histórico / Manutenção" )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", , "Histórico das Averbações de Tempo de Contribuição" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", , "Averbações de Tempo de Contribuição" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", , "Inclui Averbação" )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", , "Exclui Averbação" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", , "Averbação de Tempo de Contribuição" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", , "1=Tempo para Averbação de Contribuição em Outros Órgãos" )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", , "2=Tempo Simples ou em Dobro de Licença-Prêmio e Férias Não Gozadas" )
		#define STR0010 If( cPaisLoc $ "ANG|PTG", , "1=RGPS (INSS)" )
		#define STR0011 If( cPaisLoc $ "ANG|PTG", , "2=RPPS (Previdência Própria)" )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", , "1=Estatutário" )
		#define STR0013 If( cPaisLoc $ "ANG|PTG", , "2=CLT" )
		#define STR0014 If( cPaisLoc $ "ANG|PTG", , "Filial:" )
		#define STR0015 If( cPaisLoc $ "ANG|PTG", , "Matrícula:" )
		#define STR0016 If( cPaisLoc $ "ANG|PTG", , "Tp.Averbação:" )
		#define STR0017 If( cPaisLoc $ "ANG|PTG", , "Data da Averbação" )
		#define STR0018 If( cPaisLoc $ "ANG|PTG", , "Tp.Regime" )
		#define STR0019 If( cPaisLoc $ "ANG|PTG", , "Sessão" )
		#define STR0020 If( cPaisLoc $ "ANG|PTG", , "Num.Certidão" )
		#define STR0021 If( cPaisLoc $ "ANG|PTG", , "Data Certidão" )
		#define STR0022 If( cPaisLoc $ "ANG|PTG", , "Órgão Exped." )
		#define STR0023 If( cPaisLoc $ "ANG|PTG", , "Período De" )
		#define STR0024 If( cPaisLoc $ "ANG|PTG", , "Período Até" )
		#define STR0025 If( cPaisLoc $ "ANG|PTG", , "Ent.Contrib." )
		#define STR0026 If( cPaisLoc $ "ANG|PTG", , "Tempo Bruto" )
		#define STR0027 If( cPaisLoc $ "ANG|PTG", , "Deduções" )
		#define STR0028 If( cPaisLoc $ "ANG|PTG", , "Tempo Liq." )
		#define STR0029 If( cPaisLoc $ "ANG|PTG", , "Tipo de Registro da Informação" )
		#define STR0030 If( cPaisLoc $ "ANG|PTG", , "Selecione a Modalidade" )
		#define STR0031 If( cPaisLoc $ "ANG|PTG", , '"N" - Novo' )
		#define STR0032 If( cPaisLoc $ "ANG|PTG", , '"H" - Histórico' )
