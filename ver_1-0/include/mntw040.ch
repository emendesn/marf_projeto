	...
	#define STR0034 "Servidor SMTP não informado! Favor, verificar parâmetro MV_RELSERV."
		...
		#define STR0025 "Check the configuration parameters: "
		...
		#define STR0019 If( cPaisLoc $ "ANG|PTG", "Solicitação de serviço a ser atendida", "Solicitação de Serviço a ser atendida" )
		...
		#define STR0023 "Abertura de Solicitação de Serviço"
		#define STR0024 "Não há dados para gerar o workflow."
		#define STR0025 "Verifique os parametros de configuracao: "
		#define STR0026 "MV_RELAUSR e MV_RELAUTH."
		#define STR0027 "Atenção!"
		#define STR0028 "Verifique os parâmetros de configuração."
		#define STR0029 " Favor, verificar parâmetro MV_RELACNT"
