	...
	#define STR0039 "El Incoterms utilizado preve el registro de Gastos."
	#define STR0040 " Solo se permitirá emitir la Factura complementaria de Embarque,"
	...
	#define STR0055 "El TES selec., esta configur. para generar Fact. de Cred. ¿Desea continuar?"
		...
		#define STR0039 "Incoterms used envisages entry of expenses.        "
		#define STR0040 " Issuing of shipping supplementary invoice is only allowed       "
		...
		#define STR0039 If( cPaisLoc $ "ANG|PTG", "O Incoterms Utilizado Prevê Lançamento De Despesas.", "O Incoterms utilizado prevê lançamento de Despesas." )
		#define STR0040 If( cPaisLoc $ "ANG|PTG", " Só Será Permitido Emitir A Factura Complementar De Embarque,", " Só sera permitido emitir a Nota fiscal complementar de Embarque," )
