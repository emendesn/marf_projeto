	...
	#define STR0010 "Para consultar detalles de la carencia posicione sobre el procedimiento deseado y haga clic en el boton verde de confirmacion (ok)"
	...
	#define STR0030 "Anulado por el usuario."
		...
		#define STR0010 "To check the details about grace period, place the cursor on the procedure desired and click the confirm button - green (ok)"
		...
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "Para consultar detalhes da carência posicione sobre o procedimento desejado e clique no botão verde de confirmação (ok)", "Para consultar detalhes da carencia posicione sobre o procedimento desejado e clique no botao de verde de confirmacao (ok)" )
