	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Registo - SXA", "Cadastro - SXA" )
		#define STR0002 "Pesquisar"
		#define STR0003 "Visualizar"
		#define STR0004 "Incluir"
		#define STR0005 "Alterar"
		#define STR0006 "Excluir"
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Tradução SXA - ENGLISH", "Traducao SXA - ENGLISH" )
		#define STR0008 "Pesquisar"
		#define STR0009 "Visualizar"
		#define STR0010 "Incluir"
		#define STR0011 "Alterar"
		#define STR0012 "Excluir"
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "Tradução SXA - SPANISH", "Traducao SXA - SPANISH" )
