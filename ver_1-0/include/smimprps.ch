	...
	#define STR0089 "No"
		...
		#define STR0057 "below will defint the directory of"
		...
		#define STR0089 "No "
	#else
		#define STR0001 "Arquivo modelo não encontrado"	
		#define STR0002 "O arquivo modelo para impressão dos RPS "
		#define STR0003 " não foi encontrado no diretório "
		#define STR0004 ", indicado nas perguntas da rotina."
		#define STR0005 "Verifique se o arquivo de retorno informado nas "
		#define STR0006 "Informe o diretório e o nome do arquivo "
		#define STR0007 "corretamente e processe a rotina novamente."
		#define STR0008 "MS-Word não localizado"
		#define STR0009 "O programa MS-Word não está instalado nesta máquina. "
		#define STR0010 "Apenas com a existência deste programa, é possível "
		#define STR0011 "efetuar a impressão do RPS."
		#define STR0012 "Instale o MS-Word nesta máquina ou efetue a impressão "
		#define STR0013 "em outra máquina que possua o programa instalado."
		#define STR0014 "Pesquisar"
		#define STR0015 "Visualizar"
		#define STR0016 "Manual"
		#define STR0017 "Automática"
		#define STR0018 "Impressão do Recibo Provisório de Serviços - RPS"
		#define STR0019 "Parâmetro inexistente"
		#define STR0020 "O parâmetro MV_NFESERV não está definido no dicionário de dados. "
		#define STR0021 "Este parâmetro irá indicar como deverá ser composta a descrição "
		#define STR0022 "do serviço prestado no documento. Caso este parâmetro não seja "
		#define STR0023 "cadastrado, a descrição sempre será composta pelo conteúdo "
		#define STR0024 "da tabela 60 do SX5. O programa tem a opção de compor a descrição "
		#define STR0025 "do serviço prestado observando também a mensagem da nota fiscal "
		#define STR0026 "lançada no pedido de vendas. Para tanto, será necessário observar "
		#define STR0027 "a solução proposta abaixo: "
		#define STR0028 "Estrutura do parâmetro MV_NFESERV: "
		#define STR0029 "<indica se a descrição do serviço prestado na Nota Fiscal "
		#define STR0030 "Eletrônica deverá ser composta 1 = pelo pedido de vendas ou "
		#define STR0031 "descrição do SX5 ou 2 - somente pela descrição do SX5>."
		#define STR0032 " Para maiores referências, consultar a documentação que acompanha a rotina."
		#define STR0033 "Informe o diretório onde se encontra o "
		#define STR0034 "arquivo padrão de impressão (.DOT). "
		#define STR0035 "Exemplo: C:\MP8\SYSTEM\"
		#define STR0036 "Diretório .DOT"
		#define STR0037 "Informe o nome do arquivo que contém "
		#define STR0038 " o modelo para impressão do RPS, "
		#define STR0039 "incluindo a extensão. Exemplo: RPS.DOT"
		#define STR0040 "Informe a data de emissão inicial "
		#define STR0041 "para seleção dos documentos a imprimir."
		#define STR0042 "Emissão inicial"
		#define STR0043 "Informe a data de emissão final "
		#define STR0044 "para seleção dos documentos a imprimir."
		#define STR0045 "Emissão final"
		#define STR0046 "Informe o cliente inicial "
		#define STR0047 "Deixe esta pergunta em branco, para que "
		#define STR0048 "todos os clientes sejam processados."
		#define STR0049 "Cliente inicial"
		#define STR0050 "Informe o cliente final "
		#define STR0051 "Informe ZZZZZZ, para que "
		#define STR0052 "Cliente final"
		#define STR0053 "Define se os RPS selecionados pela "
		#define STR0054 "rotina automática serão impressos ou "
		#define STR0055 "apenas gravados para impressão posterior. "
		#define STR0056 "Caso a opção seja a gravação, a pergunta "
		#define STR0057 "abaixo irá definir o diretório de "
		#define STR0058 "gravação"
		#define STR0059 "Quanto opcäo automática"
		#define STR0060 "Imprimir"
		#define STR0061 "Gravar"
		#define STR0062 "Define o diretório de gravação dos "
		#define STR0063 "documentos selecionados pela rotina "
		#define STR0064 "automática, caso tenha sido selecionada "
		#define STR0065 "a opção 'Gravar' na pergunta acima."
		#define STR0066 "Diretório destino"
		#define STR0067 "Arquivo .DOT"
		#define STR0068 "Implementação não efetuada"
		#define STR0069 "A implementação do processo da Nota "
		#define STR0070 "Fiscal Eletrônica não foi efetuada corretamente, "
		#define STR0071 "visto que existem tabelas e campos que "
		#define STR0072 "não estão disponíveis no dicionário de dados."
		#define STR0073 "Verifique a documentação que acompanha a rotina e "
		#define STR0074 "execute todos os procedimentos indicados e processe "
		#define STR0075 "esta rotina novamente."
		#define STR0076 "Tabela SFT - "
		#define STR0077 " Campos: "
		#define STR0078 "Informe o número do RPS inicial para"
		#define STR0079 "todos os RPS sejam processados."
		#define STR0080 "RPS inicial"
		#define STR0081 "Informe o número do RPS final para"
		#define STR0082 "RPS final"
		#define STR0083 "RPS gerado por emissor de cupom fiscal (ECF)"
		#define STR0084 "Informe se deseja que os RPS"
		#define STR0085 "cancelados sejam selecionados"
		#define STR0086 "para impressao."
