	...
	#define STR0059 "Descripcion"
		...
		#define STR0041 If( cPaisLoc == "CHI", "Centro Trab", "Paym. Location" )
		#define STR0042 If( cPaisLoc == "CHI", "Centro Trabajo", "Payment Location" )
		#define STR0043 If( cPaisLoc == "CHI", "Total Centro Trab", "Payment Local. Total" )
