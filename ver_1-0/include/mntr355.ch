	...
	#define STR0020 "Puesto      Nombre Fantasia                          Tienda   Flota                       Km           Km Recorrido   Ctd.Litros        Promedio         Vlr.Unit.            Val.Total      Fecha"
	...
	#define STR0044 "No exite conductor relacionado al abastecimiento del bien."
	...
	#define STR0049 "Informe que opcion desea ordenar la impresion del informe."
		...
		#define STR0044 "There is no driver correlated to refueling of the asset."
		...
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "Posto      Nome Comercial                         Loja   Frota                       Km           Km Percorrido   Qtd.Litros        Média         Vlr.Unit.            Vlr.Total      Data", "Posto      Nome Fantasia                          Loja   Frota                       Km           Km Percorrido   Qtd.Litros        Média         Vlr.Unit.            Vlr.Total      Data" )
		...
		#define STR0044 If( cPaisLoc $ "ANG|PTG", "Não exite condutor relacionado ao abastecimento do bem.", "Não exite motorista relacionado ao abastecimento do bem." )
