#ifdef SPANISH
	#define STR0001 "Consolidacion de los valores de costo operativo vs. factor moderador"
...
#else
	#ifdef ENGLISH
		#define STR0001 "Consolidation of amounts for operating costs x moderator fact"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Consolidação dos valores de custo operacional x factor moderador", "Consolidacao dos valores de custo operacional x fator modernador" )
