	...
	#define STR0024 "La rutina de off-shore no podra habilitarse."
	...
	#define STR0042 "Total Anticipo"
		...
		#define STR0024 If( cPaisLoc $ "ANG|PTG", "O procedimento de off-shore não poderá ser habilitada.", "A rotina de off-shore näo sera podera ser habilitada." )
