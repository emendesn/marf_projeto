	...
	#define STR0011 "SUC MATRIC NOM. DEL EMPLEADO                    SUELDO  CAT FUNC.                      CENTRO DE COSTO"
	#define STR0012 "SUC MATRIC NOMBRE DEL EMPLEADO                  SUELDO  CAT CENTRO DE COSTO"
	#define STR0013 "SUC MATRIC NOMBRE DEL EMPLEADO                  SUELDO  CAT FUNC. "
	...
	#define STR0026 "Favor utilizar el compatibilizador RHUPDCSA, opcion 'Ajustar Campos para sueldo' para ajuste da tabla RB7"
		...
		#define STR0011 "BCH REG.   EMPLOYEE NAME                      SALARY    CAT FUNCTION                   COST CENTER"
		#define STR0012 "BCH REG.   EMPLOYEE NAME                      SALARY    CAT COST CENTER"
		#define STR0013 "BCH REG.   EMPLOYEE NAME                      SALARY    CAT FUNCT."
		...
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "Fil. Reg.    Nome do Empregado                    Remuneração Cat. Função                     Centro De Custo", "FIL MATRIC NOME DO FUNCIONARIO                  SALARIO CAT FUNCAO                     CENTRO DE CUSTO" )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "Fil. Registo Nome Do Empregado                  Remuneração Cat. Centro De Custo", "FIL MATRIC NOME DO FUNCIONARIO                  SALARIO CAT CENTRO DE CUSTO" )
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "Fil.registo Nome Do Empregado                  Remuneração Cat. Função", "FIL MATRIC NOME DO FUNCIONARIO                  SALARIO CAT FUNCAO" )
