	...
	#define STR0048 "¡Recurso anulado con exito!"
		...
		#define STR0040 If( cPaisLoc $ "ANG|PTG", , "O status atual não possibilita inclusão de um recurso!" )
		#define STR0041 If( cPaisLoc $ "ANG|PTG", , "O status atual não possibilita analise do recurso!" )
		...
		#define STR0046 If( cPaisLoc $ "ANG|PTG", , "O recurso só pode ser cancelado com o status de protocolado!" )
		#define STR0047 If( cPaisLoc $ "ANG|PTG", , "O recurso só pode ser cancelado com o status de protocolado!" )
