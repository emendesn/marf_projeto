#ifdef SPANISH
	#define STR0001 "Informe de mantenimientos en que la especialidad seleccionada es planea-"
	...
	#define STR0006 "Donde se Usa Especialidad"
	...
	#define STR0015 "ATENCION"
#else
	#ifdef ENGLISH
		#define STR0001 "Report on maintenances in which the selected Skill has been alloca-"
		...
		#define STR0006 "Where-To-Use Skill"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Relatório das manutenções em que a especialidade seleccionada é planea-", "Relatorio das manutencoes em que a especialidade selecionada e planeja-" )
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Onde-se-usa Especialidade", "Onde-Se-Usa Especialidade" )
