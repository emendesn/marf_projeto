#ifdef SPANISH
	#define STR0001 "Verificacion de mapa de separacion"
	...
	#define STR0014 "¡Servicio de verificacion no encontrado!"
	#define STR0015 "Certifiquese que:"
	#define STR0016 "Finalizando la Verificacion."
	#define STR0017 "¡Espere!.."
	#define STR0019 "Microsiga Protheus WMS - LOG de Ocurrencias en la Verificacion ("
	#define STR0020 "Log generado en "
	#define STR0021 ", las "
	#define STR0022 "- Se genero el mapa de separac.;"
	#define STR0023 "- Se atribuyo el Separador al mapa consolidado;"
	...
	#define STR0033 " se genero. Llame al supervisor."
	#define STR0034 "Contando Productos."
	#define STR0037 "¡Etiqueta invalida !"
	#define STR0038 "El Producto "
	#define STR0039 " no esta registrado. ATENCION: En la lectura de codigo de barras, deje el parametro MV_DLCOLET igual a S"
	#define STR0040 "¡Verificador no autorizado!"
	#define STR0041 "- La direccion de servicio fue atribuida al mapa consolidado;"
	#define STR0042 "¡Informe el codigo del mapa de separacion!"
	#define STR0043 "¡Informe un empaquetador!"
	#define STR0044 "Recurso "
	#define STR0045 " ¡No registrado! (DCD)"
	#define STR0046 "Exiten items del mapa de separacion "
	#define STR0047 " que no estan aptos para verificacion."
	#define STR0048 "El producto "
	#define STR0049 " no pertenece al mapa de separacion."
#else
	#ifdef ENGLISH
