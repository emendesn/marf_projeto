	...
	#define STR0005 "No hay datos p/esta Matric."
	...
	#define STR0022 "¿Matricula vehic.?"
		...
		#define STR0005 "There is no data for this License Plate"
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "Não há dados para esta placa", "Nao ha dados para esta Placa" )
