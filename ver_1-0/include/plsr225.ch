	...
	#define STR0003 "Dia de Vencimiento/Fecha de Baja"
	...
	#define STR0029 "TOTAL DE LA QUIEBRA      "
		...
		#define STR0008 "MATRICULA        NOME                                             TELEFONE        VENCTO  VL TITULO      SALDO      JUROS      TOTAL"
		#define STR0009 "PRF NUM          NOME                                              TELEFONE       VENCTOX  VL TITULO      SALDO      JUROS      TOTAL"
		#define STR0010 " - Pending   ("
		#define STR0011 "Detailed "
		#define STR0012 "Summarizd"
		#define STR0013 "MATRICULA        NOME                         DATA VENCTO DT BAIXA NUM BANCO       VALOR      JUROS  DESCONTO      TOTAL"
		#define STR0014 "PRF NUM          NOME                         DATA VENCTO DT BAIXA NUM BANCO       VALOR      JUROS  DESCONTO      TOTAL"
		#define STR0015 "                                                                                   AMOUNT     INTRST DISCOUNT      TOTAL"
		#define STR0016 " - Collected ("
		#define STR0017 "MATRICULA        NOME                                               DATA VENCTO     VALOR     MAT. ANTIGA"
		#define STR0018 "PRF NUM          NOME                                              DATA VENCTO    VALOR     MAT. ANTIGA"
		#define STR0019 "                                                                                                                               AMNT."
		#define STR0020 " - All   ("
