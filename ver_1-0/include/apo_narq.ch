	...
	#define STR0013 "Aula"
		...
		#define STR0005 "Vigência:"
		#define STR0006 "Turmas:"
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Cofacturairma ", "Confirma " )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Sair Sem Guardar", "Sair sem Salvar" )
		#define STR0009 "Excluir"
		#define STR0010 "(dd/mm/aaaa) "
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "Procurar Ficheiro", "Buscar Arquivo" )
