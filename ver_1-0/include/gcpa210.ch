	...
	#define STR0036 ". Todos deben ser iguales dentro del lote."
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", , "***Resultado Final*** Integração realizada com SUCESSO." )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", , "***Resultado Final*** Integração NÃO realizada." )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", , "Resultado" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", , "Ok" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", , "***Resultado Final*** Integração realizada com SUCESSO." )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", , "***Resultado Final*** Integração NÃO realizada." )
		...
		#define STR0010 If( cPaisLoc $ "ANG|PTG", , "Login do usuário" )
		...
		#define STR0014 If( cPaisLoc $ "ANG|PTG", , "Licitação incluida com sucesso." )
		...
		#define STR0020 If( cPaisLoc $ "ANG|PTG", , "Não Foi possível conectar ao comprasnet, verifique sua conexão ou sua auteticação pode estar incorreta." )
		#define STR0021 If( cPaisLoc $ "ANG|PTG", , "O produto '" )
		#define STR0022 If( cPaisLoc $ "ANG|PTG", , "' não possui Tipo de produto(B5_TIPO) Material ou Servico" )
		#define STR0023 If( cPaisLoc $ "ANG|PTG", , "O produto '" )
		#define STR0024 If( cPaisLoc $ "ANG|PTG", , "' não esta vinculado ao CATMAT (B5_CATMAT)" )
		#define STR0025 If( cPaisLoc $ "ANG|PTG", , "O produto '" )
		#define STR0026 If( cPaisLoc $ "ANG|PTG", , "' não especifica se o atende o Decreto 7174(B5_DEC7174)Sim ou Não" )
		#define STR0027 If( cPaisLoc $ "ANG|PTG", , "Não existem dados complemetares(SB5) para o produto '" )
		#define STR0028 If( cPaisLoc $ "ANG|PTG", , "Existem Licitantes cadastrados, para proseguir com a integração é necessario exclui-los. Deseja exclui-los?" )
		...
		#define STR0033 If( cPaisLoc $ "ANG|PTG", , "Erro Integração, código erro:" )
