	...
	#define STR0003 "MITSUBISHI vehiculos - Asunto FACTURAS DE SERVICIO."
	#define STR0004 "Exportacion del archivo de FACTURAS DE SERVICIO."
	...
	#define STR0027 "PSCE(Cor Warn)"
	#define STR0028 "PSCC(Cor Dad)"
#else
	#ifdef ENGLISH
		#define STR0001 "This routine aims at generating "
		#define STR0002 "EDI communication file with the automaker "
		#define STR0003 "MITSUBISHI vehicles - Subject SERVICE INVOICES."
		#define STR0004 "Export file SERVICE INVOICES."
		...
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "MITSUBISHI veículos - Assunto FACTURAS DE SERVIÇO.", "MITSUBISHI veículos - Assunto NOTAS FISCAIS DE SERVIÇO." )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "Exportação do ficheiro de FACTURAS DE SERVIÇO.", "Exportação do arquivo de NOTAS FISCAIS DE SERVIÇO." )
