	...
	#define STR0014 "Mes invalido"
		...
		#define STR0006 "Imprimir"
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Histórico Tab.Honor.Padrão", "Historico Tab Honor Padrao" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Modelo de dados de histórico tab.honor.padrão", "Modelo de Dados de Historico Tab Honor Padrao" )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Dados de histórico tab.honor.padrão", "Dados de Historico Tab Honor Padrao" )
		...
		#define STR0012 "Não é permitido gravar histórico futuros"
