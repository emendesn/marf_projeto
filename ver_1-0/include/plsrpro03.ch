	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", , "Geração de Graficos na Anamnese" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", , " Dias" )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", , " Mês" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", , " Ano" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", , "Gerando gráfico, aguarde..." )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", , "Calculadora" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", , "Imprimir" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", , "Prontuário" )
