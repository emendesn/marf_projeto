	...
	#define STR0006 "Cod. del Usuario"
	#define STR0007 "Nomb. Usuario que utilizo el servicio"
	#define STR0008 "Fch.Aten.N.Debito"
	#define STR0009 "Cant."
	#define STR0010 "Codigo AMB"
	...
	#define STR0038 "Total"
		...
		#define STR0007 "Name of User who used the service"
		#define STR0008 "Debit N.Serv.Date"
		#define STR0009 "Amount"
		#define STR0010 "AMB Code"
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Codigo do utilizador", "Codigo do Usuario" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Nome do utilizador que utilizou o serviço", "Nome do Usuario que utilizou o servico" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Dt.Atend.N.Débito", "Dt.Atend.N.Debito" )
		#define STR0009 "Quant."
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "Código AMB", "Codigo AMB" )
