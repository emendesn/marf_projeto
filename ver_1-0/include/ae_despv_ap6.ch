	...
	If Type('cPaisLoc') == 'C'
		...
		If cPaisLoc == "ANG"
			STR0012 := "Cancelar"
			STR0013 := "Deseja realmente cancelar a prestação de contas avulsa?"
			STR0014 := "Este registro nao trata-se de uma despesa avulsa."
			STR0015 := "Excluir"
			STR0016 := "Deseja realmente excluir a prestação de contas avulsa?"
			STR0017 := "Esta solicitaçao ja esta cancelada deseja realmente exclui-la?"
		ElseIf cPaisLoc == "PTG"
			STR0012 := "Cancelar"
			STR0013 := "Deseja realmente cancelar a prestação de contas avulsa?"
			STR0014 := "Este registro nao trata-se de uma despesa avulsa."
