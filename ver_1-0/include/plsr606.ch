...
#else
	#ifdef ENGLISH
		#define STR0001 "Relatorio do cadastro da Rede de Atendimento"
		#define STR0002 "Este relatorio ira emitir os dados cadastrais da"
		#define STR0003 "Rede de Atendimento"
		#define STR0004 "Code "
		#define STR0005 "Name"
