	...
	#else
		#define STR0001 "A U T O RI Z A C A O     D E      D O C U M E N T O S "
		#define STR0002 "AUTORIZACAO DE DOCUMENTOS"
		#define STR0003 " de "
		#define STR0004 "A U T O R I Z A C A O"
		#define STR0005 "Eu, "
		#define STR0006 "Autorizo o "
		#define STR0007 "a enviar copias  de  documentos  do  meu prontuario, a auditoria do"
		#define STR0008 "convenio, do qual faco parte  relativas  ao  periodo em  que estive"
		#define STR0009 "internado nesse hospital, para efeito de analise medico-financeira."
		#define STR0010 "NOME:_______________________________________"
		#define STR0011 "R.G.:_________________________"
	#endif
#endif
