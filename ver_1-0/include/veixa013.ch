#ifdef SPANISH
	#define STR0001 "Salida de Vehiculos por Remesa"
...
#else
	#ifdef ENGLISH
		#define STR0001 "Outflow of Vehicles per Remittance"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Saída de Veículos por Remessa", "Saida de Veiculos por Remessa" )
