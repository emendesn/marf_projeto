	...
	#define STR0047 "El Título tuvo su solicitud de transferencia presentada para la Sucursal "
		...
		#define STR0002 "Possui cópia da NF que mostra o aceite do devedor?"
		#define STR0003 "Possui instrução de protesto?"
		#define STR0004 "Transference request"
		...
		#define STR0024 "Fatura cancelada. Não é permitida a inclusão da solicitação de transferência"
		#define STR0025 "Não é permitida a inclusão da solicitação de transferência para titulos de abatimento. Por favor posicione sobre o titulo principal para efetuar a solicitação."
		#define STR0026 "Transferência Automática"
		#define STR0027 "Possui instrução de protesto?"
		#define STR0028 "Estorno de Transferencia de titulo entre filiais."
		#define STR0029 "Este titulo não foi utilizado em tranferencia."
