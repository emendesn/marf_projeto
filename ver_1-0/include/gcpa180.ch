	...
	#define STR0034 "Problema con inclusión de participante "
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", , "Cadastro de Fornecedores/Habilitação" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", , "Incluir" )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", , "Consulta de Fornecedores no SICAF" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", , "Parâmetros de Consulta de Fornecedores" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", , "Inclui Fornecedor/Participante" )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", , "Não existem campos preenchidos para realizar esta busca." )
		...
		#define STR0011 If( cPaisLoc $ "ANG|PTG", , "Problemas consultando dados básicos do fornecedor" )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", , " fornecedores, " )
		#define STR0013 If( cPaisLoc $ "ANG|PTG", , "Foram encontrados " )
		#define STR0014 If( cPaisLoc $ "ANG|PTG", , "serão exibidos apenas os 990 primeiros no grid." )
		#define STR0015 If( cPaisLoc $ "ANG|PTG", , "Informe filtro mais específico para restringir o resultado." )
		#define STR0016 If( cPaisLoc $ "ANG|PTG", , "Erro no recebimento das informações pelo SICAF" )
		#define STR0017 If( cPaisLoc $ "ANG|PTG", , "Não existem linhas do grid selecionadas para realizar inclusão." )
		#define STR0018 If( cPaisLoc $ "ANG|PTG", , "Confirma inclusão dos fornecedores/participantes selecionados?" )
		#define STR0019 If( cPaisLoc $ "ANG|PTG", , " ), não será feita importação do mesmo." )
		#define STR0020 If( cPaisLoc $ "ANG|PTG", , "Já existe fornecedor com CPF semelhante ao " )
		#define STR0021 If( cPaisLoc $ "ANG|PTG", , " ), não será feita importação do mesmo." )
		#define STR0022 If( cPaisLoc $ "ANG|PTG", , "Já existe participante com CPF semelhante ao " )
		#define STR0023 If( cPaisLoc $ "ANG|PTG", , "Atenção!" )
		#define STR0024 If( cPaisLoc $ "ANG|PTG", , "Os fornecedores/participantes selecionados não serão processados." )
		#define STR0025 If( cPaisLoc $ "ANG|PTG", , " Fornecedores" )
		#define STR0026 If( cPaisLoc $ "ANG|PTG", , " Participantes" )
		#define STR0027 If( cPaisLoc $ "ANG|PTG", , "Serão incluídos " )
		#define STR0028 If( cPaisLoc $ "ANG|PTG", , "Fornecedores" )
		#define STR0029 If( cPaisLoc $ "ANG|PTG", , "Problemas consultando dados básicos do fornecedor" )
		#define STR0030 If( cPaisLoc $ "ANG|PTG", , "Retorno do httpget() inconsistente não permite obter dados dos fornecedores." )
		#define STR0031 If( cPaisLoc $ "ANG|PTG", , "Problemas consultando dados detalhados do fornecedor" )
		#define STR0032 If( cPaisLoc $ "ANG|PTG", , "Fornecedor não encontrado na consulta detalhada" )
		#define STR0033 If( cPaisLoc $ "ANG|PTG", , "Problema com inclusão do fornecedor " )
		#define STR0034 If( cPaisLoc $ "ANG|PTG", , "Problema com inclusão do participante " )
	#endif
#endif
