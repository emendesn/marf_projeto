#ifdef SPANISH
	#define STR0001 "No se pudo montar el menu. ¡La cantidad de items excede el limite maximo que se permite!"
	#define STR0002 "Contacte el Adminsitrador para verificar la estructura del menu."
#else
	#ifdef ENGLISH
		#define STR0001 "Menu elaboration was not possible. Amount of items exceeds maximum limit allowed!"
		#define STR0002 "ContactAdministrator to check menu structure."
	#else
