	...
	#define STR0032 "La fecha de desmontaje del kit es menor o igual al ultimo cierre de stock, no se podra hacer el asiento."
		...
		#define STR0015 "There´s no enough quantity of the Product"
		...
		#define STR0031 "A Data da montagem do kit é menor ou igual ao último fechamento de estoque, não será possível efetuar o lançamento."
		#define STR0032 "A Data da desmontagem do kit é menor ou igual ao último fechamento de estoque, não será possível efetuar o lançamento."
	#else
		#define STR0001 "Pesquisar"
		#define STR0002 "Montagem"
		#define STR0003 "Montagem e Desmontagem de Kit's"
		#define STR0004 "Montagem de Kit's"
		#define STR0005 "Desmontagem de Kit's"
		#define STR0006 "Qtd a Montar"
		#define STR0007 "Qtd a Desmontar"
		...
		#define STR0013 " está DESATIVADO!"
		#define STR0014 " Não Pode Ser Lançado Para Pacientes!"
		#define STR0015 "Não existe quantidade suficiente do Produto "
		#define STR0016 " para a Montagem do Kit!"
		#define STR0017 " não existe no Arquivo de Saldos!"
		#define STR0018 "Quantidade de Kit's em Estoque é insuficiente para a Desmontagem!"
		#define STR0019 "Desmontagem"
		#define STR0020 "Prod. do Kit"
		#define STR0021 "1 - Codigo do Kit"
		#define STR0022 "2 - Descricao"
		#define STR0023 "3 - Produto Kit"
		#define STR0024 "O Produto principal "
		#define STR0025 " Possui Rastro, Necessario Informar o Lote!"
		#define STR0026 "Validação dos Campos"
		#define STR0027 " está sendo inventariado e não pode movimentar estoque"
		#define STR0028 "Verifica inventário"
		#define STR0029 "Quantidade a montar invalida"
		#define STR0030 "Quantidade a desmontar invalida"
		#define STR0031 "A Data da montagem do kit é menor ou igual ao último fechamento de estoque, não será possível efetuar o lançamento."
		#define STR0032 "A Data da desmontagem do kit é menor ou igual ao último fechamento de estoque, não será possível efetuar o lançamento."
	#endif
#endif
