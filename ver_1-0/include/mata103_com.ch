	...
	#define STR0035 "Buscar"
		...
		#define STR0003 If( cPaisLoc $ "ANG|PTG", , "Favor verificar o(s) produto(s) que estejam nesta condição para que o Pedido seja carregado totalmente !" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", , "No Pedido de Compra selecionado, existem produto(s) que não possuem cadastro na Filial de Entrada da Nota Fiscal." )
		...
		#define STR0014 If( cPaisLoc $ "ANG|PTG", , "O Produto selecionado do Pedido de compra, não possui cadastro na Filial de Entrada da Nota Fiscal. Favor efetuar cadastro !" )
		#define STR0015 If( cPaisLoc $ "ANG|PTG", , "Consulta ao Pedido de Compra" )
		#define STR0016 If( cPaisLoc $ "ANG|PTG", , "Consulta Autorização de Entrega" )
		...
		#define STR0021 If( cPaisLoc $ "ANG|PTG", , "Para documentos com lote do PLS, é permitido somente um pedido." )
