	...
	#define STR0036 "El intervalo de tiempo informado excedio el retorno maxímo de registros."
	#define STR0037 "Por favor, seleccione un intervalo de tiempo menor."
		...
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "Não foram encontrados WO para o filtro informado.", "Não foram encontrados WO para o filtro informado!" )
		#define STR0029 "Filtrar por"
		...
		#define STR0036 If( cPaisLoc $ "ANG|PTG", "O intervalo de tempo informado excedeu o retorno máxímo de registos.", "O intervalo de tempo informado excedeu o retorno maxímo de registros." )
