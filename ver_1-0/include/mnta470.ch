	...
	#define STR0055 "La fecha inicio de la movimentacion del bien debe estar en el mes igual o superior de la fecha informada en el parametro MV_ULTDEPR = "
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Registo De Movimentação", "Cadastro de Movimentacao" )
		#define STR0009 "Bem"
		...
		#define STR0014 If( cPaisLoc $ "ANG|PTG", "Dados Da Movimentação Anterior", "Dados Da Movimentacao Anterior" )
		#define STR0015 "Data"
		#define STR0016 "Hora"
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "Dados Da Movimentação Posterior", "Dados Da Movimentacao Posterior" )
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "Dados Da Movimentação", "Dados Da Movimentacao" )
		...
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "Utilização", "Utilizacao" )
		#define STR0022 "Contador 1"
		#define STR0023 "Contador 2"
		...
		#define STR0035 "Contador"
		#define STR0036 If( cPaisLoc $ "ANG|PTG", "Variação Dia", "Variacao Dia" )
		#define STR0037 "Acumulado"
		...
		#define STR0039 If( cPaisLoc $ "ANG|PTG", "Deseja seleccionar ordens de serviço para serem", "Deseja selecionar ordens de servico para serem" )
