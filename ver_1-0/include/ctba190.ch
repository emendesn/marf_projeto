	...
	#define STR0013 "Hay un reprocesamiento en ejecución ! " + CHR ( 10 ) + "Intente nuevamente despues, o verifique" + CHR ( 10 ) + "se hay usuario reprocesando."
	...
	#define STR0051 "La configuracion de Job no esta activa. El proceso se encerrará  automaticamente."
		...
		#define STR0013 "Reprocessing in use ! Try again later or check other users."
		...
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "Ha um reprocessamento em execução  ! " + chr ( 10 ) + "tente novamente depois, ou verificar" + chr ( 10 ) + "se há  utilizador rea processar.", "Há um reprocessamento em execução ! " + CHR ( 10 ) + "Tente novamente depois, ou verifique" + CHR ( 10 ) + "se há usuário reprocessando." )
