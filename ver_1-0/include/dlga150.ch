	...
	#define STR0026 "Cantidad de caracteres de la expresion que se configuro en el parametro MV_WMSPRIO (Secuencia de prioridad) es mayor que 46."
	...
	#define STR0036 "Existe facturacion para el pedido/item: "
		...
		#define STR0026 "Number of characters of the expression set in parameter MV_WMSPRIO (Priority Sequence) higher than 46."
		...
		#define STR0026 "Quantidade de caracteres da expressão configurada no parâmetro MV_WMSPRIO (Sequência de Prioridade) é maior que 46."
