	...
	#define STR0028 ""
		...
		#define STR0002 "Aguarde, processando preparação dos arquivos"
		#define STR0003 "Empresa : "
		#define STR0004 "Criando campos das tabelas"
		#define STR0005 "Criando campos das tabelas SL1/SLQ"
		#define STR0006 "Log da atualizacao "
		#define STR0007 "Mono AS"
		#define STR0008 "Atualizacao concluida com sucesso"
		#define STR0009 "Atenção"
		#define STR0010 "Não foi possével a abertura da tabela de empresas de forma exclusiva !"
		#define STR0011 "Ok"
		#define STR0012 "Ocorreu um erro desconhecido durante a atualizacao da tabela : "
		#define STR0013 ". Verifique a integridade do dicionario e da tabela."
		#define STR0014 "Continuar"
		#define STR0015 " Fim da atualização de estruturas "
