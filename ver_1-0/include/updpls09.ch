	...
	#define STR0013 "Actualización concluida."
	...
	#define STR0045 "Marca/Desmarca"
		...
		#define STR0015 "Vigência para o Horário Especial do Prestador"
		...
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "Não foram seleccionadas nenhuma empresa para Actualização", "Não foram selecionadas nenhuma empresa para Atualização" )
		...
		#define STR0026 If( cPaisLoc $ "ANG|PTG", "Aguarde, a processar a preparação dos registos", "Aguarde, processando preparação dos arquivos" )
		#define STR0028 "SX3 - Dicionário de Campos"
		#define STR0029 "Vig. Inicial"
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Data de Início da Vigência", "Data de inicio da Vigência" )
		#define STR0031 "Informar a data de inicio da vigência."
		#define STR0032 "Vig. Final"
		#define STR0033 "Data Final da Vigência"
		#define STR0034 "Informar a data final da vigência."
		...
		#define STR0040 If( cPaisLoc $ "ANG|PTG", "Escolha a(s) Empresa(s) que será(ão) Actualizada(s)", "Escolha a(s) Empresa(s) que será(ão) Atualizada(s)" )
		#define STR0041 "Nao existe bancos a consultar"
		#define STR0042 If( cPaisLoc $ "ANG|PTG", "Cód Empresa", "Cod Empresa" )
		#define STR0043 If( cPaisLoc $ "ANG|PTG", "Cód Filial", "Cod Filial" )
