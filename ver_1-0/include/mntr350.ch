#ifdef SPANISH
	#define STR0001 "Desempeño de los Proveedores de Recauchutaje de Neumaticos."
	#define STR0002 "El usuario puede seleccionar los campos que deberan ser mostrados "
	#define STR0003 "e informar parametros de seleccion para la impresion."
	#define STR0004 "A Rayas"
	#define STR0005 "Administracion"
	#define STR0006 "Fornec.         Descricao"
	#define STR0007 "   Familia Descripcion                         Reformas       Prom. Km"
	...
	#define STR0016 "Proveedores"
		...
		#define STR0006 "Vendor          Descript."
		#define STR0007 "   Family  Description                         Rebuilds       Aver. Km"
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Fornec.         Descrição", "Fornec.         Descricao" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "   Família Decrição                            Reformas       Média Km", "   Familia Decricao                            Reformas       Media Km" )
