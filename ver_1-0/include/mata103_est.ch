	...
	#define STR0050 "Generar numeros de serie"
		...
		#define STR0044 If( cPaisLoc $ "ANG|PTG", , "Valor Unitário" )
		#define STR0045 If( cPaisLoc $ "ANG|PTG", , "Deseja realizar o endereçamento dos itens da nota?" )
		#define STR0046 If( cPaisLoc $ "ANG|PTG", , "Endereçar itens" )
		#define STR0047 If( cPaisLoc $ "ANG|PTG", , "Criação de Lotes na Produção" )
		#define STR0048 If( cPaisLoc $ "ANG|PTG", , "Gerar Números de Série" )
		#define STR0049 If( cPaisLoc $ "ANG|PTG", , "Gerar Números de Série" )
		#define STR0050 If( cPaisLoc $ "ANG|PTG", , "Gerar Números de Série" )
	#endif
#endif
