	...
	#define STR0010 " !"
	#define STR0011 "íIncluya por lo menos un mensaje en el idioma!"
	...
	#define STR0013 "íMensaje ya registrado!"
		...
		#define STR0010 " !"
		#define STR0011 "Insert at least one message in the language !"
		...
		#define STR0010 " !"
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "Inclua pelo menos uma mensagem no idioma !", "Inclua pelo menos uma a mensagem no idioma !" )
