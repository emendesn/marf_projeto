	...
	#define STR0080 "¡Para realizar reserva es necesario el asiento del Producto!"
		...
		#define STR0054 If( cPaisLoc $ "ANG|PTG", "Para Utilizar A Opção 'entrega' Do Campo Lr_entrega, Efectue Os Procedimentos Para Implementação Da 'emissão De Pedido De Vendas Na Venda Assistida'.", "Para utilizar a Opção 'Entrega' do campo LR_ENTREGA, efetue os procedimentos para implementação da 'Emissão de Pedido de Vendas na Venda Assistida'." )
