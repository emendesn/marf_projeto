	...
	#define STR0006 "Codigo-Td-Nombre Cliente      Prf-Numero         TP  Modalidad  Fecha de   Vencto     Vencto     Banco Valor Original|       Titulos Vencidos        |Titulos por Vencer| Num              Vlr.interes o Dias   Historial     "
	...
	#define STR0081 "Totales"
		...
		#define STR0006 "Code-Unit-Cust. Name     Prf-Number         TP  Nature   Due    Date     Due Date     Bank Original Value|       Overdue Bills        |Bills to be Due| Nr.                Inter.Vl. or  Days   History     "
		#define STR0007 "                              Installment                           Issue    Bill     Real                           |   Current Value  Restated Value|   Current Value  | Bank                permanence  Delay               "
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Código-Lj-Nome do Cliente     Prf-Número         TP  Natureza   Data de    Vencto     Vencto     Banco Valor Original|       Títulos Vencidos        |Títulos a Vencer| Num                Vlr.juros ou  Dias   Histórico     ", "Codigo-Lj-Nome do Cliente     Prf-Numero         TP  Natureza   Data de    Vencto     Vencto     Banco Valor Original|       Titulos Vencidos        |Titulos a Vencer| Num                Vlr.juros ou  Dias   Historico     " )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "                              Parcela                           Emissão    Título     Real                           |   Valor Actual  Valor Corrigido|   Valor Actual  | Banco              permanência   Atraso               ", "                              Parcela                           Emissao    Titulo     Real                           |   Valor Atual  Valor Corrigido|   Valor Atual  | Banco              permanencia   Atraso               " )
		#define STR0008 "Por Cliente"
		...
		#define STR0044 If( cPaisLoc $ "ANG|PTG", "                                                                                                                   |       títulos vencidos        |títulos a vencer|            valorjuros ou              (vencidos+vencer)", "                                                                                                                   |       Titulos Vencidos        |Titulos a Vencer|            Vlr.juros ou              (Vencidos+Vencer)" )
		#define STR0045 If( cPaisLoc $ "ANG|PTG", "                                                                                                                   | valor nominal  valor corrigido|  valor nominal |             permanência                               ", "                                                                                                                   | Valor Nominal  Valor Corrigido|  Valor Nominal |             permanencia                               " )
