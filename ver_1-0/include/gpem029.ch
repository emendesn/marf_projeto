	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", , "Integração de Rescisões" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", , "Este programa realizará a Integração das rescisões para o arquivo de    " )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", , "movimento mensal, transferindo os dados e atualizando-os                " )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", , "Confirma configuração dos parâmetros?" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", , "Fim do processo de Integração!" )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", , "Atenção!" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", , "O roteiro selecionado não é de Rescisão!" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", , "O período selecionado ja foi integrado!" )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", , 'O "Alias" informado não existe!' )
	#endif
#endif
