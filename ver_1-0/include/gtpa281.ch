	...
	#define STR0010 "¡Valor inválido! Digite solo valores numéricos."
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", , "Parâmetros do Módulo" )
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", , "Parâmetros do Módulo" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", , "Parâmetro já cadastrado!" )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", , "Valor inválido! Digite .T. ou .F. !" )
		#define STR0010 If( cPaisLoc $ "ANG|PTG", , "Valor inválido! Digite apenas valores numéricos." )
	#endif
#endif
