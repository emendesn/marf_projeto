	...
	#define STR0031 "Este campo deve ser preenchido com seis caracteres. Complete com zeros a esquerda !"
	#define STR0032 "Item não pode ser deletado, existe uma OS baixada para este produto"
#else
	#ifdef ENGLISH
		...
		#define STR0011 "SO: "
		#define STR0012 "is not open; therefor, budget will not be excluded. Contact the laboratory!!!"
