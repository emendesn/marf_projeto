#ifdef SPANISH
	#define STR0001 "Valores de la línea"
	...
	#define STR0008 "Es necesario informar el 'Órgano' para realizar la consulta de las categorías."
#else
	#ifdef ENGLISH
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", , "É necessário informar o 'Orgão' para realizar a consulta das categorias." )
	#endif
#endif
