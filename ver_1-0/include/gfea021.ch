	...
	#define STR0010 "Regiones vs. Ciudades"
	#define STR0011 "Region vs. Cp"
	...
	#define STR0028 "No es posible una region con ciudades o Cp relacionados y la opcion Otras Ciudades igual a 'Si'."
	#define STR0029 "Ciudade con la situacion Inactiva"
	#define STR0030 "Ciudad inexistente"
	#define STR0031 "No es posible una region con ciudades y Cp relacionados."
#else
	#ifdef ENGLISH
		...
		#define STR0010 "Regions x Cities"
		#define STR0011 "Region x Postal Code"
		...
		#define STR0028 "A region with related postal codes or cities and the option Other Cities equal to Yes are not possible."
		#define STR0029 "City with Inactive status"
		#define STR0030 "City does not exist"
		#define STR0031 "A region with related postal codes or cities is not possible."
	#else
		...
		#define STR0008 "Copiar"
		#define STR0009 "Imprimir"
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "Regiões X Concelhos", "Regiões X Cidades" )
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "Região X CP", "Região X Cep" )
		...
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "Não é possível uma região com concelhos ou CP relacionados e a opção Demais Concelhos igual a 'Sim'.", "Não é possível uma região com cidades ou Cep´s relacionadas e a opção Demais Cidades igual a 'Sim'." )
		...
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Não é possível uma região com concelhos e CP relacionados.", "Não é possível uma região com cidades e Cep´s relacionadas." )
	#endif
#endif
