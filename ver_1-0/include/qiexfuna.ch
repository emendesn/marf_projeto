	...
	#define STR0012 "No fue posible generar el codigo del certificado de calidad"
	...
	#define STR0041 "Falta vinculacion del Producto vs Proveedor registrado por la rutina Mata060 "
#else
	#ifdef ENGLISH
		...
		#define STR0012 "Unable to generate Quality Certificate Code"
		...
		#define STR0041 "There is no binding of Product x Supplier registered by routine Mata060"
	#else
		...
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "Não foi possível criar o código do Certificado De Qualidade.", "Nao foi possivel gerar o Codigo do Certificado de Qualidade" )
		...
		#define STR0041 If( cPaisLoc $ "ANG|PTG", "Falta amarração do Artigo X Fornecedor registado pelo procedimento Mata060", "Falta amarracao do Produto X Fornecedor cadastrado pela rotina Mata060" )
	#endif
#endif
