	...
	#define STR0052 ""	
		...
		#define STR0034 "OS Vencida"   
		#define STR0035 "Saida Loja"
		#define STR0036 "Atualizar"
		#define STR0037 "Conf. Loja"
		#define STR0038 "Cancela Loja"
		#define STR0039 "Lab Concluido"
		#define STR0040 "Cancelar Lab"
		#define STR0041 "Esta ação não pode ser executada. O orçamento referente esta OS está vencido"
		#define STR0042 "Lente/Bloco ja saiu do laboratorio!"
		#define STR0043 "Lente/Bloco nao foi baixado pelo estoque de lentes!"
		#define STR0044 "Esta ação não pode ser executada pois já foi realzado a baixa na loja."
		#define STR0045 "Lente/Bloco ainda nao saiu do laboratorio!"
		#define STR0046 "Esta ação não pode ser executada pois não foi dado baixa no laboratório."
		#define STR0047 "Lente/Bloco ja saiu da loja!"
		#define STR0048 "Lente/Bloco ainda nao saiu da loja!"
		#define STR0049 "OS Entregue"
		#define STR0050 "OS Entregue na Loja"
		#define STR0051 "Esta Rotina só pode ser utilizada na Retaguarda!" 
  		#define STR0052 "Venda ainda não confirmada no PDV!"
	#endif                                                       
#endif
