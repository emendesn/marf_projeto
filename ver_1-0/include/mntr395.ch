	...
	#define STR0015 "Tipos de Infracciones de Transito                               Cant.      Valor Infraccion    Valor Infraccion     %        %Ac."
	...
	#define STR0031 "El Ano informado debera escribirse con los 4 digitos!"
		...
		#define STR0014 "Wait"
		#define STR0015 "Types of Traffic Violation                                  Amt.      Violation Value     Violation Value      %        %Ac."
		#define STR0016 "Total"
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Tipos de Infracções de Trânsito                                  Qtde.      Valor Infracção      Valor Infracção       %        %Ac.", "Tipos de Infrações de Trânsito                                  Qtde.      Valor Infração      Valor Infração       %        %Ac." )
		#define STR0016 "Total"
