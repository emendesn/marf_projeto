	...
	#define STR0034 "Sucursal: "
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Código SRF Inicial", "Codigo SRF Inicial" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Código SRF Final", "Codigo SRF Final" )
		#define STR0009 "Agrupa por"
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "Período de Apuro", "Período de Apuração" )
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "Número de referência", "Numero de referencia" )
