#ifdef SPANISH
	#define STR0001 "Importacion de sujetos borrados de ganancias acumuladas"
	#define STR0002 "Atencion"
	#define STR0003 "Complete correctamente la informacion solicitada."
	#define STR0004 "Esta rutina importara el archivo de devolucion de Sujetos borrados de ganancias acumuladas"
	#define STR0005 ", con informacion sobre proveedores   "
	#define STR0006 "generadas en el periodo."
	#define STR0007 "Asistente de parametrizacion"
	#define STR0008 "Informacion sobre el archivo de devolucion: "
	#define STR0009 "Archivo de devolucion: "
	...
	#define STR0018 "Implementacion no realizada"
	#define STR0019 "La implementacion del proceso de actualizacion"
	#define STR0020 "La importacion no se realizo correctamente."
	...
	#define STR0025 "La importacion del archivo de devolucion no se realizo "
	#define STR0026 "porque no existe informacion de devolucion en el archivo "
	#define STR0027 "texto informado. "
	#define STR0028 "Verifique si el archivo de devolucion informado en las "
	#define STR0029 "preguntas de la rutina es el enviado por la rutina sujetos borrados de ganancias acumuladas "
	...
	#define STR0036 "Fecha de cierre"
	#define STR0037 "Impresion de la lista de verificacion"
	...
	#define STR0046 "CGC Proveedor     Periodo Solicitado     Cod. Eletronico Reproweb     Situacion     Fecha cierre     Mensaje de Error"
	#define STR0047 "Este programa presentara una lista con el resultado de la importacion de la devolucion"
#else
	#ifdef ENGLISH
		#define STR0001 "Subject import deleted from accrued profits"
		#define STR0002 "Attention"
		#define STR0003 "Fill out properly with the required information."
		#define STR0004 "This routine imports return file of Subjects deleted from accrued profits"
		...
		#define STR0021 "check the documentation following the routine and "
		...
		#define STR0026 "as there is no file return information "
		#define STR0027 "in the indicated text. "
		#define STR0028 "Check whether return file indicated in the "
		#define STR0029 "questions of the routine is sent by the routine accrued profits deleted subjects "
		#define STR0030 "and run the routine again."
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Importação de Sujeitos eliminados de lucros acumulados", "Importação de Sujeitos excluidos de lucros acumulados" )
		...
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "Este procedimento importará o ficheiro de retorno de Sujeitos eliminados de lucros acumulados", "Esta rotina ira importar o arquivo de retorno de Sujeitos excluidos de lucros acumulados" )
		...
		#define STR0023 If( cPaisLoc $ "ANG|PTG", "este prodimento novamente.", "esta rotina novamente." )
		...
		#define STR0029 If( cPaisLoc $ "ANG|PTG", "perguntas do procedimento é o enviado pelo procedimento sujeitos eliminados de lucros acumulados ", "perguntas da rotina é o enviado pela rotina sujeitos excluidos de lucros acumulados " )
		...
		#define STR0032 If( cPaisLoc $ "ANG|PTG", "No. Contrib. Fornecedor", "CGC Fornecedor" )
