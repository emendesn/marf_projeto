	...
	#define STR0031 "¡Imposible continuar! Existe(n) Fact(s) generada(s) referente(s) a comision(es)de bonos."
	...
	#define STR0033 "¡Imposible continuar! El vendedor informado no alcanzo el limite minimo de abordajes en el CEV."
		...
		#define STR0031 "Cannot continue! Invoice(s) issued regarding Bonus commission(s)."
		...
		#define STR0031 "Impossível continuar! Existe(m) NF(s) gerada(s) referente(s) a comissão(ões) de Bonus."
		#define STR0032 "Cliente bloqueado!"
