	...
	#define STR0006 "No puede borrarse hasta que las referencias a ella se eliminen."
	...
	#define STR0016 "¿Demostrar el Log Sinteticamente ?"
		...
		#define STR0006 "Till the references are removed, the same cannot be deleted."
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Até que as referências a ela sejam eliminadas a mesmo não pode ser eliminada.", "At‚ que as referˆncias a ela sejam eliminadas a mesmo n„o pode ser excluida." )
