	...
	#define STR0048 "Actualizada la estructura del archivo: "
		...
		#define STR0005 "A rotina de atualização irá criar os campos necessários para a utilização do novo tratamento que irá substituir o arquivo Batch ao gerar as OPs."
		...
		#define STR0008 "Este update tem como objetivo criar os campos C2_BATCH, C2_BATUSR, C2_BATROT, C2_BATORCA."
