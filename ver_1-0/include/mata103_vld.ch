	...
	#define STR0018 "Clave: "
		...
		#define STR0018 "Key: "
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", , "Este documento pertence à um Edital e nao poderá ocorrer alteração na Quantidade e/ou Valor." )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", , "ATENCAO" )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", , " só poderá ser alterado através da pré-nota de entrada, pois a Nota Fiscal já foi liberada do bloqueio de tolerância de recebimento." )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", , "O campo de " )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", , "preço unitário" )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", , "Vinculado ao Pedido de Venda: " )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", , "Verifique o Item NF: " )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", , "Pedido de Compra não pode ser vinculado a Nota de Compra, pois possui amarração com o Pedido de Vendas gerado pelo processo de Central de Compras de Distribuição que ainda não foi faturado !" )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", , "Verifique o Item NF: " )
		#define STR0010 If( cPaisLoc $ "ANG|PTG", , "É necessário vincular o Documento de Entrada a um Pedido de Compras Centralizado !" )
		#define STR0011 If( cPaisLoc $ "ANG|PTG", , "Atenção: Para que seja possível baixar o Pedido Centralizado, é necessário que o parâmetro MV_VPCCNFE esteja configurado com valor diferente de ZERO. Verifique o seu conteúdo !" )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", , "Saldo no Pedido Centralizado: " )
		#define STR0013 If( cPaisLoc $ "ANG|PTG", , "Não existe saldo disponível no Pedido de Compras Centralizado !" )
		#define STR0014 If( cPaisLoc $ "ANG|PTG", , "Produto não localizado em nenhum Pedido de Compras Centralizado !" )
		#define STR0015 If( cPaisLoc $ "ANG|PTG", , "Atenção: O parâmetro MV_VPCCNFE está ativado. Verifique se os campos: D1_PCCENTR e D1_ITPCCEN estão marcados como USADO no Configurador." )
		#define STR0016 If( cPaisLoc $ "ANG|PTG", , "Nota Fiscal não pode ser Excluida, pois possui vinculo com outro Processo !" )
