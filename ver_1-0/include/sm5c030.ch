	...
	#define STR0046 "Debido al tamano del informe seran permitidas hasta 7 formas. Ajuste los parametros del informe."
	#define STR0050 "S U B T O T A L ---- > Ventas - Caja: "
#else
	#ifdef ENGLISH
		...
		#define STR0046 "Due to the report size only 7 forms are allowed. Adjust the report parameters.             "
		#define STR0049 "S U B T O T A L     ---- > Sales - C.Reg: "
	#else
		...
		#define STR0003 "Mapa de Vendas"
		#define STR0004 "Zebrado"
		#define STR0005 "Administracao"
		#define STR0006 "Aguarde"
		#define STR0007 "Selecionando registros para impressão..."
		#define STR0008 "Selecione corretamente as formas de pagamento para serem impressas no relatório."
		#define STR0009 "Atenção"
		#define STR0010 "CX. "
		#define STR0011 "Data     "
		#define STR0012 "N.Fisc."
		#define STR0013 "Ser."
		#define STR0014 "Vend.  "
		#define STR0015 "Nome Vend       "
		#define STR0016 "Clien. "
		#define STR0017 "Nome Cliente        "
		#define STR0018 "Desc."
		#define STR0019 "Acr."
		#define STR0020 "Credito"
		#define STR0021 "Total"
		...
		#define STR0031 "Imprimindo, aguarde..."
		#define STR0032 "*************** DEVOLUCOES ***************"
		#define STR0033 "S U B  -  T O T A L ---- > Caixa: "
		#define STR0034 "S U B  -  T O T A L ---- > Data: "
		#define STR0035 "S U B  -  T O T A L ---- > Filial: "
		#define STR0036 "T O T A L     G E R A L ---- > "
		#define STR0037 "Imps.Discr."
		#define STR0038 "Retencöes"
		#define STR0039 "T R O C O           ---- > Caixa: "
		#define STR0040 "T R O C O           ---- > Data: "
		#define STR0041 "T R O C O           ---- > Filial: "
		#define STR0042 "Sangria: "
		#define STR0043 "Entrada de Troco: "
		#define STR0044 "Foram escolhidas "
		#define STR0045 " formas de pagamento."
		#define STR0046 "Devido ao tamanho do relatório são permitidas até 7 formas. Ajuste os parâmetros do relatório."
		#define STR0047 "Usuario"
		#define STR0048 "sem permissão para exibir o Mapa de Vendas."
		#define STR0049 "S U B  -  T O T A L ---- > Vendas - Caixa: "
	#endif
#endif
