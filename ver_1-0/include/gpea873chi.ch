	...
	#define STR0029 "Impuesto Unico Ret"
	#define STR0030 "Mayor Ret. Solic"
	#define STR0031 "Renta Tot. Exenta"
	...
	#define STR0034 "Ya existe registro con esta información"
		...
		#define STR0029 "Withh. Unique Tax"
		#define STR0030 "Greater Withh. Req"
		#define STR0031 "Total Income Exempt"
		...
		#define STR0029 If( cPaisLoc $ "ANG|PTG", "Impuesto Unico Ret", "Imposto Único Ret." )
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Mayor Ret. Solic", "Maior Ret. Solic" )
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Renta Tot. Exenta", "Renda Tot. Isenta" )
