	...
	#define STR0027 "La fecha de Resultado no puede ser menor a la Fecha de Programacion"
#else
	#ifdef ENGLISH
		...
		#define STR0027 "Result Date cannot be earlier than Schedule Date."
	#else
		...
		#define STR0027 "Data do Resultado não pode ser menor que a Data da Programação."
	#endif
#endif
