	...
	#define STR0024 "Este Bien fue TRANSFERIDO."
		...
		#define STR0015 "last follow-up of asset"
		#define STR0016 "Break date for counter 2 is lower than date"
		#define STR0017 "No record found with reading date equal"
		#define STR0018 "to date of last follow-up of counter 1"
		#define STR0019 "Break time lower than or equal to last history entry"
		#define STR0020 "for counter 1"
		#define STR0021 "to date of last follow-up of counter 2"
		#define STR0022 "for counter 2"
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "De último acompanhamento do bem", "de ultimo acompanhamento do bem" )
		...
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "à data de último acompanhamento do contabilista 1", "a data de ultimo acompanhamento do contador 1" )
		...
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "Do contador 1", "do contador 1" )
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "A data de último acompanhamento do contador 2", "a data de ultimo acompanhamento do contador 2" )
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "Do contador 2", "do contador 2" )
