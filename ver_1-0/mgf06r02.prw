...
//ฑฑบPrograma  ณ MGF06R02	บAutor  ณGeronimo Benedito Alves																	บData ณ08/12/17	บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: Financeiro - Contas a Receber - Clientes por Condi็ใo de Pagamento (M๓dulo 06-FIN)บฑฑ
...
User Function MGF06R02()
	...
	Aadd(_aDefinePl, "CONTA A RECEBER - Clientes por Condi็ใo de Pagamento" )	//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	Aadd(_aDefinePl, "Clientes por Condi็ใo Pagamento"						)	//02-  _cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Clientes por Condi็ใo Pagamento"}					)	//03-  _cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Clientes por Condi็ใo Pagamento"}					)	//04-  _cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, {"A1_LOJA"		,"COD_LOJA"										,"C๓d. da Loja"					,"C",002	,0	,""						,""	,""	 })
	...
	Aadd(_aCampoQry, {"NOM_ESTADO"	    	,"NOM_ESTADO"	  , "Estado"				,"C",20	,0	,"@!"					,""	,"@!"	 })
 	Aadd(_aCampoQry, {"AOV_CODSEG"	,"COD_SEGMENTO				as CODSEGMENT"	,"C๓d. do Segmento"				,"C",006	,0	,""						,""	,""	 })
	Aadd(_aCampoQry, {"AOV_DESSEG"	,"DESC_SEGMENTO				as DESCSEGMEN"	,"Descri็ใo do Segmento"			,"C",040	,0	,""						,""	,""	 }) 
	Aadd(_aCampoQry, {"E4_CODIGO"	,"COD_COND_PGTO				as CODCONDPGT"	,"Condi็ใo de Pagamento"			,"C",003	,0	,""						,""	,""	 })
	Aadd(_aCampoQry, {"E4_DESCRI"	,"DESC_COND_PGTO				as DESCCONDPG"	,"Descri็ใo Condi็ใo de Pagto"	,"C",015	,0	,""						,""	,""	 })
	//Aadd(_aCampoQry, {"ZQ_COD"	,"COD_REDE"										,"C๓d. Rede"						,"C",003	,0	,""						,""	,""	 })
	Aadd(_aCampoQry, {"ZQ_DESCR"	,"DESC_REDE"										,"Descri็ใo Rede"			,"C",040	,0	,""						,""	,""	 })
	Aadd(_aCampoQry, {"EXPOSICAO"	,"EXPOSICAO"										,"Exposi็ใo"				,"N",13	,2	,""						,""	,""	 })
	...
	Aadd(_aCampoQry, {"YA_DESCR"	,"NOM_PAIS						as NOMEDOPAIS"	,"Nome do Paํs"					,"C",020	,0	,""						,""	,""	 })
	...
	Aadd(_aCampoQry, {"A1_ZREDE"	, "A1_COD_REDE          		as CODREDECLI" ,"C๓digo de rede" 		, "C" , tamSx3("A1_ZREDE")[1] 	,0	,""						,""	,""	 })
	Aadd(_aCampoQry, {"A1_ZBOLETO"	, "GERA_BOLETO					as GERABOLETO" ,"Gera Boleto" 			, "C" , 003 					,0	,""						,""	,""	 })
	Aadd(_aCampoQry, {"A1_XPENFIN"	, "PENDENCIA_FINANCEIRA			as PEDNFINANC" ,"Pend๊ncia Financeira" 	, "C" , 003 					,0	,""						,""	,""	 })
	Aadd(_aCampoQry, {"A1_ZINATIV"	, "INATIVIDADE_COMPRA			as INITCOMPRA" ,"Inatividade de Compra" , "C" , 003 					,0	,""						,""	,""	 })
	Aadd(_aCampoQry, {"A1_XMAILCO"	, "EMAIL_COBRANCA				as EMAILCOBRA" ,"E-mail Cobran็a" 		, "C" , tamSx3("A1_XMAILCO")[1] ,0	,""						,""	,""	 })
	...
	Aadd(_aCampoQry, {"A1_ZALTCRED" , "OBSERV" 									   ,"Observa็ใo" 			, "C" , tamSx3("A1_ZALTCRED")[1] ,0	,""						,""	,""	 })	
	...
	aAdd(_aParambox,{1,"Cod. Municํpio"					,Space(tamSx3("CC2_CODMUN")[1])	,"@!", 														,"CC2"	,,050,.F.})  	//03
	aAdd(_aParambox,{3,"Status Clientes" 				,iif(Set(_SET_DELETED),1,2)		, {'Ativo','Inativo','Ambos'}								,100,"",.T.})			//04
	aAdd(_aParambox,{3,"Grandes Redes" 					,iif(Set(_SET_DELETED),1,2)		, {'Sim','Nใo','Todos'}										,100,"",.T.})			//05
	aAdd(_aParambox,{1,"Data Ult. Compra De"			,Ctod("")						,""		,""													,""		,""	,050,.F.})	//06
	aAdd(_aParambox,{1,"Data Ult. Compra At้"			,Ctod("")						,""		,"U_VLFIMMAI(MV_PAR06, MV_PAR07, 'Data Ult Comp')"	,""		,""	,050,.F.})	//07
	aAdd(_aParambox,{1,"Data Venc. Limite Cr้dito De"	,Ctod("")						,""		,""													,""		,""	,050,.F.})	//08
	aAdd(_aParambox,{1,"Data Venc. Limite Cr้dito At้"	,Ctod("")						,""		,"U_VLFIMMAI(MV_PAR08, MV_PAR09, 'Data Venc Cred')"	,""		,""	,050,.F.})	//09
	

	If ! U_ParameRe(_aParambox, _bParameRe, @_aRet) ; Return ; Endif
	
	//===		C O N D I ว ร O 		D E 	P A G A M E N T O  -- Bruno Tamanaka - Filtros 04/06/2019
	...
	cTitCondPg	:= "Condi็ใo de Pagamento: "
