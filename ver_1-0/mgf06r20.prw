...
//ฑฑบPrograma  ณ MGF06R20	บAutor  ณ Geronimo Benedito Alves																	บData ณ 05/07/17   บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: Financeiro - Contas เ Pagar - Seguro                            (M๓dulo 06-FIN)  บฑฑ
...
User Function MGF06R20()
	...
	Aadd(_aDefinePl, "Contas แ Pagar - Seguro"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {"XXM0FILIAL"	,"DESC_EMPRESA"			,"Descri็ใo da Empresa"	,"C",040	,0	,"" 		,"" 	,"" })
	Aadd(_aCampoQry, {"E2_NUM"		,"NUM_TITULO"			,"Nบ Titulo"			,"C",009	,0	,"" 		,"" 	,"" })
	...
	Aadd(_aCampoQry, {"ED_DESCRIC"	,"DESCR_NATUREZA"		,"Descri็ใo Natureza"	,"C",040	,0	,"" 		,"" 	,"" })
	Aadd(_aCampoQry, {"E2_VALOR"	,"VALOR_NF"				,"Valor NF"				,"N",016	,2	,"" 		,"" 	,"" })
	Aadd(_aCampoQry, {"E2_VALOR"	,"VALOR_LIQUIDO_PAGAR"	,"Valor เ Pagar"		,"N",016	,2	,"" 		,"" 	,"" })
	Aadd(_aCampoQry, {"E2_VALLIQ"	,"VALOR_PAGO"			,"Valor Pago"			,"N",016	,2	,"" 		,"" 	,"" })
	Aadd(_aCampoQry, {"E2_DESCONT"	,"DESCONTO"				,"Desconto"				,"N",016	,2	,"" 		,"" 	,"" })
	Aadd(_aCampoQry, {"E2_EMISSAO"	,"DT_EMISSAO"			,"DT Emissใo"			,"D",008	,0	,"" 		,"" 	,"" })
	...
	cQryProdut	:= "SELECT ' ' as B1_COD, 'NรO INFORMADO' as B1_DESC FROM DUAL UNION ALL "
	...
	cTitProdut	:= " Marque os Produtos เ listar."		// No relat๓rio, sempre serใo listados, ao menos os produtos: 817979, 758711 e 855659"
	...
	_cQuery += U_WhereAnd( !empty(_aRet[7]),       " CNPJ_FORNECEDOR_FILTRO LIKE '%" + _aRet[7]    + "%' "                       ) //NรO OBRIGATORIO - USUARIO DIGITA O NOME		
