...
Data.....:              19/04/2017
Descricao / Objetivo:   Cadastro de Usu·rios RAMI
Doc. Origem:            GAP CRM
Solicitante:            Cliente
Uso......:              Marfrig
Obs......:              
...
user function MGFCRM37()
	...
	oBrowse:SetDescription('Cadastro de Usu·rios RAMI')      
	//Ativa o Browse
	oBrowse:Activate()
...
Static Function ModelDef()
	...
	oModel:SetDescription( 'Cadastro de Usu·rios RAMI' )

	// Adiciona a descricao do Componente do Modelo de Dados
	oModel:GetModel( 'ZBKMASTER' ):SetDescription( 'Dados de Usu·rios RAMI' )
...
static function CRM37POS( oModel )
	...
	if nOper == MODEL_OPERATION_INSERT
		...
		if !QRYZBK->(EOF())
			Help( ,, 'Usu·rio j· cadastrado',, 'Este Usu·rio j· est· cadastrado.', 1, 0 )
			lRet := .F.
		endif
