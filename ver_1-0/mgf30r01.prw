...
//ฑฑษออออออออออัออออออออออออหอออออออัอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออหออออออัอออออออออออปฑฑ
//ฑฑบPrograma  ณ MGF30R01	บAutor  ณ Geronimo Benedito Alves                                                                   บ Data ณ 13/06/18  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสออออออฯอออออออออออนฑฑ
//ฑฑบDesc.     ณ Rotina que mostra na tela os dados da planilha:                                                                                   บฑฑ
//ฑฑบ          ณ EFF-Easy Financing - 30 -Financiamento - Ordens de Pagamento com Saldo – Resumo                                                   บฑฑ
...
User Function MGF30R01()
	...
	Aadd(_aDefinePl, "Financiamento - Resumo-Ordens de Pagamento com Saldo"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {"XXEEQEVE01"	,"TIPO_CREDITO			as TIPCREDITO"	,"Tipo Cr้dito"	,"C",020	,0, ""							,""	,""	 })
	...
	aAdd(_aParambox,{1,"C๓digo Empresa Inicial",Space(tamSx3("A2_COD")[1])	,"@!"	,""													,"SAA2"	,"",050,.F.}) 
	aAdd(_aParambox,{1,"Loja   Empresa Inicial",Space(tamSx3("A2_LOJA")[1])	,"@!"	,""													,""		,"",050,.F.}) 
	aAdd(_aParambox,{1,"C๓digo Empresa Final"	,Space(tamSx3("A2_COD")[1])	,"@!"	,"U_VLFIMMAI(MV_PAR01, MV_PAR03, 'C๓digo Empresa')"	,"SAA2"	,"",050,.F.}) 
	...
	cQryMoeda	:= "SELECT ' ' as YF_MOEDA, 'Nใo Informado' as YF_DESC_SI FROM DUAL UNION ALL " +CRLF
	...
	aCpoMoeda	:=	{	{ "YF_MOEDA"	,"Moeda"		,TamSx3("YF_MOEDA")[1] + 80	}	,;
						{ "YF_DESC_SI"	,"Descri็ใo"	,TamSx3("YF_DESC_SI")[1] 		}	 } 
