...
//ฑฑบPrograma  ณ MGF05R10	บAutor  ณ Eduardo Augusto Donato																	บData ณ  24/04/18  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: FATURAMENTO - Controle de Pallets					(M๓dulo 05-FAT)			บฑฑ
...
User Function MGF05R10()
	...
	Aadd(_aDefinePl, "Faturamento - Controle de Pallets"	)	//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {"C5_FILIAL"	,"COD_FILIAL"					,"C๓d. Empresa"					,"C",006	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"A1_NOME"		,"DESC_FILIAL"					,"Descri็ใo Empresa"			,"C",030	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"D1_DOC"		,"NOTA_FISCAL"					,"Nบ Nota Fiscal"				,"C",010	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"D1_SERIE"	,"SERIE"						,"Serie NF"						,"C",005	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"D1_EMISSAO"	,"DATA_EMISSAO"					,"Data Emissao"					,"D",008	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"D1_DTDIGIT"	,"DATA_DIGITACAO"				,"Data Digita็ใo"				,"D",008	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"D1_COD"		,"COD_PRODUTO"					,"C๓d. Produto"					,"C",020	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"B1_DESC"		,"DESC_PRODUTO"					,"Descr. Produto"				,"C",040	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"F1_COND"		,"CONDICAO_PGTO"				,"C๓d. Condi็ใo"				,"C",006	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"E4_DESCRI"	,"DESCRICAO_COND_PGTO"			,"Descr. Condi็ใo"				,"C",030	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"F1_FORNECE"	,"COD_FORNECEDOR_CLIENTE"		,"C๓d. Cliente Fornecedor"		,"C",008	,0	,""						,"" 	,"" })
	...
	Aadd(_aCampoQry, {"D1_TOTAL"	,"PRECO_UNIT_MEDIO"				,"Pre็o Unitแrio M้dio"			,"N",015	,2	,"@E 999,999,999,999.99","" 	,"" })
	...
	Aadd(_aCampoQry, {"X5_DESCRI"	,"DESC_CFOP"					,"Descri็ใo CFOP"				,"C",020	,0	,""						,"" 	,"" })

	/*WHERE COD_FILIAL IN ('02001','','') --OBRIGATORIO, SELEวรO FILIAL
    AND DATA_FILTRO BETWEEN '20181201' AND '20181231' --OBRIGATORIO - TRAVA 45 DIAS
    AND COD_PRODUTO BETWEEN '01' AND '10' --NรO OBRIGATORIO DE/ATE
	AND COD_FORNECEDOR_CLIENTE --COMBO DE SELECAO CONFORME PADRAO -- PRECISARIA DE DOIS COMBOS, UM DE FORNECEDOR E UM DE CLIENTE NรO SENDO OBRIGATORIO
	AND LOJA -- COMBO DE SELECAO CONFORME PADRรO -- PRECISARIA DE DOIS COMBOS, UM DE FORNECEDOR E UM DE CLIENTE NรO SENDO OBRIGATORIO
	AND TIPO_MOVIMENTO -- NรO OBRIGATORIO / SELEวรO (ENTRADA OU SAIDA) A NรO SELEวรO MOSTRAR TODOS
	*/


	aAdd(_aParambox,{1,"Data Digita็ใo Inicial"	,Ctod("")						,""		,""													,""		,""	,050,.T.})
	aAdd(_aParambox,{1,"Data Digita็ใo Final"	,Ctod("")						,""		,"U_VLFIMMAI(MV_PAR01, MV_PAR02, 'Data Entrega')"	,""		,""	,050,.T.})
	...
	If _aRet[1] > _aRet[2]
		MsgStop("A Data de Digita็ใo Inicial, nใo pode ser maior que a data de Digita็ใo Final.")
		Return.F.
	Endif
	...
	cQryCliente	:= "SELECT ' ' as A1_COD_LOJ, 'NรO INFORMADO' as A1_NOME, ' ' AS A1_CGC  FROM DUAL UNION ALL "
	...
	aCpoClient	:=	{	{ "A1_COD_LOJ"	,"c๓digo-loja"			,TamSx3("A1_COD")[1] + TamSx3("A1_LOJA")[1] +20		} ,;
	aCpoClient	:=		{ "A1_NOME"		,"Nome do Cliente"		,TamSx3("A1_NOME")[1]  +50  }	 ,; 
	aCpoClient	:=		{ "A1_CGC"		,U_X3Titulo("A1_CGC")	,TamSx3("A1_CGC")[1]  }	} 
	cTitClient	:= " Marque os Clientes เ listar."
	nPosRetorn	:= 1		// Quero que seja retornado o primeiro campo: A6_COD
	//.T. no envio do parametro _lCancProg, indica que devo abandonar programa, se for clicado o botใo cancelar da MarkGene.
	//.T. no _lCancProg, ap๓s a Markgene, indica que realmente foi teclado o botใo cancelar e que devo abandonar o programa. 
	//.F. no _lCancProg, ap๓s a Markgene, indica que realmente nใo foi teclado o botใo cancelar ou que mesmo ele teclado, nใo devo abandonar o programa (mas apenas "limpar/desconsiderar" a marca็ใo dos registro) 
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),     " DATA_FILTRO BETWEEN '"  + _aRet[1]  + "' AND '" + _aRet[2] + "'  "	)	// OBRIGATORIO, COM A VALIDAวรO DE 35 DIAS
	_cQuery += U_WhereAnd( !empty(_aRet[4] ),     " COD_PRODUTO BETWEEN '"          + _aRet[3]  + "' AND '" + _aRet[4] + "'  "	)	// NรO OBRIGATORIO
	
	If _aRet[5] <> 1	// 1=Todos
		_cQuery += U_WhereAnd( !empty(_cTpMovimento ),    " TIPO_MOVIMENTO = '"          		+ _cTpMovimento + "' "	                )	// NรO OBRIGATORIO
	Endif
	_cCliFor := ""
