...
Data.....: 04/12/2018
Descricao: Chamado pelo ponto de entrada DPCTB102GR pgravacaoa��o da SCR e DBM do lancamento contabil.
======================================================================================================
*/
user function MGFCTB25(nxOpc)
	...
	//Nao deve ser gerada grade quando o Execauto � acionado pela rotina de aprovacao.
	...
	If CT2->CT2_TPSALD == "2"
		//(nxOpc = 4 .AND. Empty(CT2->CT2_ORIGEM));  // Saldo Or�ado ou Alteracao ; 18/09/2019: Alteracao de lancamento nao deve ir para a grade.
...
Verifica o lancamento ira para a grade ou � uma excecao.
