...
//ฑฑบPrograma  ณ MGF05R08	บAutor  ณ Geronimo Benedito Alves																	บData ณ  10/08/18  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: FATURAMENTO - Devolu็ใo NF Entrada   (M๓dulo 05-FAT)                             บฑฑ
...
User Function MGF05R08()
	...
	Aadd(_aDefinePl, "Faturamento - Devolu็ใo NF Entrada"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	Aadd(_aDefinePl, "Devolu็ใo NF Entrada"					)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Devolu็ใo NF Entrada"}				)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Devolu็ใo NF Entrada"}				)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, {"D1_ZRAMI"	,"N_RAMI"				,"Nบ Rami"						,""		,""	,""	,""		,""		,""	})
	...
	Aadd(_aCampoQry, {"D1_COD"		,"COD_SKU"				,"C๓digo SKU"					,""		,""	,""	,""		,""		,""	})
	...
	Aadd(_aCampoQry, {"D1_SERIE"	,"SERIE_NF_ORIGEM"		,"S้rie NF Origem"				,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"D2_PEDIDO"	,"N_PEDIDO_ORIGEM"		,"Pedido Origem"				,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"D1_ITEMORI"	,"SKU_ORIGEM"			,"Item Origem"					,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"C5_VEND1"	,"COD_VENDEDOR"			,"C๓d. Vendedor"				,""		,""	,""	,""		,""		,""	})
	...
	Aadd(_aCampoQry, {"ZBG_REPRES"	,"COD_GERENTE"			,"C๓d. Gerente"					,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"A3_NOME"		,"NM_GERENTE"			,"Nome Gerente"					,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"DAK_TRANSP"	,"COD_TRASPORTADOR"		,"C๓d Transportador"			,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"A4_NOME"		,"NM_TRANSPORTADOR"		,"Nome Transportador"			,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"XXDAKSEQCA"	,"N_OE"					,"Nบ OE"						,"C"	,10	,0	,""		,""		,""	})
	Aadd(_aCampoQry, {"DA3_PLACA"	,"N_PLACA"				,"Placa"						,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"ZP_CODREG"	,"COD_REGIAO"			,"C๓d Regiใo"					,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"ZP_DESCREG"	,"NM_REGIAO"			,"Nome Regiใo"					,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"ZAW_MOTAFE"	,"MOTIVO_AFERIDO"		,"Motivo Aferido"				,""		,""	,""	,""		,""		,""	})
	Aadd(_aCampoQry, {"ZAW_RESPAF"	,"RESPONSAVEL_AFERICAO"	,"Responsแvel pela Aferi็ใo"	,""		,""	,""	,""		,""		,""	})
	...
	aAdd(_aParambox,{1,"Data Emissใo Final"		,Ctod("")						,""		,"U_VLFIMMAI(MV_PAR05, MV_PAR06, 'Data Emissใo')"	,""		,,050,.F.})
	aAdd(_aParambox,{1,"Data Digita็ใo Inicial"	,Ctod("")						,""		,""													,""		,,050,.F.})
	aAdd(_aParambox,{1,"Data Digita็ใo Final"	,Ctod("")						,""		,"U_VLFIMMAI(MV_PAR07, MV_PAR08, 'Data Digita็ใo')"	,""		,,050,.F.})
...
//WHERE D_E_L_E_T_ <> '*'
	...
	cQryMotivo	:= "SELECT          ' Nใo Informado' as CODIGO, '" +SPACE(TamSx3("ZAS_DESCRI")[1])+ "' as ZAS_DESCRI FROM DUAL UNION ALL "	// Coloco um espa็o no come็o de " Nใo Informado" para este registro aparecer na 1ช linha do Browse 
