...
Data................: 28/05/2019
Descrição / Objetivo: Relatório Compras - Planejamento e Consumo. 
Doc. Origem.........: 
Solicitante.........: Priscilla Sombini
Uso.................: Marfrig
Obs.................: Relatório Planejamento e Consumo.
=====================================================================================
*/
...
User Function MGF02R06()
	...
	Aadd(_aDefinePl, "Relatório Planejamento e Consumo"			)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerá na regua de processamento.
	...
	Aadd(_aCampoQry, { "COD_PRODUTO"			,"COD_PRODUTO"				,"Código do Produto"		,"C",015,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "DESC_PRODUTO"			,"DESC_PRODUTO"				,"Descrição do Produto"		,"C",076,0	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "CUSTO_MEDIO"			,"CUSTO_MEDIO"				,"Custo Médio"				,"N",017,4	,"@E 999,999,999,999.9999"	,""	,""	})
	Aadd(_aCampoQry, { "CONSUMO_ULT_3_MESES"	,"CONSUMO_ULT_3_MESES"		,"Consumo Ult. 3 Meses"		,"N",017,4	,"@E 999,999,999,999.9999"	,""	,""	})
	Aadd(_aCampoQry, { "CONSUMO_MES_ATUAL"		,"CONSUMO_MES_ATUAL"		,"Consumo Mês Atual"		,"N",017,4	,"@E 999,999,999,999.9999"	,""	,""	})
	Aadd(_aCampoQry, { "SUGESTAO_COMPRA"		,"SUGESTAO_COMPRA"			,"Sugestão Compra"			,"N",017,4	,"@E 999,999,999,999.9999"	,""	,""	})																																													  
	
																																							
	aAdd(_aParambox,{1,"Produto De "			,Space(tamSx3("B1_COD")[1])		,""		,""													,"SB1"	,,050,.F.}) //01
	aAdd(_aParambox,{1,"Produto Até "			,Space(tamSx3("B1_COD")[1])		,""		,"U_VLFIMMAI(MV_PAR01, MV_PAR02, 'Produto')"		,"SB1"	,,050,.F.}) //02
	aAdd(_aParambox,{1,"Tipo do Produto De "	,Space(tamSx3("B1_TIPO")[1])	,""		,""													,""		,,050,.F.}) //03
	aAdd(_aParambox,{1,"Tipo do Produto Até "	,Space(tamSx3("B1_TIPO")[1])	,""		,"U_VLFIMMAI(MV_PAR03, MV_PAR04, 'Tipo Produto')"	,""		,,050,.F.}) //04
	aAdd(_aParambox,{1,"Grupo do Produto De "	,Space(tamSx3("BM_GRUPO")[1])	,""		,""													,""		,,050,.F.}) //05
	aAdd(_aParambox,{1,"Grupo do Produto Até "	,Space(tamSx3("BM_GRUPO")[1])	,""		,"U_VLFIMMAI(MV_PAR05, MV_PAR06, 'Grp. Produto')"	,""		,,050,.F.}) //06
