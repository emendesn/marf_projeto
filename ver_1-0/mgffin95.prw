...
User Function xMGFI95A()
	...
	If xValAlt()
		...
		EndIf
	Else
		Help(" ",1,'ERROALTER',,'Todos os Titulos desse processo j� estao Baixados',1,0)
	EndIf
	...
	if oModel:GetOperation() <> MODEL_OPERATION_DELETE
		...
		For ni := 1  to oMdlDeta:Length()
			For nx := 1 to Len(oStrZDZ:aFields)
				...
				If !oStrZDZ:aFields[nx,14] //Verifica Se nao � Virtual
...
Static Function MGF95When(oMdlZE0,cField,xValue,nLine)
	...
	If !lRet
		Help(" ",1,'BAIXADO',,'Despesa J� Baixada',1,0)	
	EndIf
