...
user function MGFCRM49()
	...
	Local lRet 	 	 := .T.
	Local nI   	 	 := 0
	Local cProd 	 := " RAMI nao sera finalizada!!! Alguns produtos nao atenderam as condi��es para finalizar a RAMI !"
	Local cAliasZAX	 := "" // RESOLU��O
	Local cQuery	 := ""
	Local nQtdOco	 := 0 //Quantidade de ocorrencias
	Local nQtdRes	 := 0 //Quantidade de Resolu��o
