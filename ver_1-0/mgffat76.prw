...
//�                                                                        �
//��������������������������������������������������������������������������
oReport := TReport():New("MGFFAT76","Emissao da Confirmacao do Pedido","MGF730", {|oReport| ReportPrint(oReport,oPreNota,@nItem,aItemPed,aCabPed)},"Emissao da confirmacao dos pedidos de venda, de acordo com" + " " + "intervalo informado na op��o Parametros.")	//
...
//��������������������������������������������������������������������������
oPreNota := TRSection():New(oReport,"Emissao da Confirmacao do Pedido",{"SC5","SC6"},/*{Array com as ordens do relat�rio}*/,/*Campos do SX3*/,/*Campos do SIX*/)	//
...
//� Secao dos Impostos                                                     �
//��������������������������������������������������������������������������
oImpostos := TRSection():New(oReport,"Emissao da Confirmacao do Pedido",{"SC5","SC6","SD1","SB1","SD2","SA1","SA2","SA4","SE4","SA3","SX3"},/*{Array com as ordens do relat�rio}*/,/*Campos do SX3*/,/*Campos do SIX*/)	// "Emissao da Confirmacao do Pedido"
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������Ŀ��
���Programa  � MGFFAT76R3� Autor � Eduardo Jos� Zanardo  � Data � 26.12.01 ���
�������������������������������������������������������������������������Ĵ��
���Descri��o �Emissao da Pr�-Nota                                         ���
�������������������������������������������������������������������������Ĵ��
���Retorno   �Nenhum                                                      ���
...
//�Define Variaveis                                                        �
//��������������������������������������������������������������������������
Local Titulo  := OemToAnsi("Emiss�o da Confirmacao do Pedido") //"Emissao da Confirmacao do Pedido"
Local cDesc1  := OemToAnsi("Emiss�o da confirma��o dos pedidos de venda, de acordo com") //"Emiss�o da confirmac�o dos pedidos de venda, de acordo com"
Local cDesc2  := OemToAnsi("intervalo informado na opini�o Par�metros.") //"intervalo informado na op��o Par�metros."
Local cDesc3  := " "
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������Ŀ��
���Fun��o    �Mgf730Cli � Autor � Henry Fila            � Data � 26.08.02 ���
�������������������������������������������������������������������������Ĵ��
