		...
		If (lTodos .And. (cAliasSE2)->(MsRLock())) .Or. !lTodos
			...
			If SE2->(MsRLock()) .And. ( (lTodos .And. LockByName(cChaveLbn,.T.,.F.)) .Or. !lTodos)
				...
				Else
					...
					EndIf
				EndIf
			Else // Paulo Mata - PRB0041033 - 15/10/2020 - Impede marcaÁ„o dos mesmos tÌtulos duas vezes
				IW_MsgBox(STR0068,STR0046,"STOP") //"Este titulo est· sendo utilizado em outro terminal, n„o pode ser utilizado na fatura"###"AtenÁ„o"
				lRet := .F.
				Exit
			EndIf
...
@type function
Paulo Mata - PRB0041033 - 15/10/2020 - Impede marcaÁ„o dos mesmos tÌtulos duas vezes
/*/
