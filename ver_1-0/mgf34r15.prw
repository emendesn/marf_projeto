...
//����������������������������������������������������������������������������������������������������������������������������������������������������
//������������������������������������������������������������������������������������������������������������������������������������������������ͻ��
//���Programa  � MGF34R15	�Autor  � Geronimo Benedito Alves																	�Data �13/04/18	���
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.		� Rotina que mostra na tela os dados da planilha: CONTABILIDADE - Planejamento - Pagamento de Compra de Gado  (Modulo 34-CTB)		���
...
User Function MGF34R15()
	...
	Aadd(_aDefinePl, "Planejamento - Pgto de Compra de Gado"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecer� na regua de processamento.
	...
	Aadd(_aCampoQry, {"A1_FILIAL"	,"FILIAL"								,"C�d. Filial"				,"C"	,006	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"D1_TES"		,"COD_TES"								,"C�d. TES"					,"C"	,003	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"F4_TEXTO"	,"DESCRICAO_TES			as DESCRI_TES"	,"Descr. TES"				,"C"	,060	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"D1_CF"		,"COD_FISCAL"							,"Codigo Fiscal"			,"C"	,005	,0	,""  						,"" ,"" })	  
	Aadd(_aCampoQry, {"D1_DOC"		,"NOTA_FISCAL			as NOTAFISCAL"	,"N� Nota Fiscal"			,"C"	,009	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"D1_SERIE"	,"SERIE"								,"N� Serie"					,"C"	,003	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"D1_EMISSAO"	,"DATA_EMISSAO			as DT_EMISSAO"	,"Data de Emissao"			,"D"	,008	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"D1_DTDIGIT"	,"DATA_DIGITACAO		as DT_DIGITAC"	,"Data de Digita�ao"		,"D"	,008	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"F1_COND"		,"CONDICAO_PAGAMENTO	as COND_PAGTO"	,"Condicao de Pagamento"	,"C"	,003	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"E4_DESCRI"	,"DESCRICAO_COND_PGTO	as DESC_PAGTO"	,"Descr. Condicao de Pagto"	,"C"	,015	,0	,""  						,"" ,"" })
	...
	Aadd(_aCampoQry, {"F1_FORNECE"	,"COD_FORNECEDOR		as COD_FORNEC"	,"C�d. Fornecedor"			,"C"	,006	,0	,""  						,"" ,"" })
	...
	Aadd(_aCampoQry, {"A2_INSCR"	,"INSCRICAO_ESTADUAL	as INESTATUAL"	,"Inscri��o Estatual"		,"C"	,018	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"A2_MUN"		,"CIDADE"								,"Cidade"					,"C"	,040	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"A2_EST"		,"ESTADO"								,"Estado"					,"C"	,002	,0	,""  						,"" ,"" })
	Aadd(_aCampoQry, {"D1_COD"		,"COD_PRODUTO 			as CODPRODUTO"	,"C�d. Produto"				,"C"	,015	,0	,""  						,"" ,"" })
	...
	aAdd(_aParambox,{1,"Codigo Fiscal Inicial"			,Space(tamSx3("D1_CF")[1])	,""	,""															,"13"	,"",050,.F.}) 
	aAdd(_aParambox,{1,"Codigo Fiscal Final"			,Space(tamSx3("D1_CF")[1])	,""	,"U_VLFIMMAI(MV_PAR05, MV_PAR06, 'Codigo Fiscal')"			,"13"	,"",050,.F.}) 
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),      " DATA_ENTRADA BETWEEN '" + _aRet[1]    + "' AND '" + _aRet[2] + "' " ) //OBRIGATORIO, COM A VALIDA��O DE 35 DIAS
	_cQuery += U_WhereAnd( !empty(_aRet[4] ),      " COD_TES BETWEEN '"      + _aRet[3]    + "' AND '" + _aRet[4] + "' " ) //NAO OBRIGATORIO
	_cQuery += U_WhereAnd( !empty(_aRet[6] ),      " COD_FISCAL BETWEEN '"   + _aRet[5]    + "' AND '" + _aRet[6] + "' " ) //NAO OBRIGATORIO
