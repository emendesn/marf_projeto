...
//±±ºPrograma  ³ MGF30R03	ºAutor  ³ Geronimo Benedito Alves                                                                   º Data ³ 21/12/18  º±±
...
//±±º          ³ EFF-Easy Financing - 30 -Financiamento - Ordens Importação à pagar                                                            º±±
//±±º          ³ Os dados sao obtidos e mostrados na tela executando uma query, e depois, o usuario gera uma planilha excel com eles               º±±
...
User Function MGF30R03()
	...
	Aadd(_aDefinePl, "Financiamento-Ordens Importação à pagar"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerá na regua de processamento.
	Aadd(_aDefinePl, "Ordens Importação à pagar"		)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Ordens Importação à pagar"}		)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Ordens Importação à pagar"}		)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	_cQuery += U_WhereAnd( !empty(_cCODFILIA ),		" COD_FILIAL IN "			+ _cCODFILIA	                      		 ) //OBRIGATORIO (SELEÇÃO COMBO)
