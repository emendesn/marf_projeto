...
user function MGFFIS12(cTbl, cSeek, nRecno, cTblAlter, nRecnoAlte, cField, cOld, cNew, dDate, cHour, cUser)
	...
	cHtml += "<P><font face = 'verdana' size='4'><strong>ALTERACAO DE NF-E PARA TRANSMISS�O SEFAZ</strong></font></p>" +CRLF
	cHtml += CRLF+"<P><font face = 'verdana' size='2'>FILIAL/NOTA FISCAL-S�RIE: </font></p>"
	...
	cHtml += "<P><font face = 'verdana' size='2'> USU�RIO, DATA E HORA DA ALTERACAO: </font></p>"
