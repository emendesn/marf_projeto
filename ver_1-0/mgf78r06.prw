...
Data................: 04/10/2019
Descricao / Objetivo: Relatorio Logistica - cte
Doc. Origem.........:
Solicitante.........: Nicomed Filho
Uso.................: 
Obs.................: Relatorio Logistica - cte
=====================================================================================
*/
...
User Function MGF78R06()
	...
	Aadd(_aDefinePl, "Relatorio Logistica CTE"				)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecer� na regua de processamento.
	Aadd(_aDefinePl, "Relatorio Logistica CTE"				)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Relatorio Logistica CTE"}			)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Relatorio Logistica CTE"}			)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, { "DATA_EMISSAO"			,"DATA_EMISSAO"			,"Data Emissao"				,"D",008,0	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "NUMERO"					,"NUMERO"				,"Numero Documento"			,"N",016,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "SERIE"					,"SERIE"				,"Serie Documento"			,"N",003,0	,""	,""	,""	})
