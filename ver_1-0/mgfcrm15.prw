...
Data.....:              06/04/2017
Descricao / Objetivo:   Importação de Categorias x Produto para ACU
Doc. Origem:            GAP CRM
Solicitante:            Cliente
Uso......:              Marfrig
Obs......:              
...
return paramBox(aParambox, "Importação de Categoria x Produtos"	, @aRet, , , .T. /*lCentered*/, 0, 0, , , .T. /*lCanSave*/, .T. /*lUserSave*/)
