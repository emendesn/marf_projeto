...
//±±ºPrograma  ³ MGF34R16	ºAutor  ³ Geronimo Benedito Alves																	ºData ³27/04/18	º±±
...
//±±ºDesc.		³ Rotina que mostra na tela os dados da planilha: CONTABILIDADE - Relatório NF Canceladas						(Módulo 34-CTB)		º±±
...
User Function MGF34R16()
	...
	Aadd(_aDefinePl, "Contabilidade - NF Canceladas"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerá na regua de processamento.
	...
	Aadd(_aCampoQry, {"F3_FILIAL"	,"FILIAL"								,"Cód. Filial"			,"C"	,006	,0	,""	,""	,""	})
	Aadd(_aCampoQry, {"F3_DTCANC"	,"DATA_CANCELAMENTO		as DT_CANCELA"	,"Dt. de Cancelamento"	,"D"	,008	,0	,""	,"" ,""	})
	Aadd(_aCampoQry, {"F3_NFISCAL"	,"NOTA_FISCAL			as NOTAFISCAL"	,"Nº Nota Fiscal"		,"C"	,009	,0	,""	,"" ,""	})
	Aadd(_aCampoQry, {"F3_SERIE"	,"SERIE"								,"Nº Serie"				,"C"	,003	,0	,""	,"" ,""	})
	...
	Aadd(_aCampoQry, {"F3_CFO"		,"COD_FISCAL"							,"Cód. Fiscal"			,"C"	,005	,0	,""	,"" ,""	})
	Aadd(_aCampoQry, {"F3_CODISS"	,"COD_SERVICO_ISS		as SERVICOISS"	,"Cód. Serviço ISS"		,"C"	,009	,0	,""	,"" ,""	})
	Aadd(_aCampoQry, {"F3_ESTADO"	,"ESTADO"								,"Estado"				,"C"	,002	,0	,""	,"" ,""	})
	Aadd(_aCampoQry, {"F3_EMISSAO"	,"DATA_EMISSAO			as DT_EMISSAO"	,"Data Emissão"			,"D"	,008	,0	,""	,"" ,""	})
	Aadd(_aCampoQry, {"F3_OBSERV"	,"OBSERVACAO"							,"Observação"			,"C"	,060	,0	,""	,"" ,""	})
	...
	aAdd(_aParambox,{1,"Data Emissão Final"			,Ctod("")						,""	,"U_VLFIMMAI(MV_PAR03, MV_PAR04, 'Data Emissão')" 		,"","",050,.F.})
	...
	If _aRet[1] > _aRet[2]
		MsgStop("A Data de Cancelamento Inicial, não pode ser maior que a data de Cancelamento Final.")
		Return.F.
	Endif
	If _aRet[3] > _aRet[4]
