...
Data................: 19/03/2019
Descrição / Objetivo: Relatório Palete - 05 Faturamento. 
Doc. Origem.........: 
Solicitante.........: Priscilla Sombini
Uso.................: Marfrig
Obs.................: Relatório Palete.
=====================================================================================
*/
...
User Function MGF05R12()
	...
	Aadd(_aDefinePl, "Relatório Palete"						)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerá na regua de processamento.
	Aadd(_aDefinePl, "Relatório Palete"						)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Relatório Palete"}					)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Relatório Palete"}					)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, { "COD_PALLET"				,"COD_PALLET"			,"Código Palete"			,"C",006,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "END_ENTREGA"			,"END_ENTREGA"			,"Endereço Entrega"			,"C",050,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "COD_TRANSPORTADORA"		,"COD_TRANSPORTADORA"	,"Código Transportadora"	,"C",010,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "NOME_TRANSPORTADORA"	,"NOME_TRANSPORTADORA"	,"Nome Transportadora"		,"C",050,0	,""	,""	,""	})																																															  
	Aadd(_aCampoQry, { "COD_PRODUTO"			,"COD_PRODUTO"			,"Código Produto"			,"C",015,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "DESC_PRODUTO"			,"DESC_PRODUTO"			,"Descrição Produto"		,"C",040,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "PLACA_VEICULO"			,"PLACA_VEICULO"		,"Placa Veículo"			,"C",040,0	,""	,""	,""	})
	...
	Aadd(_aCampoQry, { "VALOR_UNITARIO"			,"VALOR_UNITARIO"		,"Valor Unitário"			,"N",014,2	,"@E 99,999,999,999.99"		,""	,""	})
	...
	Aadd(_aCampoQry, { "PREF_TITULO"			,"PREF_TITULO"			,"Prefixo Título"			,"C",003,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "NUM_TITULO"				,"NUM_TITULO"			,"Número Título"			,"C",009,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "TIPO_TITULO"			,"TIPO_TITULO"			,"Tipo Título"				,"C",003,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "NF_CLIENTE"				,"NF_CLIENTE"			,"NF do Cliente"			,"C",009,0	,""	,""	,""	})
	Aadd(_aCampoQry, { "NF_SERIE_CLIENTE"		,"NF_SERIE_CLIENTE"		,"Série NF do Cliente"		,"C",006,0	,""	,""	,""	})
	...
	cQryStatus	+= "  WHERE TMPSX5.X5_TABELA	= 'TY' "	//Criada a tabela genérica TY na SX5.
	...
	_cQuery += U_WhereAnd(!empty(_cStatus )	 , " STATUS IN "                   	   	 + _cStatus                             )	// OBRIGATORIO (SELEÇÃO DO COMBO)  CAMPO FILIAL(06 posições)
