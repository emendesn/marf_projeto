...
user function PE01NFESEFAZ()
	...
	If aNota[04] == "0"
		...
		//Informacoes do ve�culo para operacoes internas, uma vez que a mesma nao sera mais necess�ria para a Nota Fiscal 4.0 - Natanael Simoes
		...
		If lMGFFIS35
			If SF1->(FieldPos("F1_ZDTBUSC"))>0 .AND.  len(aNota)=6 //Data de Busca de Gado
				...
				EndIf
			Else
				Help( ,, 'PE01NFESEFAZ_01',, '� necessario compatibilizar o fonte para o GAP133.', 1, 0)
			EndIf
		EndIf
	...
	Else
		...
		///Verifica se h� mensagem para o produto.
		dBselectArea('SB1')
		dbSetOrder(1) //B1_FILIAL+B1_COD
	...
	_msgFINB0 := SuperGetMV("MGF_FINB0A",.T.,"2� Via de boletos, favor acessar o portal https://www.portaldeboletos.com.br/MARFRIG-PORTAL-BOLETOS")
