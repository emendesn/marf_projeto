...
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.		� Rotina que mostra na tela os dados da planilha: FATURAMENTO - Pedidos Cancelados      					(Modulo 05-FAT)			���
...
User Function MGF05R11()
	...
	Aadd(_aDefinePl, "Faturamento - Pedidos Cancelados"	)		//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecera na regua de processamento.
	...
	Aadd(_aCampoQry, {"C5_CLIENTE"	,"COD_CLIENTE"								,"Cod. Cliente"					,"C",006	,0	,"" 					,"" 	,"" })
	...
	Aadd(_aCampoQry, {"C5_ZTIPPED"	,"ESPECIE_PEDIDO			as ESPECIEPED"	,"Especie Pedido"				,"C",003	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"A3_COD"		,"CODIGO_VENDEDOR			as COD_VENDED"	,"Cod. Vendedor"				,"C",006	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"A3_NOME"		,"NOME_VENDEDOR				as NOM_VENDED"	,"Nome Vendedor"				,"C",030	,0	,"" 					,"" 	,"" })
	Aadd(_aCampoQry, {"C6_PRODUTO"	,"COD_PRODUTO				as CD_PRODUTO"	,"Cod. Produto"					,"C",015	,0	,"" 					,"" 	,"" })
	...
	IF Empty(_aRet[1]) .and. Empty(_aRet[2])
		MsgStop("� obrigatorio o preenchimento do parametro data de Emissao Final.")
		Return.F.
	Endif
	If _aRet[1] > _aRet[2]
	...
	cQryClient	:= "	SELECT '" +SPACE(TamSx3("A1_COD")[1] ) + "' as A1_COD , '" + SPACE(TamSx3("A1_LOJA")[1] ) + "' as A1_LOJA, ' Nao Informado' as A1_NOME "
	...
	*/			
	// Traz todos os clientes que fizeram pedido no periodo nas filiais selecionadas
	cQryClient	:= "	SELECT '" +SPACE(TamSx3("C5_CLIENTE")[1] ) + "' as C5_CLIENTE , '" + SPACE(TamSx3("C5_LOJACLI")[1] ) + "' as C5_LOJACLI, ' Nao Informado' as C5_XNOMECL "
	cQryClient	+= "	FROM DUAL UNION ALL "
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),     " DATA_EMISSAO_FILTRO BETWEEN '"  + _aRet[1]  + "' AND '" + _aRet[2] + "'  "	)	// OBRIGATORIO, COM A VALIDACAO DE 90 DIAS
	_cQuery += U_WhereAnd( !empty(_aRet[3] ),     " PEDIDO LIKE '%"         + _aRet[3]  + "%' "	                        )	// NAO OBRIGATORIO
