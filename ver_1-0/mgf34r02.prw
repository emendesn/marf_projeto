...
//ฑฑบPrograma  ณ MGF34R02	บAutor  ณ Geronimo Benedito Alves																	บData ณ01/12/17	บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: CONTABILIDADE - Razใo Contabil  (M๓dulo 34-CTB)									บฑฑ
...
User Function MGF34R02()
	...
	_aEmailQry	:= {}  ; _cWhereAnd	:= " AND "	// Jแ inicio com AND, pois o inicio do Where da query, jแ vem escrita no programa fonte

	Aadd(_aDefinePl, "Contabilidade Gerencial - Razใo Contabil"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {	"A1_FILIAL"		,"FILIAL"									,"C๓digo Filial"					,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"A1_NOME"		,"DESC_FILIAL 				as NOMEFILIAL"	,"Descricใo Filial"					,"C"	,040	,0	,""		,""	,""	})
	...
	Aadd(_aCampoQry, {	"CT2_DEBITO"	,"CONTA_DEBITO 				as CTA_DEBITO"	,"Conta Contแbil Debito"			,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CT1_DESC01"	,"DESCRICAO_CTA_DEBITO 		as DESCCTADEB"	,"Descri็ใo Conta Contแbil Debito"	,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CT2_CREDIT"	,"CONTA_CRETIDO 			as CTACREDITO"	,"Conta Contแbil Cr้dito"			,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CT1_DESC01"	,"DESCRICAO_CTA_CRETIDO 	as DESCCTACRE"	,"Descri็ใo Conta Contแbil"			,""		,""		,""	,""		,""	,""	})
	...
	Aadd(_aCampoQry, {	"CT2_HP"		,"HISTORICO					as CODHISTORI"	,"C๓d. Hist."						,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CT2_HIST"		,"DESC_HISTORICO			as DESHISTORI"	,"Hist๓rico"						,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CT2_CCD"		,"C_CUSTO_DEBITO			as CCUSTODEBI"	,"Centro Custo D้bito"				,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CTT_DESC01"	,"DESCRICAO_C_CUSTO_DEBITO	as DCCUSTODEB"	,"Descri็ใo Centro de Custo D้bito"	,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CT2_CCD"		,"C_CUSTO_CREDITO			as CCUSTOCRED"	,"Centro Custo Cr้dito"				,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CTT_DESC01"	,"DESCRICAO_C_CUSTO_CREDITO	as DCCUSTOCRE"	,"Descri็ใo Centro de Custo Cr้dito",""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CT2_ITEMD"		,"ITEM_CONTABIL_DEB			as ITEMCTBDEB"	,"Item Contแbil D้bito"				,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CT2_ITEMC"		,"ITEM_CONTABIL_CRE			as ITEMCTBCRE"	,"Item Contแbil Cr้dito"			,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CT2_CLVLDB"	,"CLASSE_VLR_DEB			as CLASVLRDEB"	,"Classe Valor D้bito"				,""		,""		,""	,""		,""	,""	})
	Aadd(_aCampoQry, {	"CT2_CLVLCR"	,"CLASSE_VLR_CRE			as CLASVLRCRE"	,"Classe Valor Cr้dito"				,""		,""		,""	,""		,""	,""	})
	...
	aAdd(_aParambox,{1,"Conta Contแbil D้bito Inicial"	,Space(tamSx3("CT1_CONTA")[1])	,""	,""															,"CT1"	,"",050,.F.})
	aAdd(_aParambox,{1,"Conta Contแbil D้bito Final"	,Space(tamSx3("CT1_CONTA")[1])	,""	,"U_VLFIMMAI(MV_PAR03, MV_PAR04, 'Conta Contแbil D้bito')"	,"CT1"	,"",050,.F.})
	aAdd(_aParambox,{1,"Conta Contแbil Cr้dito Inicial"	,Space(tamSx3("CT1_CONTA")[1])	,""	,""															,"CT1"	,"",050,.F.})
	aAdd(_aParambox,{1,"Conta Contแbil Cr้dito Final"	,Space(tamSx3("CT1_CONTA")[1])	,""	,"U_VLFIMMAI(MV_PAR05, MV_PAR06, 'Conta Contแbil Cr้dito')"	,"CT1"	,"",050,.F.})
	aAdd(_aParambox,{1,"Centro Custo D้bito Inicial"	,Space(tamSx3("CTT_CUSTO")[1])	,""	,""															,"CTT"	,"",050,.F.})
	aAdd(_aParambox,{1,"Centro Custo D้bito Final"		,Space(tamSx3("CTT_CUSTO")[1])	,""	,"U_VLFIMMAI(MV_PAR07, MV_PAR08, 'Centro de Custo D้bito')"	,"CTT"	,"",050,.F.})
	aAdd(_aParambox,{1,"Centro Custo Cr้dito Inicial"	,Space(tamSx3("CTT_CUSTO")[1])	,""	,""															,"CTT"	,"",050,.F.})
	aAdd(_aParambox,{1,"Centro Custo Cr้dito Final"		,Space(tamSx3("CTT_CUSTO")[1])	,""	,"U_VLFIMMAI(MV_PAR09, MV_PAR10, 'Centro de Custo Cr้dito')","CTT"	,"",050,.F.})
	aAdd(_aParambox,{1,"Classe Valor D้bito Inicial"	,Space(tamSx3("CTH_CLVL")[1])	,""	,""															,"CTH"	,"",050,.F.})
	aAdd(_aParambox,{1,"Classe Valor D้bito Final"		,Space(tamSx3("CTH_CLVL")[1])	,""	,"U_VLFIMMAI(MV_PAR11, MV_PAR12, 'Classe de Valor D้bito')"	,"CTH"	,"",050,.F.})
	aAdd(_aParambox,{1,"Classe Valor Cr้dito Inicial"	,Space(tamSx3("CTH_CLVL")[1])	,""	,""															,"CTH"	,"",050,.F.})
	aAdd(_aParambox,{1,"Classe Valor Cr้dito Final"		,Space(tamSx3("CTH_CLVL")[1])	,""	,"U_VLFIMMAI(MV_PAR13, MV_PAR14, 'Classe de Valor Cr้dito')","CTH"	,"",050,.F.})
	...
	_cQuery += U_WhereAnd( !empty(_aRet[4]),  " CT2.CT2_DEBITO BETWEEN '" + _aRet[3]  + "' AND '" + _aRet[4]  + "' " ) // '  ' AND '999999999' --NรO OBRIGATORIO
	_cQuery += U_WhereAnd( !empty(_aRet[6]),  " CT2.CT2_CREDIT BETWEEN '" + _aRet[5]  + "' AND '" + _aRet[6]  + "' " ) // '  ' AND '999999999' --NรO OBRIGATORIO
	_cQuery += U_WhereAnd( !empty(_aRet[8]),  " CT2.CT2_CCD    BETWEEN '" + _aRet[7]  + "' AND '" + _aRet[8]  + "' " ) // '  ' AND '9999'  --NรO OBRIGATORIO
	_cQuery += U_WhereAnd( !empty(_aRet[10]), " CT2.CT2_CCC    BETWEEN '" + _aRet[9]  + "' AND '" + _aRet[10] + "' " ) // '  ' AND '9999'   --NรO OBRIGATORIO               
	_cQuery += U_WhereAnd( !empty(_aRet[12]), " CT2.CT2_CLVLDB BETWEEN '" + _aRet[11] + "' AND '" + _aRet[12] + "' " ) // '  ' AND '999999999'  --NรO OBRIGATORIO
	_cQuery += U_WhereAnd( !empty(_aRet[14]), " CT2.CT2_CLVLCR BETWEEN '" + _aRet[13] + "' AND '" + _aRet[14] + "' " ) // '  ' AND '999999999'  --NรO OBRIGATORIO
