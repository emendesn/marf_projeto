...
//����������������������������������������������������������������������������������������������������������������������������������������������������
//������������������������������������������������������������������������������������������������������������������������������������������������ͻ��
//���Programa  � MGF29R01	�Autor  �Geronimo Benedito Alves																	�Data �03/08/18	���
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.		� Rotina que mostra na tela os dados da planilha: EEC-Easy Export Control - 29 -EXPORTACAO - EXPs Embarcadas							���
...
User Function MGF29R01()
	...
	Aadd(_aDefinePl, "Exportacao - EXPs Embarcadas")	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecer� na regua de processamento.
	Aadd(_aDefinePl, "EXPs Embarcadas"			 )	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"EXPs Embarcadas"}			 )	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"EXPs Embarcadas"}			 )	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	Aadd(_aCampoQry, {"XXSALDODEV"	,"SALDO_DEVEDOR"						,"Saldo Devedor"			,"N",016	,2	,"@E 999,999,999,999.99",""		,""	})
	Aadd(_aCampoQry, {"XXVALORPAG"	,"VALOR_PAGO"							,"Valor Pago"				,"N",016	,2	,"@E 999,999,999,999.99",""		,""	})
	Aadd(_aCampoQry, {"XXPORTDEST"	,"PORTO_DESTINO"						,"Porto Destino"			,"C",020	,0	,""						,""		,""	})
	...
	Aadd(_aCampoQry, {"EEC_ZBL"		,"NUM_BL"								,""							,"C",020  	,0	,""						,""		,""	}) // C,20,0
	Aadd(_aCampoQry, {"YP_TEXTO"	,"SITUACAO"								,"Situacao"					,"C",080	,0	,""						,""		,""	})
	...
	Aadd(_aCampoQry, {"XXNCONTAIN"	,"NUM_CONTAINER"						,"Numero Container"			,"C",020	,0	,""						,""		,""	})
	...
	_cQuery += " FROM " + U_IF_BIMFR("IF_BIMFR", "V_EX_EXPSEMBARCADAS"  ) + CRLF
	...
	Else	
			_cQuery += U_WhereAnd( .T. ,        " SITUACAO IN " + _cSituacao	          )	
	Endif
