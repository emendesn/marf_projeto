...
//ฑฑบPrograma  ณ MGF34R21	บAutor  ณ Geronimo Benedito Alves																	บData ณ  13/07/18  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: Contabilidade Gerencial - Provisใo   (M๓dulo 34-CTB)                             บฑฑ
...
User Function MGF34R21()
	...
	Aadd(_aDefinePl, "Contabilidade Gerencial - Provisใo"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	Aadd(_aDefinePl, "Provisใo"								)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Provisใo"}							)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Provisใo"}							)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
	...
	aAdd(_aParambox,{1,"Data Contabiliza็ใo Inicial",Ctod("")						,""	,""														,""		,""	, 050,.F.})
	aAdd(_aParambox,{1,"Data Contabiliza็ใo Final"	,Ctod("")						,""	,"U_VLFIMMAI(MV_PAR07, MV_PAR08	,'Data Contabiliza็ใo')",""		,""	, 050,.F.})
	...
	_cQuery += U_WhereAnd(!empty(_aRet[9] ),       " NUM_TITULO LIKE '%"             + _aRet[9]  + "%' "                        ) //NรO OBRIGATORIO - USUARIO DIGITA O NOME		
	_cQuery += U_WhereAnd(!empty(_aRet[11] ),      " COD_FORNECEDOR  BETWEEN '"      + _aRet[10] + "' AND '" + _aRet[11] + "' " ) //NรO OBRIGATORIO, USUARIO COLOCA O CODIGO DE/ATE (RANGE) 
	_cQuery += U_WhereAnd(!empty(_aRet[13] ),      " COD_NATUREZA  BETWEEN '"        + _aRet[12] + "' AND '" + _aRet[13] + "' " ) //NรO OBRIGATORIO, USUARIO COLOCA O CODIGO DE/ATE (RANGE) 
