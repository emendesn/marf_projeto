...
User Function mgfgct06(aItem,_cChaveSE1)
	...
	ConOut(PadC("Rotina Automaica para a Medi��o do Contrato de Compras e Vendas",80))
	...
	If CN9->(dbSeek(xFilial("CN9",_xcFil) + _cContra + _cRevisa))
		...
		While !(_cArqTrb)->(Eof())
			...
			aAdd(aCabCN120,{"CND_OBS","Medi��o automatica - Pedido de venda numero " + _cPedido +" - Nota: .",NIL}) //Medi��o gerada automaticamente a partir da inclusao do pedido de venda numero ###.
			...
			BEGIN TRANSACTION
				...
				if lMsErroAuto
				    ...
				    EndIf
					_lToK := .F.
					APmsgalert("Medi��o do contrato " + allTrim(_cContra) + " nao gerada!")
				else
					//CONFIRMSX8()
					DBSelectArea("CND")
					...
					//APmsgalert("Gerada Medi��o " + allTrim(_cDoc) + " do contrato " + allTrim(_cContra) )
				endif
