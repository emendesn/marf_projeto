...
//����������������������������������������������������������������������������������������������������������������������������������������������������
//������������������������������������������������������������������������������������������������������������������������������������������������ͻ��
//���Programa  � MGF06R08	�Autor  � Geronimo Benedito Alves																	�Data �29/12/17	���
//������������������������������������������������������������������������������������������������������������������������������������������������͹��
//���Desc.		� Rotina que mostra na tela os dados da planilha: CONTAS A RECEBER - Recebimento Consolidado  (Modulo 06-FIN)						���
...
User Function MGF06R08()
	...
	Aadd(_aDefinePl, "Contas a Receber - Recebimento Consolidado"	)	//01-  _cTitulo	- Titulo da planilha a ser gerada. Aparecera na regua de processamento.
	...
	Aadd(_aCampoQry, {"A1_FILIAL"	,"COD_FILIAL"							,"Codigo Filial"			,"C",006	,0	,""						,""		,""	})
	...
	Aadd(_aCampoQry, {"E1_VALOR"	,"VLR_DEVOLUCAO			as VLRDEVOLUC"	,"Valor Devolucao"			,"N",017	,2	,"@E 99,999,999,999.99"	,""		,""	})
	...
	Do While.T.													// La�o para obrigar a marcacao de ao menos um portador
		...
		_lCancProg	:= .T. 		//.T. no envio do parametro, indica que devo abandonar programa, se for clicado o Botao cancelar da MarkGene										// Quero que seja retornado o primeiro campo: A6_COD
	...
	MsgRun("Aguarde!!! Montando\Desconectando Tela"	,,{ ||U_TGridRel()})		// Mostra mensagem, ao montar a tela de dados e tamb�m ao fecha-la
RETURN
