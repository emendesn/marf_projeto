...
Static Function MGFFINBA01()
	...
	If !(ZA7->ZA7_STATUS $ cStatPerm) //1=Envio Pendente;2=Enviado;3=Reenvio Pendente;4=Reenviado;5=Cancelado
		Help( ,, ProcName() + ' - ' + Str(ProcLine()),, 'Os arquivos *.xml s� podem ser gerados para os status ' + cStatPerm + ".", 1, 0)
		Return
	...
	// Verifica se o diretorio MGF_FIN90A esta pode ser criado ou j� existe.
