...
//ฑฑบPrograma  ณ MGF06R16	บAutor  ณ Geronimo Benedito Alves																	บData ณ  20/04/18  บฑฑ
//ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออสอออออฯออออออออออออนฑฑ
//ฑฑบDesc.		ณ Rotina que mostra na tela os dados da planilha: Financeiro -  Contas a Receber - Tํtulos em Aberto CR			(M๓dulo 06-FIN)    บฑฑ
...
User Function MGF06R16()
	...
	Aadd(_aDefinePl, "Contas a Receber - Tํtulos em Aberto"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerแ na regua de processamento.
	...
	Aadd(_aCampoQry, {"E2_FILIAL"	,"COD_FILIAL"							,"C๓d. Filial"				,"C",006	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"M0_FILIAL"	,"NOM_FILIAL"							,"Descr. Filial"			,"C",040	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"A1_COD"		,"COD_CLIENTE			as COD_CLIENT"	,"C๓d. do Cliente"			,"C",006	,0	,""							,""	,""	})
	...
	Aadd(_aCampoQry, {"A1_INSCR"	,"COD_INSCR_EST_CLIENTE"				,"Inscri็ใo Estadual"		,"C",018	,0	,""							,""	,""	})	
	...
	Aadd(_aCampoQry, {"E1_NUM"		,"NUM_TITULO"							,"Nบ Tํtulo"				,"C",009	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"E1_PARCELA"	,"NUM_PARCELA			as NUMPARCELA"	,"Parcela"					,"C",002	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"E1_NATUREZ"	,"COD_NATUREZA_OPERACAO	as CODNATUREZ"	,"C๓d. Natureza"			,"C",010	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"E1_TIPO"		,"TIP_TITULO"							,"Tipo Tํtulo"				,"C",003	,0	,""							,""	,""	})
	...
	Aadd(_aCampoQry, {"E1_NUMBCO"	,"NUM_TIT_BANCO			as NUMTITBANC"	,"Nบ no Banco"				,"C",015	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"E1_PORTADO"	,"COD_PORTADOR			as CODPORTADO"	,"C๓d. do Portador"			,"C",003	,0	,""							,""	,""	})
	AADD(_aCampoQry, {"E1_AGEDEP"	,"NUM_AGENCIA			as NUMAGENCIA"	,"Nบ Agencia"				,"C",005	,0	,""							,""	,""	})
	AADD(_aCampoQry, {"E1_CONTA"	,"NUM_CONTA				as NUM_CONTA"	,"Nบ Conta"					,"C",010	,0	,""							,""	,""	})
	...
	Aadd(_aCampoQry, {"ZZB_NRONFD"	,"DEVOLUCAO"							,"Devolu็ใo"				,"C",250	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"ZZ9_DESPOS"	,"POSICAO"								,"Posi็ใo"					,"C",040	,0	,""							,""	,""	})
	...
	Aadd(_aCampoQry, {"E1_HIST"		,"HISTORICO_TITULO		as HISTOR_TIT"	,"Hist๓rico Tํtulo"			,"C",250	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"A1_END"		,"NOM_ENDERECO			as NOM_ENDERE"	,"Endere็o"					,"C",080	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"A1_BAIRRO"	,"NOM_BAIRRO_CLIENTE	as BAIRROCLIE"	,"Bairro Cliente"			,"C",040	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"A1_ESTADO"	,"NOM_MUNICIPIO_CLIENTE	as MUNICICLIE"	,"Municํpio Cliente"		,"C",020	,0	,""							,""	,""	})
	...
	Aadd(_aCampoQry, {"E1_PREFIXO"	,"NUM_PREFIXO_TITULO	as PREFIXOTIT"	,"Prefixo Tํtulo"			,"C",003	,0	,""							,""	,""	})
	Aadd(_aCampoQry, {"E1_MOEDA"	,"COD_MOEDA"							,"C๓d. Moeda"				,"N",002	,0	,"99"						,""	,""	})
	Aadd(_aCampoQry, {"XXDESMOE01"	,"DESC_MOEDA"							,"Descri็ใo da Moeda"		,"C",005	,0	,""							,""	,""	})	
...
//===		S E L E C I O N A	T I P O	D E		T I T U L O
	...
	cTituTipo	:= "Marque op็ใo do Tipo de Titulo a serem listado: "
...
//===		S E L E C I O N A	R E D E
	...
	_cQuery += U_WhereAnd( !empty(_aRet[2] ),     " DT_VENCIMENTO_FILTRO BETWEEN '"   + _aRet[1] + "' AND '" + _aRet[2] + "' " ) // OBRIGATORIO, COM A VALIDAวรO DE 35 DIAS
	...
	Endif
	_cQuery += U_WhereAnd( !empty(_aRet[6] ),     " COD_NATUREZA_OPERACAO BETWEEN '"  + _aRet[5] + "' AND '" + _aRet[6] + "' " ) // NรO OBRIGATORIO
