...
//±±ºPrograma  ³ MGF30R06	ºAutor  ³ Geronimo Benedito Alves																	ºData ³  21/12/18  º±±
...
//±±ºDesc.		³ Rotina que mostra na tela os dados da planilha: EFF-Easy Financing - 30-Financiamento-Ordens Importação Pagos	       º±±
...
User Function MGF30R06()
	...
	Aadd(_aDefinePl, "Financiamento-Ordens Importação Pagos"	)	//01-	_cTitulo	- Titulo da planilha a ser gerada. Aparecerá na regua de processamento.
	Aadd(_aDefinePl, "Ordens Importação Pagos"		)	//02-	_cArqName  - Nome da planilha Excel a ser criada
	Aadd(_aDefinePl, {"Ordens Importação Pagos"}		)	//03-	_cNomAbAna - Titulo(s) da(s) aba(s) na planilha excel
	Aadd(_aDefinePl, {"Ordens Importação Pagos"}		)	//04-	_cNomTTAna - Titulo(s) da(s) tabela(s) na planilha excel
