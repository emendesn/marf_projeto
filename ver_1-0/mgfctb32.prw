...
AADD (aProd, "B1_COD")
	...
	If Len(cExpres) > TamSX3("ZD2_PRODUT")[1]
		Help( ,, 'HELP',, "O tamanho da express�o (" + cValToChar(Len(cExpres)) + ") � maior do que o sistema comporta (" + cValTochar(TamSX3("ZD2_PRODUT")[1]) + ")", 1, 0,)
		Return cRet 
	EndIf
...
/// Retorna express�o do tipo de documento de frete
...
AADD (aDoc, "GVT_CDESP")
	...
	If Len(cExpres) > TamSX3("ZD2_TPDOCF")[1]
		Help( ,, 'HELP',, "O tamanho da express�o (" + cValToChar(Len(cExpres)) + ") � maior do que o sistema comporta (" + cValTochar(TamSX3("ZD2_TPDOCF")[1]) + ")", 1, 0,)
		Return cRet 
	EndIf
...
/// Retorna express�o do Grupo de produto
User Function GRUPO()
...
AADD (aGrup, "B1_GRUPO")
	...
	If Len(cExpres) > TamSX3("ZD2_GRUPO")[1]
		Help( ,, 'HELP',, "O tamanho da express�o (" + cValToChar(Len(cExpres)) + ") � maior do que o sistema comporta (" + cValTochar(TamSX3("ZD2_GRUPO")[1]) + ")", 1, 0,)
		Return cRet 
	EndIf
...
//Funcao que retorna express�o para CFOP
User Function CFOP()
...
AADD (aCFOP, "X5_CHAVE")	
	...
	If Len(cExpres) > TamSX3("ZD2_CFOP")[1]
		Help( ,, 'HELP',, "O tamanho da express�o (" + cValToChar(Len(cExpres)) + ") � maior do que o sistema comporta (" + cValTochar(TamSX3("ZD2_CFOP")[1]) + ")", 1, 0,)
		Return cRet 
	EndIf
...
/// Retorna express�o do Tipo de pedido
User Function TPPED()
...
/// Retorna express�o do Grupo Tribut�rio
...
AADD (aGRPTRB, "X5_CHAVE")
	...
	If Len(cExpres) > TamSX3("ZD2_GRPTRB")[1]
		Help( ,, 'HELP',, "O tamanho da express�o (" + cValToChar(Len(cExpres)) + ") � maior do que o sistema comporta (" + cValTochar(TamSX3("ZD2_GRPTRB")[1]) + ")", 1, 0,)
		Return cRet 
	EndIf
...
/// Retorna express�o do Motivo Ocorrencia
...
AADD (aMOTOCO, "GU6_CDMOT")
	...
	If Len(cExpres) > TamSX3("ZD2_TPOCO")[1]
		Help( ,, 'HELP',, "O tamanho da express�o (" + cValToChar(Len(cExpres)) + ") � maior do que o sistema comporta (" + cValTochar(TamSX3("ZD2_TPOCO")[1]) + ")", 1, 0,)
		Return cRet 
	EndIf
